...
async function context(request: NextRequest) {
  ...
  return executeServiceRoleJob(
    {
      orgId: admin.orgId,
      reason: "Authorize access to an organization staff channel",
      moduleId: "admin.staff.channels",
    },
    async (service) => {
      ...
      return { auth, admin, thread, membership }
    },
  )
}
...
export async function GET(request: NextRequest) {
  ...
  const { admin, thread } = access
  return executeServiceRoleJob(
    {
      orgId: admin.orgId,
      reason: "Load members for an authorized organization staff channel",
      moduleId: "admin.staff.channels",
    },
    async (service) => {
...
export async function PATCH(request: NextRequest) {
  ...
  const { auth, admin, thread } = access
  return executeServiceRoleJob(
    {
      orgId: admin.orgId,
      reason: "Update an authorized organization staff channel",
      moduleId: "admin.staff.channels",
    },
    async (service) => {
