...
import { ContractReviewClient } from "@/app/contracts/[id]/contract-review-client"
import type { ContractReviewRow } from "@/app/contracts/[id]/contract-review-types"

export default async function ArtistContractReviewPage({ params }: { params: Promise<{ id: string }> }) {
  ...
  if (!user) redirect(`/login?redirectTo=/artist/business/contracts/${encodeURIComponent(id)}`)
