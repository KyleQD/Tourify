...
export function ApplicationReviewFilters({
  ...
  return (
    <div className={cn("grid gap-3 md:grid-cols-[1fr_180px_180px_auto]", className)}>
      ...
      <Button
        ...
        className={cn(filters.starredOnly ? "bg-amber-500 text-slate-950 hover:bg-amber-400" : "border-slate-700")}
      >
        <Star className={cn("mr-2 h-4 w-4", filters.starredOnly && "fill-current")} />
        Starred
      </Button>
    </div>
  )
