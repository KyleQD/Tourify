...
export function OnboardingKanbanFilters({ candidates, filters, onFiltersChange }: OnboardingKanbanFiltersProps) {
  ...
  return (
    <WorkforcePanel className="grid gap-3 p-4 md:grid-cols-6">
      ...
      <div className="space-y-2">
        ...
        <Select value={filters.templateState} onValueChange={(value) => updateFilter("templateState", value)}>
          <SelectTrigger>
            <SelectValue placeholder="Template" />
          </SelectTrigger>
          <SelectContent>
            <SelectItem value="all">All</SelectItem>
            <SelectItem value="pending">Pending template</SelectItem>
