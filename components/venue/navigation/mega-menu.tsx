          ...
          <div className="grid grid-cols-1 md:grid-cols-2 lg:grid-cols-3 gap-8">
            ...
            <div>
              ...
              <ul className="space-y-3">
                <li>
                  <Link href="/venue/dashboard" className="flex items-center text-gray-300 hover:text-white" onClick={onClose}>
                ...
                <li>
                  <Link href="/venue/documents" className="flex items-center text-gray-300 hover:text-white" onClick={onClose}>
                    <span className="bg-blue-500/20 p-1.5 rounded-md mr-3">
                      <svg xmlns="http://www.w3.org/2000/svg" width="24" height="24" viewBox="0 0 24 24" fill="none" stroke="currentColor" strokeWidth="2" strokeLinecap="round" strokeLinejoin="round" className="h-4 w-4 text-blue-400">
            ...
            <div>
              ...
              <ul className="space-y-3">
                ...
                <li>
                  <Link href="/tickets/my-tickets" className="flex items-center text-gray-300 hover:text-white" onClick={onClose}>
                    <span className="bg-green-500/20 p-1.5 rounded-md mr-3">
                      <svg
                        xmlns="http://www.w3.org/2000/svg"
                        width="24"
            ...
            <div>
              ...
              <ul className="space-y-3">
                <li>
                  <Link href="/discover" className="flex items-center text-gray-300 hover:text-white" onClick={onClose}>
            ...
            <div>
              ...
              <ul className="space-y-3">
                ...
                <li>
                  <Link href="/faq" className="flex items-center text-gray-300 hover:text-white" onClick={onClose}>
                    <span className="bg-gray-500/20 p-1.5 rounded-md mr-3">
                      <svg
                        xmlns="http://www.w3.org/2000/svg"
                        width="24"
