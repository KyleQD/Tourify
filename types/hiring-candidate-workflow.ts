...
export type TemplateState = "explicit" | "employerResolved" | "pending"

export type OnboardingDeliveryStatus = "not_sent" | "sent" | "in_progress" | "completed"

export interface HiringCandidateAssignmentSummary {
...
export interface HiringCandidate {
  ...
  workflowCurrentStage?: WorkflowStageId
  roster?: HiringCandidateRosterSummary | null
  templateState?: TemplateState
  onboardingDeliveryStatus?: OnboardingDeliveryStatus
  onboardingNotificationSentAt?: string | null
  assignment?: HiringCandidateAssignmentSummary | null
  onboardingResponses?: Record<string, unknown> | null
}
