...
import type { JobPostingBuilderProps, JobPostingFormValues } from "@/types/job-posting-builder"
      ...
      <Card>
        <CardHeader className="space-y-3">
          <div className="flex flex-col gap-3 sm:flex-row sm:items-start sm:justify-between">
            <div>
              <CardTitle>{mode === "edit" ? "Edit job posting" : "Create job posting"}</CardTitle>
              <CardDescription>
          ...
          <div className="grid gap-4 md:grid-cols-2">
            ...
            <div className="space-y-2">
              ...
              <p className="text-xs text-muted-foreground">
                Leave blank to let Phase 3 resolve the best employer-scoped template by role and department.
              </p>
            </div>
          </div>
