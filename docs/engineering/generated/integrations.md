...
| --- | --- | --- | --- |
| Supabase | `@supabase/ssr@^0.6.1`, `@supabase/supabase-js@^2.39.3` | `NEXT_PUBLIC_SUPABASE_ANON_KEY`, `NEXT_PUBLIC_SUPABASE_PROJECT_REF`, `NEXT_PUBLIC_SUPABASE_URL`, `SUPABASE_ACCESS_TOKEN`, `SUPABASE_ANON_KEY`, `SUPABASE_FETCH_TIMEOUT_MS`, `SUPABASE_JWT_SECRET`, `SUPABASE_PRODUCTION_PROJECT_ID`, `SUPABASE_PRODUCTION_URL`, `SUPABASE_PROJECT_ID`, `SUPABASE_PROJECT_REF`, `SUPABASE_REALTIME_CHANNEL_SECRET`, `SUPABASE_RLS_TEST_ANON_KEY`, `SUPABASE_RLS_TEST_SERVICE_ROLE_KEY`, `SUPABASE_RLS_TEST_URL`, `SUPABASE_SERVICE_ROLE_KEY`, `SUPABASE_STAGING_PROJECT_ID`, `SUPABASE_STAGING_URL`, `SUPABASE_TARGET_CONFIRMATION`, `SUPABASE_URL` | `app/admin/dashboard/components/lib/supabase.ts`<br>`app/admin/dashboard/components/supabase-debug.tsx`<br>`app/admin/dashboard/components/supabase-test.tsx` |
