...
| Upstash | `@upstash/ratelimit@^2.0.6`, `@upstash/redis@^1.35.3` | `UPSTASH_REDIS_REST_TOKEN`, `UPSTASH_REDIS_REST_URL` | `lib/utils/rate-limit.ts`<br>`scripts/ci/smoke-rate-limit.mjs` |
