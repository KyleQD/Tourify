# Phase 20 evidence and constellation readiness

## Purpose

Define the evidence required from several independent Phase 20 trusts before constellation work begins.

## Required design decisions

- Require audited charters, authority maps, preservation profiles and independent restores.
- Require restriction-propagation, provider-replacement, dissolution-survival and Tourify-unavailable evidence.
- Reject synthetic or single-operator evidence.
- Record unresolved blockers as stop conditions.
...
1. Require audited charters, authority maps, preservation profiles and independent restores.
2. Require restriction-propagation, provider-replacement, dissolution-survival and Tourify-unavailable evidence.
3. Reject synthetic or single-operator evidence.
4. Record unresolved blockers as stop conditions.
