# Trust-node membership, accreditation, withdrawal and suspension

## Purpose

Define trust-node eligibility, diligence, admission, renewal, suspension, withdrawal and successor treatment.

## Required design decisions

- Verify legal existence, governance, preservation capacity and remedies.
- Separate membership status from custodian accreditation for a particular collection.
- Provide suspension and appeal for security, governance or preservation failures.
- Require export and continuity on withdrawal.
...
1. Verify legal existence, governance, preservation capacity and remedies.
2. Separate membership status from custodian accreditation for a particular collection.
3. Provide suspension and appeal for security, governance or preservation failures.
4. Require export and continuity on withdrawal.
