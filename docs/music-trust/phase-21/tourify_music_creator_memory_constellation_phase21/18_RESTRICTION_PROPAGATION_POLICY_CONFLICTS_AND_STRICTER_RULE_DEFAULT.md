# Restriction propagation, policy conflicts and stricter-rule default

## Purpose

Prevent restrictions from being lost or weakened when records cross technical, legal or organizational boundaries.

## Required design decisions

- Carry machine-readable and human-readable restrictions together.
- Reject unknown or unsupported restriction semantics.
- Default conflict to deny or stricter compatible treatment.
- Require authority review before relaxing a restriction.
...
1. Carry machine-readable and human-readable restrictions together.
2. Reject unknown or unsupported restriction semantics.
3. Default conflict to deny or stricter compatible treatment.
4. Require authority review before relaxing a restriction.
