# Space-law, scientific, environmental, export and launch approvals

## Purpose

Map the separate approvals required before any space-based preservation experiment.

## Required design decisions

- Identify launching state, registration, supervision and liability responsibilities.
- Apply long-term space-sustainability and debris-mitigation controls.
- Review export controls, cybersecurity, environmental assessment and insurance.
- Require public scientific review and a terrestrial fallback.
...
1. Identify launching state, registration, supervision and liability responsibilities.
2. Apply long-term space-sustainability and debris-mitigation controls.
3. Review export controls, cybersecurity, environmental assessment and insurance.
4. Require public scientific review and a terrestrial fallback.
