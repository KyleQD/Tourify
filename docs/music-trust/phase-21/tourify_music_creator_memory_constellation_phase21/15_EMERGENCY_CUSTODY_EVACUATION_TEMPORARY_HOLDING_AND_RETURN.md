# Emergency custody, evacuation, temporary holding and return

## Purpose

Control temporary physical or digital custody during emergencies without transferring ownership or permanent authority.

## Required design decisions

- Use signed custody schedules and chain-of-custody logs.
- Define transport, storage, security and access rules.
- Set return, extension, deletion or conversion deadlines.
- Require community and rights restrictions to remain enforceable.
...
1. Use signed custody schedules and chain-of-custody logs.
2. Define transport, storage, security and access rules.
3. Set return, extension, deletion or conversion deadlines.
4. Require community and rights restrictions to remain enforceable.
