# Emergency replication packages, fixity and reconciliation

## Purpose

Define minimum emergency package content, signatures, restriction metadata, restoration and source reconciliation.

## Required design decisions

- Include source manifests, fixity, provenance, representation information and restrictions.
- Generate no public derivative by default.
- Reconcile every copy after the emergency.
- Quarantine conflicting or unverifiable packages.
...
1. Include source manifests, fixity, provenance, representation information and restrictions.
2. Generate no public derivative by default.
3. Reconcile every copy after the emergency.
4. Quarantine conflicting or unverifiable packages.
