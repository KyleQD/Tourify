# Global preservation-capacity mapping and gap prioritization

## Purpose

Identify underserved regions, languages, formats and risk areas for capacity building and mutual aid.

## Required design decisions

- Use transparent, community-informed criteria.
- Do not equate low capacity with low authority.
- Protect sensitive infrastructure details.
- Link grants to locally defined priorities and sustainable handoff.
...
1. Use transparent, community-informed criteria.
2. Do not equate low capacity with low authority.
3. Protect sensitive infrastructure details.
4. Link grants to locally defined priorities and sustainable handoff.
