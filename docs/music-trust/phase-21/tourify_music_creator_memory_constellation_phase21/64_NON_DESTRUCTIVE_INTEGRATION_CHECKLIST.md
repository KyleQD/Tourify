...
Provide a release-by-release checklist protecting Tourify’s existing music, rights, database and mobile behavior.

## Required design decisions

- No destructive migrations or replacement pipelines.
- No public route to confidential source tables.
- No Phase 21 activation from earlier flags.
- Require rollback, regression and production-readiness evidence.
...
1. No destructive migrations or replacement pipelines.
2. No public route to confidential source tables.
3. No Phase 21 activation from earlier flags.
4. Require rollback, regression and production-readiness evidence.
