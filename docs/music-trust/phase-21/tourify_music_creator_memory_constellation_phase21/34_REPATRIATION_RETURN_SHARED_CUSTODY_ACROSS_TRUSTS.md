# Repatriation, return and shared custody across trusts

## Purpose

Coordinate lawful return, digital restitution, access copies and shared custody between independent trusts and communities.

## Required design decisions

- Verify claimant and source authority without self-adjudicating title.
- Preserve provenance and prior custody history.
- Respect privacy, cultural and security restrictions.
- Define post-return deletion, retention or reference obligations.
...
1. Verify claimant and source authority without self-adjudicating title.
2. Preserve provenance and prior custody history.
3. Respect privacy, cultural and security restrictions.
4. Define post-return deletion, retention or reference obligations.
