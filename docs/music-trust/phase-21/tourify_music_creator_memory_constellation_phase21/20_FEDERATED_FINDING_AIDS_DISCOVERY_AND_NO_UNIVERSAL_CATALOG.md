# Federated finding aids, discovery and no universal catalog

## Purpose

Support cross-trust discovery through minimal projections without centralizing complete collection metadata.

## Required design decisions

- Allow trust-controlled indexing and opt-out.
- Expose only approved fields and dispute status.
- Use query brokering or distributed search where appropriate.
- Never treat discovery metadata as access or reuse permission.
...
1. Allow trust-controlled indexing and opt-out.
2. Expose only approved fields and dispute status.
3. Use query brokering or distributed search where appropriate.
4. Never treat discovery metadata as access or reuse permission.
