# Cross-trust privacy, minimization and purpose limitation

## Purpose

Minimize personal, sensitive and community data used for coordination, emergency response and public reporting.

## Required design decisions

- Use purpose-specific exchange profiles.
- Prefer aggregate capacity and risk data over collection-level exposure.
- Separate emergency contact data from public directories.
- Define retention, deletion, legal hold and onward-transfer controls.
...
1. Use purpose-specific exchange profiles.
2. Prefer aggregate capacity and risk data over collection-level exposure.
3. Separate emergency contact data from public directories.
4. Define retention, deletion, legal hold and onward-transfer controls.
