# Rights-reference interoperability and non-adjudication

## Purpose

Allow long-term rights-source references to travel with preservation packages without turning the constellation into a rights registry.

## Required design decisions

- Reference authoritative Rights Passports, licences and official sources.
- Display freshness, dispute and revocation status.
- Reload current source records before high-impact action.
- Never infer ownership, licence or payment authority from archival metadata.
...
1. Reference authoritative Rights Passports, licences and official sources.
2. Display freshness, dispute and revocation status.
3. Reload current source records before high-impact action.
4. Never infer ownership, licence or payment authority from archival metadata.
