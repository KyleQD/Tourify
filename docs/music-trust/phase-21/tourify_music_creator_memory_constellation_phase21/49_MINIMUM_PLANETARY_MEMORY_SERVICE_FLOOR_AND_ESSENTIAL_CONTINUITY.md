# Minimum planetary-memory service floor and essential continuity

## Purpose

Define the smallest public-interest functions that should survive severe disruption without expanding authority.

## Required design decisions

- Limit the floor to preservation status, correction, export, finding aids and emergency coordination.
- Keep confidential materials and exact locations restricted.
- Fund essential continuity separately from optional programs.
- Test service survival without Tourify or a central operator.
...
1. Limit the floor to preservation status, correction, export, finding aids and emergency coordination.
2. Keep confidential materials and exact locations restricted.
3. Fund essential continuity separately from optional programs.
4. Test service survival without Tourify or a central operator.
