# Public consultation, ratification, amendment, withdrawal and sunset

## Purpose

Define legitimate adoption and change control for the constellation charter and shared profiles.

## Required design decisions

- Require public notice, accessible consultation and reasoned responses.
- Use enhanced thresholds for authority, restrictions, assets and emergency powers.
- Protect trust and community withdrawal.
- Require sunset and periodic reauthorization.
...
1. Require public notice, accessible consultation and reasoned responses.
2. Use enhanced thresholds for authority, restrictions, assets and emergency powers.
3. Protect trust and community withdrawal.
4. Require sunset and periodic reauthorization.
