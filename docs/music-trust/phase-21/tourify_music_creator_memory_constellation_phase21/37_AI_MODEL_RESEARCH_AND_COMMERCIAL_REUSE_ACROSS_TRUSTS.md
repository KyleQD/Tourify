# AI, model, research and commercial reuse across trusts

## Purpose

Prevent cross-trust preservation and discovery from becoming an implied AI or commercial dataset licence.

## Required design decisions

- Deny AI training, embeddings, voice or style modeling by default.
- Require exact collections, purpose, recipient, model, territory and term for any exception.
- Propagate revocation and output restrictions.
- Require community return and benefit review where applicable.
...
1. Deny AI training, embeddings, voice or style modeling by default.
2. Require exact collections, purpose, recipient, model, territory and term for any exception.
3. Propagate revocation and output restrictions.
4. Require community return and benefit review where applicable.
