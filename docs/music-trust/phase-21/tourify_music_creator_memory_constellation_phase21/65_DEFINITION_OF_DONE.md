...
Define audit, governance, technical, legal, cultural, privacy, security, operational and continuity evidence required for completion.

## Required design decisions

- No task completes on documentation alone when implementation is required.
- No blocker may be converted into an undocumented assumption.
- Require independent verification of critical controls.
- Require complete task-level evidence in the execution plan.
...
1. No task completes on documentation alone when implementation is required.
2. No blocker may be converted into an undocumented assumption.
3. Require independent verification of critical controls.
4. Require complete task-level evidence in the execution plan.
