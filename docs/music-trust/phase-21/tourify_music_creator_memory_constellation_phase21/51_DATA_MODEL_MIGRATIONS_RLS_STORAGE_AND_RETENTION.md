...
Define additive records, policy versions, restricted storage and default-deny access for constellation operations.

## Required design decisions

- Reference Phase 20 records instead of duplicating source collections.
- Use append-only events and immutable manifests.
- Separate public projections from restricted evidence.
- Create explicit retention, legal-hold and deletion policies.
...
1. Reference Phase 20 records instead of duplicating source collections.
2. Use append-only events and immutable manifests.
3. Separate public projections from restricted evidence.
4. Create explicit retention, legal-hold and deletion policies.
