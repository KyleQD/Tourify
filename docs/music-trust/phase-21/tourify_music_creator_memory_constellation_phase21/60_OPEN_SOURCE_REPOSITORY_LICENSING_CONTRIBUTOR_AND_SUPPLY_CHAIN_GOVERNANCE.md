...
Govern shared reference implementations and test suites without granting software maintainers cultural authority.

## Required design decisions

- Use clear open licences, contributor terms and security policy.
- Separate technical maintainers from governance decision makers.
- Require reproducible builds and signed releases.
- Support forks and independent implementations.
...
1. Use clear open licences, contributor terms and security policy.
2. Separate technical maintainers from governance decision makers.
3. Require reproducible builds and signed releases.
4. Support forks and independent implementations.
