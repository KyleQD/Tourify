# Shared emergency preservation fund and rapid-response grants

## Purpose

Design a transparent rapid-response fund without central cultural control or donor-directed access.

## Required design decisions

- Use objective emergency eligibility and conflict controls.
- Separate grant decisions from custody and access authority.
- Publish aggregate awards and outcomes while protecting sensitive details.
- Require audit, clawback and misuse remedies.
...
1. Use objective emergency eligibility and conflict controls.
2. Separate grant decisions from custody and access authority.
3. Publish aggregate awards and outcomes while protecting sensitive details.
4. Require audit, clawback and misuse remedies.
