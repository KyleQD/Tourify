# Environmental footprint, energy, water, materials and climate duty

## Purpose

Measure and reduce the ecological burden of replication, storage, transport, cooling and recovery.

## Required design decisions

- Track lifecycle impacts and local resource constraints.
- Prefer efficient preservation tiers over indiscriminate duplication.
- Avoid shifting environmental harms to underserved communities.
- Publish methods, targets and exceptions.
...
1. Track lifecycle impacts and local resource constraints.
2. Prefer efficient preservation tiers over indiscriminate duplication.
3. Avoid shifting environmental harms to underserved communities.
4. Publish methods, targets and exceptions.
