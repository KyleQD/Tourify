# Future-generations voice, limits and long-horizon review

## Purpose

Include long-term impact and future creator interests without claiming to legally represent future persons.

## Required design decisions

- Use advisory panels, foresight and impact assessments.
- Disclose uncertainty and current-generation conflicts.
- Preserve sunset and reauthorization.
- Do not override current creator or community rights through speculative benefit.
...
1. Use advisory panels, foresight and impact assessments.
2. Disclose uncertainty and current-generation conflicts.
3. Preserve sunset and reauthorization.
4. Do not override current creator or community rights through speculative benefit.
