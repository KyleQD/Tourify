# Training, simulation, mutual-aid exercises and after-action review

## Purpose

Institutionalize drills for climate, fire, flood, conflict, cyberattack, archive loss and provider failure.

## Required design decisions

- Test technical and governance pathways together.
- Include community and accessibility participants.
- Record exercise assumptions, failures and corrective actions.
- Repeat provider-replacement and Tourify-unavailable drills.
...
1. Test technical and governance pathways together.
2. Include community and accessibility participants.
3. Record exercise assumptions, failures and corrective actions.
4. Repeat provider-replacement and Tourify-unavailable drills.
