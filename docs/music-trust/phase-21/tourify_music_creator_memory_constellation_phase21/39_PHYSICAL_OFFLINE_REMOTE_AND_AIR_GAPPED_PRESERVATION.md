# Physical, offline, remote and air-gapped preservation

## Purpose

Coordinate resilient physical and offline copies without treating remoteness as a substitute for governance.

## Required design decisions

- Use threat-specific copy tiers and environmental monitoring.
- Preserve readable documentation and recovery equipment.
- Maintain custody, restrictions and inspection rights.
- Test restoration from fully offline copies.
...
1. Use threat-specific copy tiers and environmental monitoring.
2. Preserve readable documentation and recovery equipment.
3. Maintain custody, restrictions and inspection rights.
4. Test restoration from fully offline copies.
