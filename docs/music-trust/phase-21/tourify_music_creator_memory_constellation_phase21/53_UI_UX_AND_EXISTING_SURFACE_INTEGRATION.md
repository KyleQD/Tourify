...
Add trust-node, mutual-aid, risk, custody, restriction and incident surfaces without altering existing music experiences.

## Required design decisions

- Show legal character, authority, restrictions and status clearly.
- Provide accessible notice, consent, withdrawal, appeals and export.
- Avoid maps that expose sensitive facility locations.
- Keep existing upload and playback surfaces unchanged.
...
1. Show legal character, authority, restrictions and status clearly.
2. Provide accessible notice, consent, withdrawal, appeals and export.
3. Avoid maps that expose sensitive facility locations.
4. Keep existing upload and playback surfaces unchanged.
