# Sovereignty, subsidiarity, reserved powers and no override

## Purpose

Prevent the constellation, funders, operators or emergency responders from overriding lawful creator, community, trust or national decisions.

## Required design decisions

- Keep decisions at the lowest competent authority.
- Record exact delegated powers and excluded powers.
- Default ambiguous authority to deny.
- Prohibit central override by software configuration.
...
1. Keep decisions at the lowest competent authority.
2. Record exact delegated powers and excluded powers.
3. Default ambiguous authority to deny.
4. Prohibit central override by software configuration.
