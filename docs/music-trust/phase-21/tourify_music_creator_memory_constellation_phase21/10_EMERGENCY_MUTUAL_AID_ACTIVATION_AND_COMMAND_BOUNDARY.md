# Emergency mutual-aid activation and command boundary

## Purpose

Define who may request, approve, coordinate and terminate cross-trust emergency preservation assistance.

## Required design decisions

- Prioritize life safety and lawful emergency command.
- Require source-custodian or competent-authority request except narrowly documented rescue conditions.
- Keep cultural and privacy restrictions attached during response.
- Use incident objectives, operational periods and demobilization criteria.
...
1. Prioritize life safety and lawful emergency command.
2. Require source-custodian or competent-authority request except narrowly documented rescue conditions.
3. Keep cultural and privacy restrictions attached during response.
4. Use incident objectives, operational periods and demobilization criteria.
