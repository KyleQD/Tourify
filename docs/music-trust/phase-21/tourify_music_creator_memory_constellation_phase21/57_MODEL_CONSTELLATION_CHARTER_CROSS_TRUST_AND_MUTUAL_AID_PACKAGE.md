# Model constellation charter, cross-trust and mutual-aid package

## Purpose

Provide model clauses, schedules, forms, evidence checklists and state transitions for counsel and public review.

## Required design decisions

- Label all materials as models requiring jurisdictional adaptation.
- Include prohibited powers and local reserved powers.
- Include incident, funding, custody, return, withdrawal and dissolution schedules.
- Separate signatures from technical credentials.
...
1. Label all materials as models requiring jurisdictional adaptation.
2. Include prohibited powers and local reserved powers.
3. Include incident, funding, custody, return, withdrawal and dissolution schedules.
4. Separate signatures from technical credentials.
