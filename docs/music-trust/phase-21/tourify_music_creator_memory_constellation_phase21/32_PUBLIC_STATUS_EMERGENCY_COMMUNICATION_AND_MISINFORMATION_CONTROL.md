# Public status, emergency communication and misinformation control

## Purpose

Communicate incidents, stale data, service limits and recovery without exposing sensitive locations or restricted records.

## Required design decisions

- Use verified incident owners and signed notices.
- Publish legal character and service scope.
- Correct misinformation without adjudicating cultural or rights disputes.
- Provide multilingual and low-bandwidth channels.
...
1. Use verified incident owners and signed notices.
2. Publish legal character and service scope.
3. Correct misinformation without adjudicating cultural or rights disputes.
4. Provide multilingual and low-bandwidth channels.
