# Provider replacement, data portability, reimplementation and Tourify exit

## Purpose

Prove the constellation and each trust can migrate providers, export records and operate without Tourify.

## Required design decisions

- Publish open schemas and export formats.
- Require independent restore and replay.
- Transfer no hidden dependencies or proprietary authority.
- Document decommissioning and key succession.
...
1. Publish open schemas and export formats.
2. Require independent restore and replay.
3. Transfer no hidden dependencies or proprietary authority.
4. Document decommissioning and key succession.
