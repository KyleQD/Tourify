# Observability, preservation health, risk and public reporting

## Purpose

Monitor package health, capacity, incidents, restrictions, transfers, funding and independence.

## Required design decisions

- Define internal and public indicators separately.
- Alert on stale manifests, failed fixity, unsupported restrictions and concentration.
- Track mutual-aid response and recovery outcomes.
- Avoid vanity metrics and cultural-value rankings.
...
1. Define internal and public indicators separately.
2. Alert on stale manifests, failed fixity, unsupported restrictions and concentration.
3. Track mutual-aid response and recovery outcomes.
4. Avoid vanity metrics and cultural-value rankings.
