# Planetary risk intelligence and preservation-capacity map

## Purpose

Map hazards, capabilities and gaps without exposing sensitive facility locations or ranking cultures.

## Required design decisions

- Separate public regional indicators from restricted site details.
- Record data sources, confidence, freshness and uncertainty.
- Avoid cultural-value scoring as a resource-allocation shortcut.
- Use the map for preparedness and mutual aid, not compulsory collection.
...
1. Separate public regional indicators from restricted site details.
2. Record data sources, confidence, freshness and uncertainty.
3. Avoid cultural-value scoring as a resource-allocation shortcut.
4. Use the map for preparedness and mutual aid, not compulsory collection.
