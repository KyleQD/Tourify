...
Define authenticated, idempotent and replay-safe routes and workers for agreements, mutual aid, transfers and public projections.

## Required design decisions

- Use exact-scope schemas and current-source authorization.
- Sign inter-trust messages and webhook payloads.
- Use outbox, inbox, dead-letter and reconciliation patterns.
- Expose public projections only through purpose-specific routes.
...
1. Use exact-scope schemas and current-source authorization.
2. Sign inter-trust messages and webhook payloads.
3. Use outbox, inbox, dead-letter and reconciliation patterns.
4. Expose public projections only through purpose-specific routes.
