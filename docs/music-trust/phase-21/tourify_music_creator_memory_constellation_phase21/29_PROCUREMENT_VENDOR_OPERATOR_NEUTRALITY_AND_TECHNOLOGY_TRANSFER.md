# Procurement, vendor and operator neutrality, and technology transfer

## Purpose

Create fair procurement and technology-transfer rules that preserve open interoperability and local capacity.

## Required design decisions

- Require export, documentation and exit terms.
- Avoid single-cloud and single-vendor dependency.
- Evaluate supply-chain, sanctions, security and environmental risks.
- Return knowledge and operational capacity to local institutions.
...
1. Require export, documentation and exit terms.
2. Avoid single-cloud and single-vendor dependency.
3. Evaluate supply-chain, sanctions, security and environmental risks.
4. Return knowledge and operational capacity to local institutions.
