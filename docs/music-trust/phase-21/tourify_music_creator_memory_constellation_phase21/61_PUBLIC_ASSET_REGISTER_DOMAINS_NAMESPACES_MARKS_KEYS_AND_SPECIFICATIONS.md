# Public asset register for domains, namespaces, marks, keys and specifications

## Purpose

Record ownership, stewardship, custody, operator and successor status for critical constellation assets.

## Required design decisions

- Distinguish legal owner, beneficial steward, custodian and operator.
- Use neutral custody or escrow where approved.
- Publish non-sensitive status and succession rules.
- Block irreversible transfer without public approval and rollback.
...
1. Distinguish legal owner, beneficial steward, custodian and operator.
2. Use neutral custody or escrow where approved.
3. Publish non-sensitive status and succession rules.
4. Block irreversible transfer without public approval and rollback.
