# Funding concentration, reserves, donor independence and equity

## Purpose

Prevent one funder, region, platform or trust from capturing constellation priorities.

## Required design decisions

- Set concentration thresholds and disclosure rules.
- Maintain emergency and continuity reserves.
- Use equity review for allocation methods.
- Prohibit funding conditions that demand access, publicity or reuse rights.
...
1. Set concentration thresholds and disclosure rules.
2. Maintain emergency and continuity reserves.
3. Use equity review for allocation methods.
4. Prohibit funding conditions that demand access, publicity or reuse rights.
