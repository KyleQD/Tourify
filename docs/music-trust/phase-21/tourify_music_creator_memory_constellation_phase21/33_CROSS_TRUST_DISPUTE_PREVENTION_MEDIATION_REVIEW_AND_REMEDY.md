# Cross-trust dispute prevention, mediation, review and remedy

## Purpose

Resolve agreement, custody, restriction, service and funding disputes without creating a global cultural court.

## Required design decisions

- Use consultation and mediation before formal review when safe.
- Preserve local courts, regulators and community processes.
- Provide interim suspension and evidence preservation.
- Publish only appropriately minimized decisions.
...
1. Use consultation and mediation before formal review when safe.
2. Preserve local courts, regulators and community processes.
3. Provide interim suspension and evidence preservation.
4. Publish only appropriately minimized decisions.
