...
Give Codex an audit-first, evidence-gated, non-destructive implementation instruction set for Phase 21.

## Required design decisions

- Audit repository and deployed schema before editing.
- Convert the template to `phase-21-execution-plan.json` and update it continuously.
- Stop at legal, cultural, scientific, provider or authority blockers.
- Preserve existing product behavior and record all evidence.
...
1. Audit repository and deployed schema before editing.
2. Convert the template to `phase-21-execution-plan.json` and update it continuously.
3. Stop at legal, cultural, scientific, provider or authority blockers.
4. Preserve existing product behavior and record all evidence.
