# Testing, multi-trust pilot, planetary resilience and rollout

## Purpose

Define sandbox, pilot, review, rollback and production evidence for several independent trusts.

## Required design decisions

- Require at least three independent trusts and two implementations.
- Run climate, conflict, cyber, provider, funder and network-partition exercises.
- Test temporary custody return and restriction conflicts.
- Keep remote and orbital work research-only.
...
1. Require at least three independent trusts and two implementations.
2. Run climate, conflict, cyber, provider, funder and network-partition exercises.
3. Test temporary custody return and restriction conflicts.
4. Keep remote and orbital work research-only.
