...
Define shared terminology, legal-character labels, lifecycle states, actor roles and authoritative sources.

## Required design decisions

- Keep custody, ownership, access, disclosure and reuse distinct.
- Keep member, trust node, custodian, responder and verifier roles distinct.
- Map every public projection to its authoritative source.
- Preserve historical policy and schema meaning.
...
1. Keep custody, ownership, access, disclosure and reuse distinct.
2. Keep member, trust node, custodian, responder and verifier roles distinct.
3. Map every public projection to its authoritative source.
4. Preserve historical policy and schema meaning.
