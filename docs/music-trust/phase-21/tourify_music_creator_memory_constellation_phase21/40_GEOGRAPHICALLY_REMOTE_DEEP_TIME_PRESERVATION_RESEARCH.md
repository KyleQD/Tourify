# Geographically remote deep-time preservation research

## Purpose

Evaluate polar, underground, desert, mountain, maritime or other remote preservation only through separate scientific, legal and community approval.

## Required design decisions

- Keep research and production deployment separate.
- Assess sovereignty, Indigenous rights, environmental impact, logistics and retrieval.
- Avoid symbolic projects that displace basic preservation funding.
- Require reversibility and independent recovery tests.
...
1. Keep research and production deployment separate.
2. Assess sovereignty, Indigenous rights, environmental impact, logistics and retrieval.
3. Avoid symbolic projects that displace basic preservation funding.
4. Require reversibility and independent recovery tests.
