# Orbital and extraterritorial preservation research boundary

## Purpose

Define a research-only gate for orbital or other extraterritorial preservation concepts.

## Required design decisions

- Disable launch, payload and orbital deployment features by default.
- Require competent state authorization, launch licensing and treaty analysis.
- Assess debris, collision, spectrum, radiation, reentry, retrieval and liability risks.
- Prohibit presenting orbital storage as safer or more durable without evidence.
...
1. Disable launch, payload and orbital deployment features by default.
2. Require competent state authorization, launch licensing and treaty analysis.
3. Assess debris, collision, spectrum, radiation, reentry, retrieval and liability risks.
4. Prohibit presenting orbital storage as safer or more durable without evidence.
