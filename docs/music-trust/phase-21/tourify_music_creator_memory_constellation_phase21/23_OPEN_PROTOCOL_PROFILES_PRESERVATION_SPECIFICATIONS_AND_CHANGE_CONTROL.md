# Open protocol profiles, preservation specifications and change control

## Purpose

Publish vendor-neutral exchange, restriction, incident and preservation profiles with governed versioning.

## Required design decisions

- Use open specifications and test vectors.
- Separate normative requirements from implementation guidance.
- Require compatibility, migration and deprecation analysis.
- Preserve historic profiles for replay.
...
1. Use open specifications and test vectors.
2. Separate normative requirements from implementation guidance.
3. Require compatibility, migration and deprecation analysis.
4. Preserve historic profiles for replay.
