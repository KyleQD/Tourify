# Long-lived identifiers, schemas, aliases and tombstones

## Purpose

Coordinate identifiers and schema references across trusts while preserving local namespaces and historical meaning.

## Required design decisions

- Avoid one mandatory global identifier.
- Support aliases, redirects, tombstones and successor resolution.
- Record method, controller, version and status.
- Never recycle identifiers for unrelated records.
...
1. Avoid one mandatory global identifier.
2. Support aliases, redirects, tombstones and successor resolution.
3. Record method, controller, version and status.
4. Never recycle identifiers for unrelated records.
