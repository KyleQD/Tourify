# Public charter and mutual-aid compact

## Purpose

Define a public charter and model mutual-aid compact with narrow powers, rights, limitations and exit.

## Required design decisions

- Publish purposes, prohibited powers and amendment rules.
- Require explicit accession and withdrawal by each trust.
- Make emergency assistance time-bounded and reviewable.
- Preserve community and local reserved powers.
...
1. Publish purposes, prohibited powers and amendment rules.
2. Require explicit accession and withdrawal by each trust.
3. Make emergency assistance time-bounded and reviewable.
4. Preserve community and local reserved powers.
