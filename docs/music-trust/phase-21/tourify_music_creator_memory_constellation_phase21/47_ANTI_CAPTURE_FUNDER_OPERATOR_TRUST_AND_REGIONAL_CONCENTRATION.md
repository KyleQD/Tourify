# Anti-capture across funders, operators, trusts and regions

## Purpose

Detect and constrain concentration that could turn the constellation into a de facto central authority.

## Required design decisions

- Measure governance, funding, operator, jurisdiction and technical concentration.
- Use recusal, caps, rotation and independent review.
- Preserve minority and local exit rights.
- Block emergency powers from becoming permanent control.
...
1. Measure governance, funding, operator, jurisdiction and technical concentration.
2. Use recusal, caps, rotation and independent review.
3. Preserve minority and local exit rights.
4. Block emergency powers from becoming permanent control.
