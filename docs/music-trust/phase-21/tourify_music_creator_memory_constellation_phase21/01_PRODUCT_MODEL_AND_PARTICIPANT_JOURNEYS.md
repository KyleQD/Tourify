...
Map creator, community, trust, custodian, responder, funder, auditor and public-user journeys across normal and emergency conditions.

## Required design decisions

- Separate discovery, assistance request, approval, execution, reconciliation and public reporting.
- Provide creator and community visibility into every cross-trust action affecting their records.
- Show legal character, custody scope, restrictions and dispute state prominently.
- Design accessible, multilingual and low-bandwidth journeys.
...
1. Separate discovery, assistance request, approval, execution, reconciliation and public reporting.
2. Provide creator and community visibility into every cross-trust action affecting their records.
3. Show legal character, custody scope, restrictions and dispute state prominently.
4. Design accessible, multilingual and low-bandwidth journeys.
