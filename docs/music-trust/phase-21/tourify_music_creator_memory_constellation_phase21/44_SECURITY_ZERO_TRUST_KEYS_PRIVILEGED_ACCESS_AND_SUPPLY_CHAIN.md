# Security, zero trust, keys, privileged access and supply chain

## Purpose

Protect constellation communications, manifests, restrictions, registries and emergency controls.

## Required design decisions

- Use hardware-backed keys and separation of duties for critical actions.
- Use short-lived credentials, signed messages and append-only audit.
- Plan root and algorithm succession.
- Continuously assess software, hardware and provider supply chains.
...
1. Use hardware-backed keys and separation of duties for critical actions.
2. Use short-lived credentials, signed messages and append-only audit.
3. Plan root and algorithm succession.
4. Continuously assess software, hardware and provider supply chains.
