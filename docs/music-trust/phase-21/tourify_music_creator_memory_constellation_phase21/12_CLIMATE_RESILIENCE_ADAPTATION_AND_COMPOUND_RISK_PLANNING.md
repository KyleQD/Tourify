# Climate resilience, adaptation and compound-risk planning

## Purpose

Integrate climate, environmental and infrastructure risks into preservation planning and funding.

## Required design decisions

- Assess heat, flood, fire, storm, drought, sea-level, power and supply-chain risks.
- Model compound and cascading failures.
- Fund adaptation without forcing collection relocation.
- Publish methods and uncertainty while restricting site-security data.
...
1. Assess heat, flood, fire, storm, drought, sea-level, power and supply-chain risks.
2. Model compound and cascading failures.
3. Fund adaptation without forcing collection relocation.
4. Publish methods and uncertainty while restricting site-security data.
