# Mutual-aid roster, resources, logistics and deployment

## Purpose

Coordinate qualified people, equipment, storage, transport, translation and technical resources for emergencies.

## Required design decisions

- Verify credentials, safety, insurance and scope before deployment.
- Support remote and local-first assistance.
- Track resource custody and return.
- Prohibit responders from retaining copies or credentials beyond the mission.
...
1. Verify credentials, safety, insurance and scope before deployment.
2. Support remote and local-first assistance.
3. Track resource custody and return.
4. Prohibit responders from retaining copies or credentials beyond the mission.
