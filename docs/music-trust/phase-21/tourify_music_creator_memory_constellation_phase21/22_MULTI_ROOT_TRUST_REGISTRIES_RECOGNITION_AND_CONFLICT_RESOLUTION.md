# Multi-root trust registries, recognition and conflict resolution

## Purpose

Define plural trust roots and recognition lists without establishing one supreme trust authority.

## Required design decisions

- Allow independent roots and scoped cross-recognition.
- Publish recognition basis, scope, term and revocation.
- Handle conflicting roots through verifier policy and human review.
- Require emergency root suspension and recovery drills.
...
1. Allow independent roots and scoped cross-recognition.
2. Publish recognition basis, scope, term and revocation.
3. Handle conflicting roots through verifier policy and human review.
4. Require emergency root suspension and recovery drills.
