# Phase 21 public approval and activation gate

## Purpose

Define the final evidence, independent approvals, feature scopes and stop conditions for any limited Phase 21 activation.

## Required design decisions

- Require valid charters and cross-trust agreements.
- Require three independent trusts, two implementations and successful mutual-aid drills.
- Require privacy, cultural, security, climate, conflict, funding and public-interest approval.
- Keep orbital and extraterritorial deployment disabled.
...
1. Require valid charters and cross-trust agreements.
2. Require three independent trusts, two implementations and successful mutual-aid drills.
3. Require privacy, cultural, security, climate, conflict, funding and public-interest approval.
4. Keep orbital and extraterritorial deployment disabled.
