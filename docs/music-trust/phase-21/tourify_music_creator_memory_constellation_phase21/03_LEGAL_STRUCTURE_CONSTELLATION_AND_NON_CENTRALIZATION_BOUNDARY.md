# Legal structure, constellation and non-centralization boundary

## Purpose

Evaluate contractual network, nonprofit consortium and other structures without creating one global archive or inherited authority.

## Required design decisions

- Keep each trust legally independent and accountable under its own governing law.
- Limit the constellation to enumerated coordination functions.
- Prohibit implied agency, partnership, ownership transfer and general representation.
- Require separate liability, insurance and dispute analysis.
...
1. Keep each trust legally independent and accountable under its own governing law.
2. Limit the constellation to enumerated coordination functions.
3. Prohibit implied agency, partnership, ownership transfer and general representation.
4. Require separate liability, insurance and dispute analysis.
