# Benefit sharing, research-output review and community return

## Purpose

Govern benefits and outputs from approved research or preservation innovation without commodifying cultural authority.

## Required design decisions

- Define nonfinancial and financial benefits transparently.
- Require output review for disclosure and re-identification risk.
- Return documentation, tools and capacity to source communities.
- Use Phase 3 accounting only if actual monetary allocations are approved.
...
1. Define nonfinancial and financial benefits transparently.
2. Require output review for disclosure and re-identification risk.
3. Return documentation, tools and capacity to source communities.
4. Use Phase 3 accounting only if actual monetary allocations are approved.
