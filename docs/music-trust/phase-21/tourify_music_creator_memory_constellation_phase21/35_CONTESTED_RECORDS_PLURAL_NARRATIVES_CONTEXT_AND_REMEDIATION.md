# Contested records, plural narratives, context and remediation

## Purpose

Preserve disputes, dissent, corrections and community statements across trust boundaries.

## Required design decisions

- Do not overwrite historical versions silently.
- Link competing claims and supporting sources.
- Protect people from harmful or defamatory publication.
- Provide correction, contextualization and appeal workflows.
...
1. Do not overwrite historical versions silently.
2. Link competing claims and supporting sources.
3. Protect people from harmful or defamatory publication.
4. Provide correction, contextualization and appeal workflows.
