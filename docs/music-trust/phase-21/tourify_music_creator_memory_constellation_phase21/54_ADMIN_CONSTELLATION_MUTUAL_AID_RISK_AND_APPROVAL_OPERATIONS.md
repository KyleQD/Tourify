# Admin Constellation, mutual-aid, risk and approval operations

## Purpose

Define queues, dual controls, reviewer roles, incident ownership and evidence requirements.

## Required design decisions

- Separate trust, cultural, privacy, security, scientific, funding and operator approvals.
- Use least privilege and queue segregation.
- Record public communication duties and deadlines.
- Prohibit super-admin bypass of local authority.
...
1. Separate trust, cultural, privacy, security, scientific, funding and operator approvals.
2. Use least privilege and queue segregation.
3. Record public communication duties and deadlines.
4. Prohibit super-admin bypass of local authority.
