# Incident classification, severity thresholds and escalation

## Purpose

Create common incident tiers, response objectives, owners, escalation paths and public-communication duties.

## Required design decisions

- Classify preservation, security, cultural, privacy and governance impacts separately.
- Trigger mutual aid only when local capacity is insufficient or specifically requested.
- Define response targets and review cadence.
- Require after-action and corrective-action records.
...
1. Classify preservation, security, cultural, privacy and governance impacts separately.
2. Trigger mutual aid only when local capacity is insufficient or specifically requested.
3. Define response targets and review cadence.
4. Require after-action and corrective-action records.
