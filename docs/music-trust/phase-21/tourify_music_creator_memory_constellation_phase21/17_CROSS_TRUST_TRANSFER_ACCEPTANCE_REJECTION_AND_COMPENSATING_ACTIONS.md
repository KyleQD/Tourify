# Cross-trust transfer acceptance, rejection and compensating actions

## Purpose

Define preflight checks, acceptance states, partial failure, rejection, rollback and repair for cross-trust transfers.

## Required design decisions

- Require receiver capability and policy compatibility before transfer.
- Use idempotency and signed acknowledgements.
- Do not delete source copies before verified acceptance and policy authorization.
- Preserve compensating actions for every irreversible external step.
...
1. Require receiver capability and policy compatibility before transfer.
2. Use idempotency and signed acknowledgements.
3. Do not delete source copies before verified acceptance and policy authorization.
4. Preserve compensating actions for every irreversible external step.
