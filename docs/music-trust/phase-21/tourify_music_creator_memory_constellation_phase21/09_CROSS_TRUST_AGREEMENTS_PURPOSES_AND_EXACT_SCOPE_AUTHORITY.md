# Cross-trust agreements, purposes and exact-scope authority

## Purpose

Define bilateral and multilateral agreements for specific preservation, restoration, training or emergency services.

## Required design decisions

- Identify exact collections, purposes, actions, recipients, locations and duration.
- Prohibit onward transfer and reuse unless explicitly approved.
- Define return, deletion, reconciliation and incident duties.
- Record governing law and dispute forum.
...
1. Identify exact collections, purposes, actions, recipients, locations and duration.
2. Prohibit onward transfer and reuse unless explicitly approved.
3. Define return, deletion, reconciliation and incident duties.
4. Record governing law and dispute forum.
