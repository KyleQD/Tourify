# External review, trustworthy-repository assurance and reassessment

## Purpose

Require independent technical, governance, cultural, privacy, security and resilience review.

## Required design decisions

- Treat standards alignment and certification as scoped evidence, not absolute safety.
- Publish review scope, findings, exceptions and expiry.
- Require reassessment after major incidents or changes.
- Provide review independence and conflict disclosures.
...
1. Treat standards alignment and certification as scoped evidence, not absolute safety.
2. Publish review scope, findings, exceptions and expiry.
3. Require reassessment after major incidents or changes.
4. Provide review independence and conflict disclosures.
