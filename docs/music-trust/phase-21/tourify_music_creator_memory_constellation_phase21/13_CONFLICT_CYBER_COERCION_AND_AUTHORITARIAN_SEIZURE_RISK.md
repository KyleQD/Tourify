# Conflict, cyber, coercion and authoritarian seizure risk

## Purpose

Protect records and communities during conflict, occupation, cyberattack, coercive access demands and institutional capture.

## Required design decisions

- Use legal, security and human-rights review before evacuation or disclosure.
- Support encrypted, compartmented and geographically separated copies.
- Do not publish locations that increase targeting risk.
- Preserve evidence of coercion and disputed authority.
...
1. Use legal, security and human-rights review before evacuation or disclosure.
2. Support encrypted, compartmented and geographically separated copies.
3. Do not publish locations that increase targeting risk.
4. Preserve evidence of coercion and disputed authority.
