# Conformance testing, mutual recognition and appeals

## Purpose

Establish independent testing for trust nodes, packages, restriction propagation, recovery and interoperability.

## Required design decisions

- Require at least two independent test implementations.
- Separate conformance from legal or cultural authority.
- Publish scope and expiry of recognition.
- Provide correction and appeal for failed or revoked status.
...
1. Require at least two independent test implementations.
2. Separate conformance from legal or cultural authority.
3. Publish scope and expiry of recognition.
4. Provide correction and appeal for failed or revoked status.
