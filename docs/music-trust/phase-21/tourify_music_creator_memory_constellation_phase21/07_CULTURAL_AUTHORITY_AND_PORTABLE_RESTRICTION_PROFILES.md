# Cultural authority and portable restriction profiles

## Purpose

Define how cultural authority and collection restrictions travel across trust boundaries without becoming universal claims.

## Required design decisions

- Represent authority by community, material class, purpose, territory and term.
- Version restriction profiles and preserve source signatures.
- Apply the stricter compatible rule when profiles conflict.
- Require periodic authority revalidation.
...
1. Represent authority by community, material class, purpose, territory and term.
2. Version restriction profiles and preserve source signatures.
3. Apply the stricter compatible rule when profiles conflict.
4. Require periodic authority revalidation.
