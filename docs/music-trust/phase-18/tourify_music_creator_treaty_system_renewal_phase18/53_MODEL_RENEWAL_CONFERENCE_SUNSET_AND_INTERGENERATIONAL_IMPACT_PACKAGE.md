# Model renewal conference and impact package

## Purpose

Provides a model mandate, evidence baseline, consultation plan, impact assessment, decision instrument and implementation schedule.
...
The model package includes a renewal mandate, baseline evidence manifest, horizon scan, future-generations impact assessment, creator consultation plan, independent evaluation terms, conflicts register, draft decision, implementation schedule, sunset schedule, archive schedule and public communications plan.
