# Phase 18 — Treaty-System Renewal and Intergenerational Stewardship Handoff

## Purpose

Define only a future handoff after repeated lawful review cycles and demonstrated generational continuity.
...
1. Prove repeated Phase 17 cycles.
2. Define long-horizon renewal and sunset questions.
3. Assess future-generation and structural risks.
4. Create separate legal and public approval package.
5. Keep all Phase 18 flags absent from Phase 17.

## Required design decisions

- No perpetual institution by default.
- No inherited authority beyond effective instruments.
- Intergenerational review must preserve local exit and creator rights.
