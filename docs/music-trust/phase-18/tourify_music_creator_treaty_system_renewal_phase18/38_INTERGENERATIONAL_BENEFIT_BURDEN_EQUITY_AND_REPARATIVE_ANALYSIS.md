# Intergenerational benefit, burden and reparative analysis

## Purpose

Tests whether current benefits create future costs, lock-in, exclusion, environmental burden or unresolved historical harm.
...
Assess consequences across at least immediate, medium, long and very-long horizons. Record affected groups, uncertainty, irreversibility, option value, lock-in, distribution of benefits and burdens, plausible alternatives and a future-review trigger. Advisory future-generation roles do not override current lawful rights.
