...
Defines additive tables, exact-scope RLS, restricted evidence, public projections, immutable manifests and retention controls.
...
Reference tables should include renewal packages, review cycles, horizon risks, impact assessments, archival packages, custody transfers, authority revalidations, succession cases, sunset decisions, service decommissions, funding reserves, oversight renewals, public projections, incidents, audit events and outbox messages. All tables use tenant/entity keys and default-deny RLS.
