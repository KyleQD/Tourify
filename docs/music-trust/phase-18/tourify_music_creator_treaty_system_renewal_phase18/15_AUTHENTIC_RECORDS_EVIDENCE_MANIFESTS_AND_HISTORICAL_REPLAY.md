# Authentic records, evidence manifests and historical replay

## Purpose

Makes historical decisions reproducible under the exact policy, schema, source and authority versions that applied.
