# Public-service and protocol portfolio renewal

## Purpose

Reviews each service and protocol against authority, outcomes, demand, cost, risk, accessibility and replaceability.
