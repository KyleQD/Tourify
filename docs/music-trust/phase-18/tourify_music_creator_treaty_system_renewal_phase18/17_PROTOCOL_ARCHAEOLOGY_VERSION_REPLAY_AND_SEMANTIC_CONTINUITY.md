# Protocol archaeology, version replay and semantic continuity

## Purpose

Preserves old schemas, test vectors, migrations, definitions and interpreters so legacy records remain understandable.
