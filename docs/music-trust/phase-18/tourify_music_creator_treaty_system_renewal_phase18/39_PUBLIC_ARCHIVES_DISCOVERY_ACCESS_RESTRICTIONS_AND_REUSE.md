# Public archives, discovery and reuse

## Purpose

Creates catalogs, provenance, access restrictions, review dates, inclusive discovery and lawful reuse without exposing restricted evidence.
