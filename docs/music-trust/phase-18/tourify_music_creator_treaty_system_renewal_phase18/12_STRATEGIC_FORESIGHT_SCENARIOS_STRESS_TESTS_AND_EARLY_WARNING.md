# Strategic foresight, scenarios and early warning

## Purpose

Uses multiple plausible futures, horizon scanning, stress tests and leading indicators rather than single-point forecasts.
