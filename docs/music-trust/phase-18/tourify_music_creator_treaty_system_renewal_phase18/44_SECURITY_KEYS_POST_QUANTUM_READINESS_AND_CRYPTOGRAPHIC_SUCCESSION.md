# Security, keys and post-quantum readiness

## Purpose

Defines algorithm inventories, crypto-agility, key ceremonies, compromise response, trust-root succession and historical verification.
