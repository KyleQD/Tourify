# Local sovereignty, exit, creator rights and provider portability

## Purpose

Preserves local decisions, creator rights, withdrawal, export and independent provider choice across renewal cycles.
