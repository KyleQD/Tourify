# Service sunset, decommission, revival and termination

## Purpose

Defines safe shutdown, redirects, data export, archival survival, dependency migration, notice and remedy.
