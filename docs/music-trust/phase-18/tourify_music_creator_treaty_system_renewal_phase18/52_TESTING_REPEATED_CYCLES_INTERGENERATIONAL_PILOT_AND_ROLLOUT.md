# Testing, repeated cycles and rollout

## Purpose

Requires repeated simulated cycles, independent operators, future-generation review, archival restore and Tourify-unavailable tests.
...
The pilot must simulate at least three review/renewal cycles, one denied renewal, one service sunset, one participant succession, one archive-custody transfer, one cryptographic migration, one operator replacement, one dissolution rehearsal and a complete Tourify-unavailable period.
