# Participant succession and no inherited authority

## Purpose

Separates succession evidence from inherited authority and requires current lawful recognition for each successor.
