# Identifier, credential, wallet and trust-root longevity

## Purpose

Separates identifier persistence from provider continuity and defines migration, rotation, recovery, deprecation and revocation.
