# Renewal lifecycle state machine and decision rights

## Purpose

Defines explicit renewal states, actor permissions, evidence, deadlines, appeals and compensating rollback.
