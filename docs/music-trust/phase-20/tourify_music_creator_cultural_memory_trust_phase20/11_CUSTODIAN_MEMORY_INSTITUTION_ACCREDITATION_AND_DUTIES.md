# Custodian and memory-institution accreditation

## Purpose

Defines qualification, reassessment, duties and removal for deep-time custodians.

## Required design decisions

- Require governance, preservation, security, staffing, funding and remedy evidence.
- Assess ISO 16363 alignment without claiming certification unless obtained.
- Require independent restore and provider replacement.
- Suspend custodians that cannot preserve restrictions or provenance.
...
1. Require governance, preservation, security, staffing, funding and remedy evidence.
2. Assess ISO 16363 alignment without claiming certification unless obtained.
3. Require independent restore and provider replacement.
4. Suspend custodians that cannot preserve restrictions or provenance.
