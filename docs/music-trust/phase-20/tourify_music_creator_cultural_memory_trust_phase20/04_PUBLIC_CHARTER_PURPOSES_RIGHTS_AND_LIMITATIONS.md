# Public charter, purposes, rights and limitations

## Purpose

Defines the public charter that limits the trust's mission, powers and treatment of creators and communities.

## Required design decisions

- Entrench voluntary participation, non-compulsory deposit and no universal identity.
- State that custody does not create copyright or licensing authority.
- Guarantee correction, access review, exit, repatriation request and provider portability.
- Require periodic charter review and sunset rather than perpetual authority.
...
1. Entrench voluntary participation, non-compulsory deposit and no universal identity.
2. State that custody does not create copyright or licensing authority.
3. Guarantee correction, access review, exit, repatriation request and provider portability.
4. Require periodic charter review and sunset rather than perpetual authority.
