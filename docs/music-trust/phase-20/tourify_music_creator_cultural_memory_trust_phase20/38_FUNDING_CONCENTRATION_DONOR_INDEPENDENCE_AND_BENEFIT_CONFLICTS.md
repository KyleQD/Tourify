# Funding concentration, donor independence and benefit conflicts

## Purpose

Controls financial capture and conflicts between preservation and commercial interests.

## Required design decisions

- Set donor and revenue concentration limits.
- Disclose related parties and restricted gifts.
- Prohibit funding terms that compel disclosure or reuse.
- Create recusal, rejection and repayment procedures.
...
1. Set donor and revenue concentration limits.
2. Disclose related parties and restricted gifts.
3. Prohibit funding terms that compel disclosure or reuse.
4. Create recusal, rejection and repayment procedures.
