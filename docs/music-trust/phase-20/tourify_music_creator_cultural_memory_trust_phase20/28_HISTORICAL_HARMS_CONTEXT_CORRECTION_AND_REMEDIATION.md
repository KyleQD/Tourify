# Historical harms, context, correction and remediation

## Purpose

Defines correction of harmful descriptions, biased classifications and damaging publication histories.

## Required design decisions

- Preserve prior descriptions for accountability while preventing harmful defaults.
- Allow contextual notes, content warnings, corrected names and community statements.
- Track remediation commitments and completion.
- Avoid rewriting source evidence or erasing contested history.
...
1. Preserve prior descriptions for accountability while preventing harmful defaults.
2. Allow contextual notes, content warnings, corrected names and community statements.
3. Track remediation commitments and completion.
4. Avoid rewriting source evidence or erasing contested history.
