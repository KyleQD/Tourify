# Copyright, moral rights, archival use and non-adjudication

## Purpose

Separates preservation exceptions, licences, moral rights and public access.

## Required design decisions

- Do not infer ownership from deposit or custody.
- Record jurisdiction-specific preservation and access bases.
- Keep rights uncertainty visible.
- Block licensing, takedown or ownership conclusions without current authoritative records.
...
1. Do not infer ownership from deposit or custody.
2. Record jurisdiction-specific preservation and access bases.
3. Keep rights uncertainty visible.
4. Block licensing, takedown or ownership conclusions without current authoritative records.
