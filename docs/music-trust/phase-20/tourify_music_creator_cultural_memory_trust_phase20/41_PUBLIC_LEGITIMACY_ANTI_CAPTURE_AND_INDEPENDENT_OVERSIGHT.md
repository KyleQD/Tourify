# Public legitimacy, anti-capture and independent oversight

## Purpose

Defines public accountability, external review, conflicts, complaints and institutional replacement.

## Required design decisions

- Publish governance, funding, preservation health and incident reports.
- Create independent audit, ethics and community-review functions.
- Provide accessible complaints and remedies.
- Allow steward or operator removal without losing collections.
...
1. Publish governance, funding, preservation health and incident reports.
2. Create independent audit, ethics and community-review functions.
3. Provide accessible complaints and remedies.
4. Allow steward or operator removal without losing collections.
