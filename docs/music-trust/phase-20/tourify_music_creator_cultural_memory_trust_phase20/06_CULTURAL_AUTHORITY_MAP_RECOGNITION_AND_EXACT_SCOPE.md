# Cultural authority map, recognition and exact scope

## Purpose

Defines how cultural authorities are identified, evidenced, scoped, reviewed and challenged.

## Required design decisions

- Do not infer authority from ethnicity, geography, account ownership or archive possession.
- Record community-defined authority, territory, subject matter, term and review process.
- Allow overlapping, contested and non-exclusive authority claims.
- Require current authority at execution time.
...
1. Do not infer authority from ethnicity, geography, account ownership or archive possession.
2. Record community-defined authority, territory, subject matter, term and review process.
3. Allow overlapping, contested and non-exclusive authority claims.
4. Require current authority at execution time.
