# Legal structure, trust, fiduciary and Tourify boundary

## Purpose

Evaluates nonprofit, charitable trust, public-benefit and multi-entity structures without selecting one before counsel review.

## Required design decisions

- Separate legal owner, beneficial steward, custodian, operator and cultural authority.
- Prohibit private inurement, asset diversion and Tourify control by implication.
- Require fiduciary duties, conflict rules, remedies and dissolution provisions.
- Use a new approval package for every jurisdiction and legal form.
...
1. Separate legal owner, beneficial steward, custodian, operator and cultural authority.
2. Prohibit private inurement, asset diversion and Tourify control by implication.
3. Require fiduciary duties, conflict rules, remedies and dissolution provisions.
4. Use a new approval package for every jurisdiction and legal form.
