# Workforce succession, knowledge transfer and professional ethics

## Purpose

Defines archivist, conservator, technologist, translator and community-liaison duties.

## Required design decisions

- Maintain role competencies and succession plans.
- Protect whistleblowers and professional independence.
- Use dual control for sensitive access and destructive actions.
- Preserve operational knowledge in accessible, versioned runbooks.
...
1. Maintain role competencies and succession plans.
2. Protect whistleblowers and professional independence.
3. Use dual control for sensitive access and destructive actions.
4. Preserve operational knowledge in accessible, versioned runbooks.
