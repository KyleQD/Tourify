# Plural governance, reserved powers and subsidiarity

## Purpose

Prevents centralized governance from overriding lawful creator, community or local-organization decisions.

## Required design decisions

- Keep decisions at the narrowest competent level.
- Publish a reserved-powers schedule for each participating authority.
- Require heightened approval for cross-community or cross-jurisdiction changes.
- Default ambiguous authority to no action and human review.
...
1. Keep decisions at the narrowest competent level.
2. Publish a reserved-powers schedule for each participating authority.
3. Require heightened approval for cross-community or cross-jurisdiction changes.
4. Default ambiguous authority to no action and human review.
