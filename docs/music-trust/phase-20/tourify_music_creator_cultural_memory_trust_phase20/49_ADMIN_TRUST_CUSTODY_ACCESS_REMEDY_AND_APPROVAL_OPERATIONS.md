# Admin trust, custody, access, remedy and approval operations

## Purpose

Defines queues, separation of duties, reviewer roles and operational targets.

## Required design decisions

- Create independent queues for authority, custody, access, incidents, repatriation and corrections.
- Require dual control for destructive and disclosure-changing actions.
- Prevent Tourify super-admin from bypassing trust governance.
- Publish operational ownership and escalation paths.
...
1. Create independent queues for authority, custody, access, incidents, repatriation and corrections.
2. Require dual control for destructive and disclosure-changing actions.
3. Prevent Tourify super-admin from bypassing trust governance.
4. Publish operational ownership and escalation paths.
