# Observability, preservation health, public reporting and incidents

## Purpose

Defines metrics, alerts, public status and long-horizon indicators.

## Required design decisions

- Monitor fixity, replication, format risk, key age, restriction leakage and restore readiness.
- Separate public metrics from sensitive incident data.
- Publish stale or disputed status promptly.
- Track provider and funding concentration.
...
1. Monitor fixity, replication, format risk, key age, restriction leakage and restore readiness.
2. Separate public metrics from sensitive incident data.
3. Publish stale or disputed status promptly.
4. Track provider and funding concentration.
