# Format policy, emulation and technology reconstruction

## Purpose

Plans preservation across obsolete formats, software, hardware and interactive environments.

## Required design decisions

- Retain originals plus normalized or emulated derivatives.
- Document significant properties and known losses.
- Use open, well-documented formats when appropriate.
- Treat executable recovery environments as high-risk restricted objects.
...
1. Retain originals plus normalized or emulated derivatives.
2. Document significant properties and known losses.
3. Use open, well-documented formats when appropriate.
4. Treat executable recovery environments as high-risk restricted objects.
