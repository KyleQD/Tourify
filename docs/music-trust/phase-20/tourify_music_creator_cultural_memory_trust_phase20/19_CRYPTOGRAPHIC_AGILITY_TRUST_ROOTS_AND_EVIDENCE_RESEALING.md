# Cryptographic agility, trust roots and evidence resealing

## Purpose

Plans key succession, multi-root trust and verification after algorithm deprecation.

## Required design decisions

- Preserve original signatures and verification context.
- Add new evidence envelopes rather than overwriting old signatures.
- Use hardware-backed keys and dual control for critical operations.
- Test compromise, rotation, loss and custodian succession.
...
1. Preserve original signatures and verification context.
2. Add new evidence envelopes rather than overwriting old signatures.
3. Use hardware-backed keys and dual control for critical operations.
4. Test compromise, rotation, loss and custodian succession.
