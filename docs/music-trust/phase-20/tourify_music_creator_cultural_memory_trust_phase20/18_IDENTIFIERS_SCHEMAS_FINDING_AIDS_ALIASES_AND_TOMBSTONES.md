# Identifiers, schemas, finding aids, aliases and tombstones

## Purpose

Defines durable references without creating universal identity or permanent authority.

## Required design decisions

- Support aliases, redirects, mergers, splits and tombstones.
- Never recycle identifiers.
- Keep public finding aids minimal and source-linked.
- Require current source records for high-impact actions.
...
1. Support aliases, redirects, mergers, splits and tombstones.
2. Never recycle identifiers.
3. Keep public finding aids minimal and source-linked.
4. Require current source records for high-impact actions.
