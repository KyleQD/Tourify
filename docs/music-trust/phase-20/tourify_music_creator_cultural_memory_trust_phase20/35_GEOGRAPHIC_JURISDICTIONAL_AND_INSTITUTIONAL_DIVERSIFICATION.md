# Geographic, jurisdictional and institutional diversification

## Purpose

Prevents correlated failure and political or vendor capture.

## Required design decisions

- Set concentration thresholds for countries, clouds, funders and operators.
- Review sanctions, export, localization and conflict risks.
- Avoid locating all complete copies in one legal order.
- Support lawful regional and community-controlled custody.
...
1. Set concentration thresholds for countries, clouds, funders and operators.
2. Review sanctions, export, localization and conflict risks.
3. Avoid locating all complete copies in one legal order.
4. Support lawful regional and community-controlled custody.
