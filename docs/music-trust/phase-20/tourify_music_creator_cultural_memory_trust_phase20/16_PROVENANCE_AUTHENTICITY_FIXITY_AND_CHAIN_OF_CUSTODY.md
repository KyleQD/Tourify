# Provenance, authenticity, fixity and chain of custody

## Purpose

Defines evidence needed to show what a record is, where it came from and how it changed.

## Required design decisions

- Preserve original and preservation-event histories.
- Use multiple checksums and cryptographic agility.
- Record every migration, normalization, redaction and disclosure transformation.
- Never equate integrity with truth, ownership or legal validity.
...
1. Preserve original and preservation-event histories.
2. Use multiple checksums and cryptographic agility.
3. Record every migration, normalization, redaction and disclosure transformation.
4. Never equate integrity with truth, ownership or legal validity.
