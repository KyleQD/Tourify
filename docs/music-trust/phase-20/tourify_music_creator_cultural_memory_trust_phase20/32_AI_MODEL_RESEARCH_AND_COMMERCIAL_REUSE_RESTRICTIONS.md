# AI, model, research and commercial-reuse restrictions

## Purpose

Defines default-deny reuse controls for training, embeddings, voice, style, extraction and derivatives.

## Required design decisions

- Require record-specific, purpose-specific and time-limited authority.
- Separate preservation processing from model development.
- Prohibit using public finding aids as dataset licences.
- Require output review, privacy, cultural and benefit-sharing assessment.
...
1. Require record-specific, purpose-specific and time-limited authority.
2. Separate preservation processing from model development.
3. Prohibit using public finding aids as dataset licences.
4. Require output review, privacy, cultural and benefit-sharing assessment.
