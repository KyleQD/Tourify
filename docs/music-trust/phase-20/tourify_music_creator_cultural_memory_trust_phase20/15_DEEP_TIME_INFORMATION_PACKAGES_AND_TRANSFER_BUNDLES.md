# Deep-time information packages and transfer bundles

## Purpose

Defines submission, archival and dissemination packages for century-scale exchange.

## Required design decisions

- Profile OAIS concepts without claiming ISO certification.
- Use BagIt-compatible manifests where appropriate and document deviations.
- Include representation information, significant properties and rights restrictions.
- Require package validation and independent unpacking.
...
1. Profile OAIS concepts without claiming ISO certification.
2. Use BagIt-compatible manifests where appropriate and document deviations.
3. Include representation information, significant properties and rights restrictions.
4. Require package validation and independent unpacking.
