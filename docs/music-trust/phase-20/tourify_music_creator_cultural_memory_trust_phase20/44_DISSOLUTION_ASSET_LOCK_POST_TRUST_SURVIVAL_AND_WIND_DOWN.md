# Dissolution, asset lock, post-trust survival and wind-down

## Purpose

Defines lawful dissolution, asset transfer, archive survival and creator notice.

## Required design decisions

- Protect archives, domains, repositories, schemas, marks and keys from private diversion.
- Assign only enumerated successor duties.
- Preserve deletion, return and restriction obligations.
- Run dissolution rehearsals before activation.
...
1. Protect archives, domains, repositories, schemas, marks and keys from private diversion.
2. Assign only enumerated successor duties.
3. Preserve deletion, return and restriction obligations.
4. Run dissolution rehearsals before activation.
