# Public asset register, domains, namespaces, marks, keys and specifications

## Purpose

Defines custody and public accountability for critical commons assets.

## Required design decisions

- Record legal owner, steward, custodian, operator and successor.
- Require transfer restrictions and step-in rights.
- Publish approved non-sensitive asset status.
- Prevent marks from implying ownership or official recognition beyond scope.
...
1. Record legal owner, steward, custodian, operator and successor.
2. Require transfer restrictions and step-in rights.
3. Publish approved non-sensitive asset status.
4. Prevent marks from implying ownership or official recognition beyond scope.
