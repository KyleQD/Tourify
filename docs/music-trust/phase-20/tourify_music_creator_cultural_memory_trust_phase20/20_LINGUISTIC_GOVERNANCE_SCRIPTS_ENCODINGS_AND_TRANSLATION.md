# Linguistic governance, scripts, encodings and translation

## Purpose

Preserves original languages, scripts, terminology and translation provenance.

## Required design decisions

- Keep source-language records first-class.
- Version translations, transliterations, summaries and machine-assisted outputs separately.
- Support community terminology and contested translations.
- Preserve fonts, encodings, pronunciation and reading-order context without distributing restricted font files.
...
1. Keep source-language records first-class.
2. Version translations, transliterations, summaries and machine-assisted outputs separately.
3. Support community terminology and contested translations.
4. Preserve fonts, encodings, pronunciation and reading-order context without distributing restricted font files.
