# Participation, deposit, withdrawal and no compulsory collection

## Purpose

Defines voluntary trust participation, deposit licences, withdrawal, non-retaliation and future-use consequences.

## Required design decisions

- Separate trust participation from Tourify and Phase 19 records.
- Use collection- and purpose-specific deposit agreements.
- Allow withdrawal from future use while preserving legally required evidence where applicable.
- Do not condition Tourify services, certification, discovery or enforcement on deposit.
...
1. Separate trust participation from Tourify and Phase 19 records.
2. Use collection- and purpose-specific deposit agreements.
3. Allow withdrawal from future use while preserving legally required evidence where applicable.
4. Do not condition Tourify services, certification, discovery or enforcement on deposit.
