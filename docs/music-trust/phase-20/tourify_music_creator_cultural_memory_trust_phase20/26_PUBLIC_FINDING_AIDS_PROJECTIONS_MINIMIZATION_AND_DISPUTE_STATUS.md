# Public finding aids, projections, minimization and dispute status

## Purpose

Defines public discovery records without exposing restricted evidence or implying ownership.

## Required design decisions

- Use approved projection tables or security-invoker views.
- Include source, custodian, version, freshness, restriction and dispute indicators.
- Suppress sensitive names, locations and community data.
- Never use a public finding aid as sole authorization.
...
1. Use approved projection tables or security-invoker views.
2. Include source, custodian, version, freshness, restriction and dispute indicators.
3. Suppress sensitive names, locations and community data.
4. Never use a public finding aid as sole authorization.
