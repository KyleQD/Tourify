# Minimum public-memory service floor and essential continuity

## Purpose

Defines the minimal services that may survive provider failure or trust dissolution.

## Required design decisions

- Limit survival services to preservation, correction, finding aids and status verification.
- Do not continue expired licensing, representation or enforcement powers.
- Provide low-bandwidth and assisted access.
- Fund and test the service floor independently.
...
1. Limit survival services to preservation, correction, finding aids and status verification.
2. Do not continue expired licensing, representation or enforcement powers.
3. Provide low-bandwidth and assisted access.
4. Fund and test the service floor independently.
