...
Defines how the charter and material governance policies are adopted and changed.

## Required design decisions

- Publish proposals, evidence and impact assessments.
- Record comments, dissent and reasoned responses.
- Use heightened thresholds for fundamental rights and asset changes.
- Require periodic renewal and preserve lawful withdrawal.
...
1. Publish proposals, evidence and impact assessments.
2. Record comments, dissent and reasoned responses.
3. Use heightened thresholds for fundamental rights and asset changes.
4. Require periodic renewal and preserve lawful withdrawal.
