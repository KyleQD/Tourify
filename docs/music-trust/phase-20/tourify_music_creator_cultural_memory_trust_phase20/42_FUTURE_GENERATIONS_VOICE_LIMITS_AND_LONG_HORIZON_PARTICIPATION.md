# Future-generations voice limits and long-horizon participation

## Purpose

Introduces foresight and youth participation without claiming authority to represent future persons.

## Required design decisions

- Use advisory futures panels and scenario testing.
- Disclose uncertainty and conflicts.
- Preserve present creator and community rights.
- Require periodic reauthorization of long-horizon policies.
...
1. Use advisory futures panels and scenario testing.
2. Disclose uncertainty and conflicts.
3. Preserve present creator and community rights.
4. Require periodic reauthorization of long-horizon policies.
