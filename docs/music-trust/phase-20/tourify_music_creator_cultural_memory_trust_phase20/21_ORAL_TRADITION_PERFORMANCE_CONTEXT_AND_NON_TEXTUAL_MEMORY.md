# Oral tradition, performance context and non-textual memory

## Purpose

Defines preservation of sound, performance, embodied practice and contextual knowledge.

## Required design decisions

- Record context, participants, setting, permissions and customary rules.
- Avoid reducing living practice to one authoritative recording.
- Support community-controlled description and access.
- Separate preservation capture from public performance or reuse rights.
...
1. Record context, participants, setting, permissions and customary rules.
2. Avoid reducing living practice to one authoritative recording.
3. Support community-controlled description and access.
4. Separate preservation capture from public performance or reuse rights.
