# Community councils, creator voice and decision rights

## Purpose

Designs councils with transparent mandates, representation, conflicts, quorum, appeals and limited powers.

## Required design decisions

- Distinguish advisory, approval, veto, review and custodial roles.
- Prevent funders, operators or a dominant community from capturing governance.
- Require accessible records of decisions and dissent.
- Preserve direct creator rights where council authority is absent or contested.
...
1. Distinguish advisory, approval, veto, review and custodial roles.
2. Prevent funders, operators or a dominant community from capturing governance.
3. Require accessible records of decisions and dissent.
4. Preserve direct creator rights where council authority is absent or contested.
