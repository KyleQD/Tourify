...
Maps creator, community, custodian, archivist, researcher, descendant, public user, reviewer and administrator journeys.

## Required design decisions

- Use explicit opt-in participation and deposit journeys.
- Give communities and creators clear restriction, correction, withdrawal and repatriation paths.
- Design public discovery separately from mediated or restricted access.
- Provide non-digital and assisted-service journeys for low-bandwidth participants.
...
1. Use explicit opt-in participation and deposit journeys.
2. Give communities and creators clear restriction, correction, withdrawal and repatriation paths.
3. Design public discovery separately from mediated or restricted access.
4. Provide non-digital and assisted-service journeys for low-bandwidth participants.
