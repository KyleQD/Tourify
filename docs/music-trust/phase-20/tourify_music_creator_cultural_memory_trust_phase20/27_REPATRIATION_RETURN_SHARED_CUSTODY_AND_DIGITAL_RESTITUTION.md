# Repatriation, return, shared custody and digital restitution

## Purpose

Defines requests, provenance review, authority, remedies and shared-custody options.

## Required design decisions

- Support physical return, digital return, shared custody, access copies and metadata correction.
- Separate legal entitlement from ethical and negotiated remedies.
- Preserve provenance and prior custody without glorifying wrongful acquisition.
- Require community and rights-holder consultation.
...
1. Support physical return, digital return, shared custody, access copies and metadata correction.
2. Separate legal entitlement from ethical and negotiated remedies.
3. Preserve provenance and prior custody without glorifying wrongful acquisition.
4. Require community and rights-holder consultation.
