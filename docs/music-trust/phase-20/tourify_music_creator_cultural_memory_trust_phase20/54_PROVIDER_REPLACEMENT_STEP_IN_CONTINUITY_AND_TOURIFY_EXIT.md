# Provider replacement, step-in, continuity and Tourify exit

## Purpose

Defines technical and contractual controls for replacing Tourify or any other operator.

## Required design decisions

- Maintain independent builds, credentials, backups and runbooks.
- Require transition assistance and escrow where appropriate.
- Test step-in without changing authoritative records.
- Publish continuity ownership and communication duties.
...
1. Maintain independent builds, credentials, backups and runbooks.
2. Require transition assistance and escrow where appropriate.
3. Test step-in without changing authoritative records.
4. Publish continuity ownership and communication duties.
