# Procurement, vendor neutrality, operator independence and technology transfer

## Purpose

Creates fair procurement, open interfaces and successor-operability requirements.

## Required design decisions

- Require export, escrow, documentation and transition assistance.
- Avoid proprietary lock-in and exclusive control of trust roots.
- Publish conflict and evaluation records.
- Test replacement before contract renewal.
...
1. Require export, escrow, documentation and transition assistance.
2. Avoid proprietary lock-in and exclusive control of trust roots.
3. Publish conflict and evaluation records.
4. Test replacement before contract renewal.
