# Open-source repository, licensing, contributor and supply-chain governance

## Purpose

Defines neutral repositories, licences, contribution rules, security and maintainer succession.

## Required design decisions

- Use approved open licences for public specifications and reference code.
- Record contributor provenance and IPR commitments.
- Use signed releases, SBOMs and reproducible builds.
- Prevent one company from controlling all maintainers or package namespaces.
...
1. Use approved open licences for public specifications and reference code.
2. Record contributor provenance and IPR commitments.
3. Use signed releases, SBOMs and reproducible builds.
4. Prevent one company from controlling all maintainers or package namespaces.
