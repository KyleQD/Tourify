...
Defines additive Supabase architecture and source separation.

## Required design decisions

- Create dedicated trust, authority, custody, preservation, restriction and public-projection tables.
- Use default-deny RLS and restricted storage.
- Keep public projections physically and logically separate.
- Never mutate Phase 1–19 canonical records.
...
1. Create dedicated trust, authority, custody, preservation, restriction and public-projection tables.
2. Use default-deny RLS and restricted storage.
3. Keep public projections physically and logically separate.
4. Never mutate Phase 1–19 canonical records.
