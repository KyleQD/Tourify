# Privacy, posthumous, descendant and affected-person interests

## Purpose

Balances preservation with privacy, dignity, safety and affected-party interests over long periods.

## Required design decisions

- Do not assume death or age eliminates legitimate privacy or safety concerns.
- Record descendant and affected-community claims without granting automatic ownership.
- Use embargoes, redaction, mediated access and periodic review.
- Apply jurisdiction-specific archival and data-protection analysis.
...
1. Do not assume death or age eliminates legitimate privacy or safety concerns.
2. Record descendant and affected-community claims without granting automatic ownership.
3. Use embargoes, redaction, mediated access and periodic review.
4. Apply jurisdiction-specific archival and data-protection analysis.
