...
Defines independent readiness assessments, gap remediation and recurring review.

## Required design decisions

- Use ISO 16363-aligned evidence where appropriate.
- Distinguish self-assessment, external audit and formal certification.
- Publish scope and limitations of assurance.
- Suspend claims when evidence expires.
...
1. Use ISO 16363-aligned evidence where appropriate.
2. Distinguish self-assessment, external audit and formal certification.
3. Publish scope and limitations of assurance.
4. Suspend claims when evidence expires.
