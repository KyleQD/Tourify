# Access classes, embargo review, appeals and mediated access

## Purpose

Defines public, registered, mediated, research-controlled, community-controlled, sealed and closed access.

## Required design decisions

- Use exact-purpose requests and least disclosure.
- Require accessible reasons, human review and appeal.
- Treat embargo dates as review triggers, not automatic release.
- Support supervised, on-site, secure-room and remote mediated access.
...
1. Use exact-purpose requests and least disclosure.
2. Require accessible reasons, human review and appeal.
3. Treat embargo dates as review triggers, not automatic release.
4. Support supervised, on-site, secure-room and remote mediated access.
