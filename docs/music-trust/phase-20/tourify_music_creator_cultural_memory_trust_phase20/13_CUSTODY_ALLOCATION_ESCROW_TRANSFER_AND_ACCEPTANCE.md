# Custody allocation, escrow, transfer and acceptance

## Purpose

Defines custody schedules, escrow, transfer evidence, acceptance tests and compensating rollback.

## Required design decisions

- Separate ownership from possession and operational control.
- Require source and destination authority plus community restrictions.
- Validate fixity, completeness, access rules and restoration before acceptance.
- Keep the prior custodian available until transfer reconciliation completes.
...
1. Separate ownership from possession and operational control.
2. Require source and destination authority plus community restrictions.
3. Validate fixity, completeness, access rules and restoration before acceptance.
4. Keep the prior custodian available until transfer reconciliation completes.
