# Indigenous Peoples, local communities and sustained consent

## Purpose

Creates safeguards for Indigenous and community-held cultural knowledge, expressions and restrictions.

## Required design decisions

- Use free, prior, sustained and informed consent where applicable.
- Respect customary access limits even when they restrict broader public access.
- Support community-defined labels, protocols and review cycles.
- Do not treat digital copies or metadata as extinguishing community interests.
...
1. Use free, prior, sustained and informed consent where applicable.
2. Respect customary access limits even when they restrict broader public access.
3. Support community-defined labels, protocols and review cycles.
4. Do not treat digital copies or metadata as extinguishing community interests.
