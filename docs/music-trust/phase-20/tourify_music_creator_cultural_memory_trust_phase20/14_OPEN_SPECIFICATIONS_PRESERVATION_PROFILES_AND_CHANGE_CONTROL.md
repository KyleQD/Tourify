# Open specifications, preservation profiles and change control

## Purpose

Defines public, versioned preservation specifications and profiles that any qualified custodian can implement.

## Required design decisions

- Use stable normative language, public schemas, test vectors and change logs.
- Separate required core fields from community-specific extensions.
- Require backward compatibility or explicit migration plans.
- Prevent Tourify-specific implementation details from becoming mandatory standards.
...
1. Use stable normative language, public schemas, test vectors and change logs.
2. Separate required core fields from community-specific extensions.
3. Require backward compatibility or explicit migration plans.
4. Prevent Tourify-specific implementation details from becoming mandatory standards.
