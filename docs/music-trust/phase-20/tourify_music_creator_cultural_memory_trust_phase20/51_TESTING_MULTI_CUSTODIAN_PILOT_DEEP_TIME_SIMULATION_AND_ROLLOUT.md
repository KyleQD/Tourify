# Testing, multi-custodian pilot, deep-time simulation and rollout

## Purpose

Defines staged pilots and mandatory regression protection.

## Required design decisions

- Start with synthetic and voluntarily contributed material.
- Require two independent custodians and implementations.
- Test restriction propagation, repatriation, archive restore and Tourify absence.
- Keep public activation narrow, time-limited and reversible.
...
1. Start with synthetic and voluntarily contributed material.
2. Require two independent custodians and implementations.
3. Test restriction propagation, repatriation, archive restore and Tourify absence.
4. Keep public activation narrow, time-limited and reversible.
