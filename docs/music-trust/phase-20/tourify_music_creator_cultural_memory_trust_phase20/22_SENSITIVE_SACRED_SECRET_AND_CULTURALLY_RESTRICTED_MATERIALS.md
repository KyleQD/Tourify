# Sensitive, sacred, secret and culturally restricted materials

## Purpose

Defines high-protection classifications, restricted metadata and community-governed access.

## Required design decisions

- Default sensitive materials to no public disclosure.
- Allow even titles, locations or existence to be restricted.
- Require periodic human review without automatic opening.
- Log access without exposing restricted details in audit projections.
...
1. Default sensitive materials to no public disclosure.
2. Allow even titles, locations or existence to be restricted.
3. Require periodic human review without automatic opening.
4. Log access without exposing restricted details in audit projections.
