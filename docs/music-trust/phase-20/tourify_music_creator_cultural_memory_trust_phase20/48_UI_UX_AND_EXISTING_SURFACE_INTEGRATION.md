...
Defines participant, community, custodian, researcher and public interfaces without disrupting existing Tourify flows.

## Required design decisions

- Use explicit trust participation and restriction language.
- Show legal character, source, freshness and dispute status.
- Avoid dark patterns that encourage public release.
- Keep existing music surfaces unchanged unless a tested display adapter is added.
...
1. Use explicit trust participation and restriction language.
2. Show legal character, source, freshness and dispute status.
3. Avoid dark patterns that encourage public release.
4. Keep existing music surfaces unchanged unless a tested display adapter is added.
