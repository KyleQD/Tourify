# Shared preservation fund, endowment, reserves and fiscal duties

## Purpose

Defines sustainable, restricted funding for preservation and emergency response.

## Required design decisions

- Separate operating, reserve, emergency and restricted funds.
- Use transparent spending and independent audit.
- Prevent donor control over access or cultural decisions.
- Require long-horizon liabilities and wind-down funding.
...
1. Separate operating, reserve, emergency and restricted funds.
2. Use transparent spending and independent audit.
3. Prevent donor control over access or cultural decisions.
4. Require long-horizon liabilities and wind-down funding.
