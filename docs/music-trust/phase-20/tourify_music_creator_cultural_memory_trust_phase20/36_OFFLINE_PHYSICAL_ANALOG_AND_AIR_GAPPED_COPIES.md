# Offline, physical, analog and air-gapped copies

## Purpose

Defines non-network preservation and recovery media for catastrophic failure.

## Required design decisions

- Use documented media refresh and environmental controls.
- Store keys and manifests separately under dual control.
- Preserve machine-readable and human-readable recovery instructions.
- Test restoration without live Tourify services.
...
1. Use documented media refresh and environmental controls.
2. Store keys and manifests separately under dual control.
3. Preserve machine-readable and human-readable recovery instructions.
4. Test restoration without live Tourify services.
