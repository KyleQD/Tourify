# Distributed custodian network, multi-root trust and independence

## Purpose

Designs plural custody across institutions, legal orders, technology stacks and regions.

## Required design decisions

- Require materially independent custodians and operators.
- Avoid one global trust root or one canonical archive copy.
- Use signed manifests and deterministic reconciliation.
- Allow lawful local non-participation and exit.
...
1. Require materially independent custodians and operators.
2. Avoid one global trust root or one canonical archive copy.
3. Use signed manifests and deterministic reconciliation.
4. Allow lawful local non-participation and exit.
