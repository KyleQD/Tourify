# Data portability, export, reimplementation and decommissioning

## Purpose

Defines complete exports, independent reimplementation and safe service retirement.

## Required design decisions

- Provide machine-readable and human-readable exports.
- Include policies, schemas, restrictions, audit and provenance.
- Test imports into a second implementation.
- Decommission without breaking identifiers, tombstones or archive access.
...
1. Provide machine-readable and human-readable exports.
2. Include policies, schemas, restrictions, audit and provenance.
3. Test imports into a second implementation.
4. Decommission without breaking identifiers, tombstones or archive access.
