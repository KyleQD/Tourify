# Rights-reference resolution and source authority

## Purpose

Defines minimal long-term links to Rights Passports, licences, administration, royalty and official sources.

## Required design decisions

- Reference rather than duplicate canonical records.
- Expose only approved public status.
- Include freshness, dispute, suspension and revocation.
- Require current authoritative source for action.
...
1. Reference rather than duplicate canonical records.
2. Expose only approved public status.
3. Include freshness, dispute, suspension and revocation.
4. Require current authoritative source for action.
