...
Defines route handlers, outbox workers, signatures, replay protection and reconciliation.

## Required design decisions

- Use dedicated Phase 20 namespaces after audit.
- Validate Zod schemas and exact-scope authorization.
- Make external writes idempotent and replay-safe.
- Provide dead-letter, reconciliation and compensating-action paths.
...
1. Use dedicated Phase 20 namespaces after audit.
2. Validate Zod schemas and exact-scope authorization.
3. Make external writes idempotent and replay-safe.
4. Provide dead-letter, reconciliation and compensating-action paths.
