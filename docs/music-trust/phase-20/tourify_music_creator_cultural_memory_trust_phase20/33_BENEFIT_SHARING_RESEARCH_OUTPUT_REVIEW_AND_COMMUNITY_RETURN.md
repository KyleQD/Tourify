...
Defines fair treatment of benefits, publications, derivatives, community copies and knowledge return.

## Required design decisions

- Do not substitute exposure for benefit.
- Record monetary and non-monetary benefit commitments.
- Require review of outputs for leakage and cultural harm.
- Use Phase 3 accounting only where a valid payable allocation exists.
...
1. Do not substitute exposure for benefit.
2. Record monetary and non-monetary benefit commitments.
3. Require review of outputs for leakage and cultural harm.
4. Use Phase 3 accounting only where a valid payable allocation exists.
