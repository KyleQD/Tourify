# Constitutional Principles, Fundamental Rights and Entrenchment

## Purpose

Define non-derogable or highly protected principles and how they may be changed.
...
1. Entrench optional participation, local sovereignty, due process, privacy, portability and non-discrimination.
2. Classify provisions as fundamental, structural, operational or advisory.
3. Require enhanced ratification for fundamental amendments.

## Durable records

- `constitutional_provisions`
- `provision_classifications`
- `fundamental_rights_versions`
...
- Ordinary deploys cannot amend fundamental provisions.
- Emergency powers cannot permanently suspend protected rights.
- Historical meaning is fixed by policy and schema version.
...
- entrenchment tests
- policy-version replay tests
- emergency-rights tests
