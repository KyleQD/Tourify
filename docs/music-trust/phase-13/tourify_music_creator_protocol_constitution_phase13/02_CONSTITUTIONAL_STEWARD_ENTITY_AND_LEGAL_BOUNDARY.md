# Constitutional Steward Entity and Legal Boundary

## Purpose

Define the entity, fiduciary, contractual and jurisdiction boundary for the constitutional steward.
...
1. Evaluate foundation, nonprofit, trust, association and multi-entity options.
2. Document duties to the public mission, participants and local organizations.
3. Keep Tourify service agreements separate from constitutional powers.

## Durable records

- `constitutional_entities`
- `entity_approval_packages`
- `fiduciary_duty_register`
...
- Entity formation requires counsel and governing-body approval.
- No implied treaty or governmental status.
- Related-party contracts require conflict review.
...
- entity-readiness gate tests
- conflict disclosure tests
- related-party approval tests
