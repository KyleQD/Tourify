# Decision-Making, Quorum, Veto and Ratification Thresholds

## Purpose

Define transparent decision rules appropriate to each change class.
...
1. Specify eligibility, quorum, participation thresholds and approval thresholds.
2. Prevent one funder, operator, region or membership class from dominating.
3. Require local ratification for reserved-power changes.

## Durable records

- `constitutional_decisions`
- `eligible_voter_snapshots`
- `quorum_calculations`
...
- Voting snapshots are immutable and auditable.
- Conflicts and abstentions are recorded.
- No silent default approval from nonresponse.
