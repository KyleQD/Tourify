...
Provide the mandatory checklist for preserving all existing Tourify behavior.
...
1. Audit exact paths before edits.
2. Use additive migrations and feature flags.
3. Run full regression and rollback evidence.
...
- No second upload, catalog, player or entitlement path.
- No public access to restricted evidence.
