# Rights Reference Commons, Source Authority and Non-Adjudication

## Purpose

Keep rights-reference services useful without becoming a copyright court or universal registry.
...
1. Resolve references to current authoritative sources.
2. Display disputes and incomplete authority.
3. Provide contact routes without granting permission.

## Durable records

- `constitutional_rights_references`
...
- Resolver output is evidence, not adjudication.
- Official sources retain authority.
- High-impact actions recheck current source records.
