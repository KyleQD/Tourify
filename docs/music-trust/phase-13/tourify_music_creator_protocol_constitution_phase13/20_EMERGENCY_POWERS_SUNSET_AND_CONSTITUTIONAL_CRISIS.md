# Emergency Powers, Sunset and Constitutional Crisis

## Purpose

Define narrowly scoped responses to key compromise, operator collapse, registry poisoning or governance capture.
...
1. Enumerate emergency triggers, actors and maximum duration.
2. Require dual control and independent confirmation.
3. Mandate public after-action review and automatic expiry.
...
- Emergency authority cannot permanently amend the constitution.
- Rights restrictions must be necessary and proportionate.
