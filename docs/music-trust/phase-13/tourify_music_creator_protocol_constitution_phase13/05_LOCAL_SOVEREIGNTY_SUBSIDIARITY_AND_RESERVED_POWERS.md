# Local Sovereignty, Subsidiarity and Reserved Powers

## Purpose

Prevent central bodies from overriding lawful local decisions.
...
1. Enumerate powers retained locally, delegated jointly and prohibited globally.
2. Require exact-scope delegation for every central action.
3. Provide conflict rules where a local policy is stricter than the compact baseline.

## Durable records

- `reserved_power_schedules`
- `delegated_power_grants`
- `local_policy_overrides`
...
- Default to local authority when delegation is absent or ambiguous.
- Global services cannot alter local membership or rights records.
- Local exit remains available.
