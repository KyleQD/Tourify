# Compact Membership, Ratification, Withdrawal and Succession

## Purpose

Create explicit compact participation and lawful exit mechanics for organizations.
...
1. Require an authorized local decision and signed ratification instrument.
2. Support reservations, scoped participation and jurisdiction modules.
3. Define withdrawal, wind-down, surviving obligations and successor recognition.

## Durable records

- `compact_memberships`
- `ratification_instruments`
- `withdrawal_notices`
- `successor_recognitions`
...
- Tourify account creation is never ratification.
- Withdrawal cannot erase historical audit records.
- No successor is recognized without authority and continuity evidence.
...
- ratification state tests
- withdrawal propagation tests
- successor challenge tests
