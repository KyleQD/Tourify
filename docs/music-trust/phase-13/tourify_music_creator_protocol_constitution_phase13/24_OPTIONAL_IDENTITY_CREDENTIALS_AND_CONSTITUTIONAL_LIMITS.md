# Optional Identity, Credentials and Constitutional Limits

## Purpose

Protect voluntary identity and credential use under the compact.
...
1. Require explicit enrollment and proof of control.
2. Support multiple identifiers and wallets.
3. Define recovery, rotation, suspension and non-use rights.

## Durable records

- `constitutional_identifiers`
- `credential_profiles`
- `control_proofs`
- `recovery_events`
...
- Credential possession alone does not authorize high-impact action.
- Loss of wallet does not erase rights or participation.
