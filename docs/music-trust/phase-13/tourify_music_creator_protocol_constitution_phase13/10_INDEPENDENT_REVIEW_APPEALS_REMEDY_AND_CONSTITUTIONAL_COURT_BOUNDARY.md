# Independent Review, Appeals, Remedy and Constitutional Review Boundary

## Purpose

Define neutral review of decisions without claiming judicial or governmental status.
...
1. Establish eligibility, standing, panels, recusal and standard of review.
2. Provide interim relief, correction, remand and invalidation remedies.
3. Separate internal review from courts, arbitration and regulators.
...
- Reviewers must be independent from challenged actors.
- High-impact decisions remain stayed when required.
- External legal rights are preserved.
...
- recusal tests
- appeal deadline tests
- remedy propagation tests
