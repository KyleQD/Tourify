# Protocol Forks, Version Coexistence and Reunification

## Purpose

Treat forks as a safety valve while minimizing user harm and namespace confusion.
...
1. Define legitimate fork triggers and naming rules.
2. Support parallel verification and data portability.
3. Provide optional reconciliation or reunification mechanisms.
...
- Forks cannot seize creator records or marks.
- Participants choose their implementation.
- Public resolvers disclose protocol lineage.
