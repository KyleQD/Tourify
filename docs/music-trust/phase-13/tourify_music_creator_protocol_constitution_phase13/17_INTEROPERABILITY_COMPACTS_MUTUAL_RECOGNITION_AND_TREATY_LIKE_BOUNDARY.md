# Interoperability Compacts, Mutual Recognition and Treaty-Like Boundary

## Purpose

Create contractual and technical compacts without falsely claiming state treaty authority.
...
1. Define bilateral, regional and multilateral compact templates.
2. Separate technical recognition from legal representation.
3. Include reservations, jurisdiction modules, dispute and exit clauses.

## Durable records

- `interoperability_compacts`
- `compact_schedules`
- `mutual_recognition_scopes`
- `reservations`
...
- Use 'compact' or 'agreement' unless sovereign states create a treaty.
- Recognition is scoped and revocable.
- No compact overrides mandatory local law.
