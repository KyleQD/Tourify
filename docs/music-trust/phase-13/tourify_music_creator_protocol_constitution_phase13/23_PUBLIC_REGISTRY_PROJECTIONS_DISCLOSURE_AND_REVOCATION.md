# Public Registry Projections, Disclosure and Revocation

## Purpose

Define minimal, purpose-specific public records with clear limits.
...
1. Use projection tables or security-invoker views.
2. Include source, freshness, version and dispute status.
3. Support correction, suspension, revocation and cache expiry.

## Durable records

- `public_registry_projections`
- `projection_policies`
- `revocation_events`
- `cache_directives`
...
- Public routes never query confidential evidence tables directly.
- No private splits, contracts, tax or payment data.
- Projection absence is not proof of no rights.
