# Jurisdiction, Conflict of Laws and Regulatory Interface

## Purpose

Manage divergent laws without presenting one global rule as legally universal.
...
1. Maintain versioned jurisdiction modules and legal-review status.
2. Define conflicts, mandatory-law overrides and regulator requests.
3. Separate protocol compliance from legal compliance.
...
- Missing jurisdiction analysis is a blocker.
- Sanctions, export and localization rules are independently enforced.
- Public notices identify applicable jurisdiction.
...
- jurisdiction gate tests
- conflicting law tests
- regulator request audit tests
