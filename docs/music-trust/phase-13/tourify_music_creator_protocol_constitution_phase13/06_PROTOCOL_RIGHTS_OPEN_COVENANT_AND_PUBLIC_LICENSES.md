# Protocol Rights, Open Covenant and Public Licences

## Purpose

Define durable rights to implement, inspect, fork, test and migrate the protocol.
...
1. Choose open specification, code, schema, documentation and test-suite licences.
2. Create contributor and patent policies.
3. Reserve marks for accurate conformance claims without blocking implementations.

## Durable records

- `protocol_rights_covenants`
- `licence_profiles`
- `contributor_grants`
- `patent_disclosures`
...
- No hidden proprietary dependency may be required for basic interoperability.
- Trademark policy cannot create vendor lock-in.
- Licence changes require compatibility and reliance review.
...
- clean-room implementation tests
- licence scanner tests
- mark misuse tests
