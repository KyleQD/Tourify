# Succession, Steward Replacement and Constitutional Continuity

## Purpose

Ensure the compact and protocol can survive steward failure or replacement.
...
1. Define ordinary succession, incapacity, insolvency, capture and emergency replacement.
2. Maintain continuity packages and successor qualification criteria.
3. Require asset, key, registry and contract handoff drills.
...
- No successor receives broader powers than the predecessor.
- Local organizations may challenge or exit.
- Tourify cannot unilaterally designate the successor.
...
- steward-unavailable tests
- successor qualification tests
- handoff integrity tests
