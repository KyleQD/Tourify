# Phase 13 Public Approval and Activation Gate

## Purpose

Define the final default-deny gate for any limited constitutional production scope.
...
1. Require approved entity, charter, ratification, operators, assets, security, funding and appeals.
2. Require two independent implementations and provider-replacement drills.
3. Publish unresolved limitations and sunset date.

## Durable records

- `phase13_activation_reviews`
- `approval_signatures`
- `limited_scope_authorizations`
- `sunset_reviews`
...
- Any missing mandatory evidence denies activation.
- Approval is scope- and jurisdiction-specific.
- Fundamental prohibited flags stay false.
