# Admin Constitutional Operations, Queues and Approvals

## Purpose

Define operational queues without giving ordinary Tourify admins constitutional power.
...
1. Separate platform admin, steward staff, independent reviewers and auditors.
2. Create queues for ratification, objections, appeals, incidents and succession.
3. Require dual control for critical actions.

## Durable records

- `constitutional_work_queues`
- `assignment_records`
- `approval_chains`
- `service_targets`
...
- Tourify super-admin is not constitutional superuser.
- Access is time-limited and purpose-bound.
