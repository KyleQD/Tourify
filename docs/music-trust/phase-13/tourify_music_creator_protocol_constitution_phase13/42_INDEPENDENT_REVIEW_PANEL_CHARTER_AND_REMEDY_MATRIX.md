# Independent Review Panel Charter and Remedy Matrix

## Purpose

Specify reviewer appointment, independence, procedure, standards and remedies.
...
1. Create appointment pools and conflict screening.
2. Define admissibility, interim relief and public reasoning.
3. Map each violation to available remedy and external escalation.

## Durable records

- `review_panel_charters`
- `reviewer_rosters`
- `remedy_matrix`
- `recusal_records`
...
- Panels cannot rewrite creator rights records.
- Decisions are reasoned and appealable where applicable.
- Confidentiality is narrow and reviewable.
...
- reviewer conflict tests
- remedy execution tests
- publication tests
