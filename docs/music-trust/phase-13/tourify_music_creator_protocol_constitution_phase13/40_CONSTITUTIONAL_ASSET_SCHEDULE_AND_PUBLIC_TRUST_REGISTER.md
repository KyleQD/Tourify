# Constitutional Asset Schedule and Public-Trust Register

## Purpose

Create a versioned schedule of every critical protocol, registry, domain, mark, repository and key.
...
1. Record ownership, custody, operator, restrictions and succession.
2. Publish minimal non-sensitive status.
3. Tie every change to authority and audit evidence.

## Durable records

- `constitutional_asset_schedules`
...
- No commons ownership claim without executed evidence.
- Restricted asset details remain private.
- Transfer and encumbrance require approval.
