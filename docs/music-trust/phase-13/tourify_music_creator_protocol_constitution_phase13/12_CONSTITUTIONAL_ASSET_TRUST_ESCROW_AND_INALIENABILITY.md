# Constitutional Asset Trust, Escrow and Inalienability

## Purpose

Protect critical domains, marks, schemas, repositories, keys and public funds from capture or unauthorized sale.
...
1. Classify assets as transferable, restricted, escrowed, public-trust or inalienable.
2. Define custodians, beneficiaries and step-in rights.
3. Require public approval for asset sales or encumbrances.

## Durable records

- `constitutional_assets`
- `asset_restrictions`
- `escrow_agreements`
- `asset_transfer_votes`
...
- Asset ownership does not confer protocol governance power.
- No irreversible transfer without rollback or replacement plan.
- Encumbrances and licences are publicly disclosed where lawful.
