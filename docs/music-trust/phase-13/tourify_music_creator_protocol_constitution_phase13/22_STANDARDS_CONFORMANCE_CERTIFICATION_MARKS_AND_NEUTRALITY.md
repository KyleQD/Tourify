# Standards, Conformance, Certification Marks and Neutrality

## Purpose

Create open conformance without turning certification into constitutional authority.
...
1. Publish test suites and versioned profiles.
2. Separate self-test, verified conformance and operator accreditation.
3. Govern certification marks neutrally.

## Durable records

- `conformance_profiles`
- `test_results`
- `certification_mark_licences`
- `appeals`
...
- Conformance does not prove rights ownership.
- Tests are reproducible and implementation-neutral.
- Marks may be suspended for misleading claims.
