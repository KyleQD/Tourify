...
Describe readiness, drafting, ratification, participation, objection, appeal, withdrawal and succession journeys.
...
1. Provide separate journeys for creators, local organizations, stewards, operators, implementers, auditors and the public.
2. Display the exact authority and limits of each body.
3. Make exit, portability and remedy first-class user journeys.

## Durable records

- `constitutional_participant_roles`
- `journey_versions`
- `notice_and_acknowledgment_receipts`
...
- No dark patterns in ratification or waiver flows.
- Every consequential action has notice, review and appeal.
- Accessibility and assisted-service paths are mandatory.
...
- role-journey tests
- withdrawal usability tests
- accessible notice tests
