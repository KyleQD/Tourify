# Testing, Sandbox, Pilot, Public Ratification and Rollout

## Purpose

Sequence implementation from documentation through independent sandbox and limited production.
...
1. Run a bilateral compact with two local organizations and two implementations.
2. Test objections, appeals, fork, operator removal and Tourify exit.
3. Publish readiness and unresolved blocker reports.
...
- No production before independent conformance and public approval.
- Stop on failed sovereignty, security or portability tests.
...
- Tourify-unavailable drill
- public ratification rehearsal
