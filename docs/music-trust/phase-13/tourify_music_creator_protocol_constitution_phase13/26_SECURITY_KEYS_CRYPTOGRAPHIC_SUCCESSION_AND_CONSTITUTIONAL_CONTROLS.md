# Security, Keys, Cryptographic Succession and Constitutional Controls

## Purpose

Bind cryptographic operations to constitutional authority and continuity.
...
1. Separate root, registry, operator, audit and release keys.
2. Use hardware-backed keys, threshold control and rotation.
3. Maintain successor and emergency recovery ceremonies.
...
- No single employee or vendor controls a root key.
- Key changes are publicly verifiable where appropriate.
- Compromise triggers suspension before replacement.
