# Fundamental and Ordinary Amendment Classification

## Purpose

Classify changes before a proposal can enter the decision process.
...
1. Distinguish fundamental, charter, protocol-breaking, operational, emergency and editorial changes.
2. Use effect-based classification rather than proposer labels.
3. Allow reclassification and independent challenge.
...
- A database migration cannot bypass constitutional classification.
- Breaking changes require transition plans.
- Misclassification pauses implementation.
...
- misclassification challenge tests
