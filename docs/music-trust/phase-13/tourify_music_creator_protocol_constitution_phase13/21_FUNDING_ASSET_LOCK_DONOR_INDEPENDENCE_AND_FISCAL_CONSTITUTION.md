# Funding, Asset Lock, Donor Independence and Fiscal Constitution

## Purpose

Protect the commons from funding concentration and mission drift.
...
2. Create reserves, restricted funds and wind-down funding.
3. Require independent approval for related-party spending.
...
- Funding cannot buy votes or trust status.
- Critical services have funded continuity plans.
- Budget rejection and correction processes are defined.
