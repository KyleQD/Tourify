# Technical Constitution, Schema, Protocol and Compatibility Rules

## Purpose

Translate constitutional requirements into versioned technical constraints.
...
1. Define normative profiles, compatibility windows and deprecation rules.
2. Require machine-readable policy and schema versions.
3. Make constitutional invariants testable in conformance suites.

## Durable records

- `technical_constitution_profiles`
- `schema_versions`
...
- No schema change silently changes historical meaning.
- Implementations must expose supported profiles.
- Breaking changes require dual-read or migration plans.
