# Incidents, Network Partition, Malicious Operators and Public Remedy

## Purpose

Coordinate technical response without bypassing due process or local sovereignty.
...
1. Classify security, integrity, governance and availability incidents.
2. Support network partition and conflicting registry state.
3. Provide public status, notice and remedy.

## Durable records

- `constitutional_incidents`
- `partition_records`
- `operator_findings`
- `remedy_programs`
...
- Incident response cannot become permanent governance.
- Affected parties receive notice and appeal.
- Conflicting roots are quarantined and disclosed.
