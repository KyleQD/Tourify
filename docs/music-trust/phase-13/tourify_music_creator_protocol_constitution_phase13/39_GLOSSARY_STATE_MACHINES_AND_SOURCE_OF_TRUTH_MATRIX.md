...
Normalize constitutional terms and authoritative records.
...
1. Define constitution, compact, steward, operator, root, provision, amendment, objection, appeal, fork and succession.
2. List state machines and source precedence.
3. Map public projections to restricted evidence.
...
- Terms cannot imply governmental or judicial authority.
