# Operator Constitution, Duties, Accreditation and Removal

## Purpose

Bind operators to service, security, neutrality and continuity obligations.
...
1. Define operator classes, minimum controls and service levels.
2. Separate operation from constitutional decision-making.
3. Provide suspension, cure, removal and replacement.

## Durable records

- `constitutional_operators`
- `operator_covenants`
- `service_level_records`
- `operator_removal_cases`
...
- Operators cannot rank or discriminate by political or commercial preference.
- Operator funding does not buy protocol control.
- Removal must not strand participants.
