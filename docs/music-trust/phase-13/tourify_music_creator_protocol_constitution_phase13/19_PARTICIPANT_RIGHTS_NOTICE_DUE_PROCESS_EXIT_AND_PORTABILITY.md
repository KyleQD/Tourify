# Participant Rights, Notice, Due Process, Exit and Portability

## Purpose

Guarantee practical rights for creators and organizations affected by infrastructure decisions.
...
1. Provide readable notice, explanation, correction, appeal and remedy.
2. Support full export and provider migration.
3. Protect access for low-bandwidth, disabled and assisted-service users.

## Durable records

- `participant_rights_notices`
- `appeals`
- `exports`
...
- No retaliation for exit or complaint.
- Withdrawal does not erase legal history.
- Essential correction and verification remain affordable.
