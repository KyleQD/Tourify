# Succession Escrow, Fork Continuity and Reunification Package

## Purpose

Create complete continuity assets for steward/operator replacement or legitimate protocol fork.
...
1. Package code, specifications, schemas, keys, domains, status snapshots and runbooks.
2. Define independent restore and verification.
3. Provide fork lineage and optional reunification rules.

## Durable records

- `succession_escrow_packages`
- `restore_attestations`
- `fork_continuity_manifests`
...
- Packages exclude private creator content unless separately authorized.
- Restore works without Tourify credentials.
- Every package has expiry and refresh rules.
