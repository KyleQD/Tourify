...
Define additive persistence and authorization patterns for Phase 13.
...
1. Create constitutional entities, compacts, provisions, decisions, appeals, assets, operators and succession records.
2. Use restricted evidence storage and public projections.
3. Define retention, legal hold and deletion behavior.

## Durable records

- See migration templates under `reference/supabase/migration-templates/`.
...
- No destructive migration or silent overwrite.
- Privileged functions use explicit grants.
