# Stewardship Transition and Tourify Separation

## Purpose

Define how critical functions, contracts, knowledge and operations can move from Tourify to an independent steward or replacement provider.
...
- `service_separation_plans`
- `step_in_events`
- `transition_acceptances`

## Primary workflows

1. Inventory dependencies and related-party services.
2. Create staged separation and dual-operation plan.
3. Run shadow operations and data export.
4. Approve cutover, step-in or rollback.
...
- No big-bang transfer.
- Creator services continue during transition.
- Tourify cannot revoke access to community-owned assets.
- Every cutover has a tested reversal or replacement path.
...
- Transition states should include proposed, due_diligence, shadow, approved, executing, dual_run, accepted, suspended, rolled_back and complete.
- Financial, personnel, cloud, domain, key, documentation and support dependencies must be independently mapped.
