# Rights Reference Commons and Minimal Resolution

## Purpose

Provide stable references to authoritative rights records without creating a universal rights registry.
...
- `rights_reference_namespaces`
- `rights_reference_records`
- `source_links`
...
2. Verify source and controller.
3. Publish minimal status.
4. Reconcile source updates.
5. Suspend, dispute or retire.
...
- Reference is not ownership proof.
- Confidential rights data excluded.
- Source jurisdiction and scope shown.
- Disputed or stale records default to caution.
...
- Resolution responses should be cacheable only within explicit expiry windows and contain integrity metadata.
- The commons must support multiple rights systems and identifiers without declaring one global canonical rights database.
