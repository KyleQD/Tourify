# Transition Escrow, Step-In, Termination and Continuity

## Purpose

Define contractual and technical rights to replace Tourify or any critical provider without losing infrastructure continuity.
...
- `termination_notices`
- `handoff_packages`
- `continuity_acceptances`

## Primary workflows

1. Deposit current assets and runbooks.
2. Monitor release conditions.
3. Trigger step-in or planned termination.
4. Transfer service and reconcile.
5. Accept, dispute or roll back.
...
- Escrow continuously updated and tested.
- No provider can delete community assets on termination.
- Credentials and identifiers remain portable.
...
- Step-in conditions may include insolvency, prolonged outage, material security breach, governance breach or voluntary exit.
- The steward must test full operator replacement before production approval.
