# Multilateral Steward Entity, Governance and Fiduciary Boundary

## Purpose

Separate Tourify, the public-interest steward, operating providers, standards program, asset custodian and oversight bodies.
...
- `commons_steward_entities`
- `steward_charters`
- `fiduciary_decisions`
- `operator_appointments`
- `related_party_reviews`

## Primary workflows

1. Evaluate entity and trust options with counsel.
2. Approve charter, reserved powers and public-benefit duties.
3. Appoint independent directors, technical and public-interest councils.
4. Execute arm’s-length Tourify service and transition agreements.
...
- No Tourify unilateral control.
- Independent budget and bank accounts.
- Related-party recusals and disclosures.
- Public purpose cannot be subordinated to Tourify commercial strategy.
...
- Entity analysis should compare nonprofit, public-benefit, trust, foundation and hosted-project models without hard-coding one structure.
- The steward must be able to replace Tourify as operator and preserve continuity.
