# Multilateral Governance, Voting, Appeals and Local Sovereignty

## Purpose

Define decision rights, public participation, reserved powers, ratification, veto, appeal and remedy.
...
1. Propose decision.
2. Determine authority and affected constituencies.
3. Run consultation and conflict review.
4. Vote or ratify.
5. Appeal, stay, correct or reverse.
...
- No one-entity override.
- Reserved local powers enforced in code and policy.
- Affected communities receive notice.
...
- Decisions should identify authority, quorum, constituency, conflicts, evidence, dissent, effective date and review date.
- Local organizations may refuse optional protocol features unless a separately executed interoperability commitment requires them.
