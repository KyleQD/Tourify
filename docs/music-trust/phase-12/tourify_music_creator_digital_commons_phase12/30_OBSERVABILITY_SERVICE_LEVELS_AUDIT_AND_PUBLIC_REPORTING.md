# Observability, Service Levels, Audit and Public Reporting

## Purpose

Measure availability, integrity, freshness, fairness, portability, operator diversity and public benefit.
...
2. Collect privacy-safe telemetry.
3. Alert and respond.
4. Publish periodic and incident reports.
...
- No hidden stale registry.
- No participant surveillance.
- Metrics independently auditable.
- Failures and corrective actions published.
...
- Metrics include operator concentration, Tourify dependency, export success, resolver freshness, revocation latency, accessibility, dispute resolution and funding concentration.
- Public reports exclude personal and confidential creator data.
