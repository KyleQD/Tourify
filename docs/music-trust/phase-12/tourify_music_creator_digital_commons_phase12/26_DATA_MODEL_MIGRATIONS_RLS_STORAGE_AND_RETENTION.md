...
Define additive schema, restricted storage, public projections, audit and retention for Phase 12.
...
- commons_* tables
- commons-evidence bucket
- `commons-public-projections`
- commons-audit outbox

## Primary workflows

1. Audit identifiers and role models.
2. Create additive migrations with CLI.
3. Apply RLS and grants.
4. Backfill explicit references only.
5. Verify advisors and rollback.
...
- Retention and legal holds explicit.
...
- Reference migrations are outlines only and must be reconciled with deployed types, existing capability helpers and Data API exposure settings.
- Public projections should be separate tables or security-invoker views populated from approved event workflows.
