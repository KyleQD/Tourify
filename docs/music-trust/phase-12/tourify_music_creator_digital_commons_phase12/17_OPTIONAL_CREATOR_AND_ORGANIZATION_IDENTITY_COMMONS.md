# Optional Creator and Organization Identity Commons

## Purpose

Define portable, nonmandatory identity references and proof-of-control services operated by multiple providers.
...
1. Create or link identity reference.
2. Prove control.
3. Rotate keys or controllers.
4. Resolve dispute.
5. Deactivate or recover.
...
- No civil-identity claim unless issued by proper authority.
- Pseudonymous participation supported where lawful.
- Recovery cannot silently change rights.
- Multiple identifiers may coexist.
...
- The identity commons is not a Know Your Customer provider by default and does not publish sensitive identity evidence.
- High-impact actions continue to use the relevant authenticated Tourify or external authority workflow.
