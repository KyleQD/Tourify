# Anti-Capture, Conflicts, Transparency and Independent Oversight

## Purpose

Prevent Tourify, large platforms, funders, governments, vendors or dominant organizations from capturing the commons.
...
- `power_concentration_metrics`
- `oversight_reviews`
- `recusal_events`
- `capture_remediation_plans`

## Primary workflows

1. Disclose interests.
2. Measure voting, funding, operator and data concentration.
3. Trigger independent review.
4. Recuse, rebalance, suspend or restructure.
...
- No stakeholder class has unilateral control.
- Public conflict register.
- Independent audit and ombuds function.
...
- Capture controls apply to formal votes and informal leverage such as funding, infrastructure, trademarks, staffing and technical expertise.
- Thresholds trigger review and mitigation rather than automatic accusation.
