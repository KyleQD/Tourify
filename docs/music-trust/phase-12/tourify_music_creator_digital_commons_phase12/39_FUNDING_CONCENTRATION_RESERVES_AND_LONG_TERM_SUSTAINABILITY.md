# Funding Concentration, Reserves and Long-Term Sustainability

## Purpose

Define financial resilience, reserve targets, cost transparency and contingency funding for essential services.
...
1. Model service costs.
2. Set reserve target.
3. Stress-test funding loss.
4. Activate continuity funding.
...
- Essential verification survives funding shock.
- No hidden cross-subsidy dependency.
- Public annual financial report.
- Funder concentration remediated.
...
- The steward should model zero-Tourify and zero-largest-funder scenarios.
- Fees, grants and procurement revenue remain separated from rights ownership or preferential access.
