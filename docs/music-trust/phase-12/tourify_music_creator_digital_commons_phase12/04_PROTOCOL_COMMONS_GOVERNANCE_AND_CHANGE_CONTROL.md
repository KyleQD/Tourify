# Protocol Commons Governance and Change Control

## Purpose

Create open, predictable and contestable governance for protocol profiles, schemas, registries and compatibility rules.
...
2. Run technical, privacy, security, accessibility and rights impact review.
3. Publish public comment draft.
4. Ratify, implement, deprecate or reject.
...
- Open participation and published rationale.
- Reference implementation cannot define the standard alone.
- Minority and accessibility impacts recorded.
...
- A protocol change must include migration guidance, compatibility window, test vectors, implementation evidence and rollback.
- Emergency changes require narrow scope, expiry and retrospective public review.
