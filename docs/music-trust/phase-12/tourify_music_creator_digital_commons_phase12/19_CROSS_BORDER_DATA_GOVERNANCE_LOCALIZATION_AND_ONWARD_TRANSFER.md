# Cross-Border Data Governance, Localization and Onward Transfer

## Purpose

Control international data exchange, localization, processor chains and participant rights.
...
- `onward_transfer_approvals`
- `deletion_attestations`

## Primary workflows

1. Define transfer purpose and dataset.
2. Identify parties and jurisdictions.
3. Approve mechanism and safeguards.
4. Monitor onward transfers.
5. Delete, return or suspend.
...
- No federation or commons membership as blanket transfer consent.
- Minimum necessary data.
- Local copies and lawful access assessed.
- Participant withdrawal propagated prospectively.
...
- Cross-border modules are policy records, not legal advice engines.
- Transfers stop when legal mechanism, authority, localization, sanctions or security status is unclear.
