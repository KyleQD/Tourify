# Open-Source Repository Governance, Licensing and IPR

## Purpose

Define neutral code ownership, contribution rules, licensing integrity, trademarks, release signing and forkability.
...
1. Adopt governance and licence policy.
2. Accept contribution with provenance.
3. Review and sign release.
4. Handle vulnerability, relicensing or fork proposal.
...
- No unilateral relicensing.
- Neutral control of marks and domains.
- Reproducible builds and SBOMs.
- Security disclosures have protected channels.
...
- Code, specifications, test suites, schemas, documentation and trademarks may require different licences.
- The asset steward must preserve the community’s ability to continue development even if Tourify withdraws.
