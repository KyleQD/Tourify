# Emergency Governance, Constitutional Crisis and Steward Replacement

## Purpose

Define narrow emergency powers, independent review, succession and steward replacement when governance fails.
...
- `temporary_powers`
- `succession_events`
- `steward_replacement_cases`
- `ratification_reviews`

## Primary workflows

1. Declare scoped emergency.
2. Activate temporary controls.
3. Notify and preserve evidence.
4. Review, ratify, terminate or replace steward.
...
- No emergency rights transfer.
- Independent and affected-party review.
- Replacement preserves local sovereignty and portability.
...
- Examples include key compromise, insolvency, unlawful order, capture, prolonged outage, governance deadlock or loss of legal capacity.
