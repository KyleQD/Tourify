# Standards Process, Conformance and Interoperability Ecosystem

## Purpose

Create independent specifications, implementation profiles, test suites, certification marks and interoperability events.
...
3. Run independent conformance.
4. Issue scoped result.
5. Revoke or update result.
...
- Tests and methodology public.
- No pay-to-pass.
- Conformance scope and expiry displayed.
...
- Conformance is evidence of tested behavior, not proof of legal authority, privacy compliance or security outside the test scope.
- Test vectors cover malformed, replayed, expired, suspended and disputed records.
