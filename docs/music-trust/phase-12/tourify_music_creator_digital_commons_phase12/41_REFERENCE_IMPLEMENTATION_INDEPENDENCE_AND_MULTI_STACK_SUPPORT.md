# Reference Implementation Independence and Multi-Stack Support

## Purpose

Ensure specifications and test suites can be implemented without Tourify, Next.js, Supabase or a specific cloud.
...
1. Publish implementation-neutral specification.
2. Build second stack.
3. Run conformance and migration.
...
- No Tourify-only semantics in protocol.
- Open test vectors.
- Multiple languages and storage stacks supported.
- Reference implementation has no governance privilege.
...
- The Tourify adapter remains one implementation profile. A second implementation should use a materially independent stack and operator.
