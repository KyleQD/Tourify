...
Protect critical commons operations, signing keys, repositories, infrastructure and software dependencies.
...
1. Threat model component.
2. Provision hardware-backed keys and roles.
3. Monitor privileged action.
4. Rotate, suspend or revoke.
5. Disclose and remediate vulnerability.
...
- No long-lived operator credentials.
- Signed builds and SBOMs.
- Independent penetration and code review.
...
- Security controls apply to steward, operators, vendors and reference implementations.
- Key compromise triggers scoped distrust, status updates, public notice and recovery procedures.
