# Trust Anchors, Recognition and Multi-Root Governance

## Purpose

Prevent a single root of trust by defining transparent recognition, cross-recognition and emergency distrust mechanisms.
...
- `cross_recognition_agreements`
- `distrust_events`

## Primary workflows

1. Apply for recognition.
2. Conduct governance, security and jurisdiction diligence.
3. Approve scoped recognition.
4. Monitor, suspend, revoke or cross-recognize.
...
- No permanent root by default.
- Recognition is scoped and expires.
- Conflicts and funder influence disclosed.
- Emergency distrust requires independent review.
...
- The architecture supports multiple recognized trust lists and explicit verifier policy rather than a universal Tourify root.
- Recognition credentials are supporting evidence and remain subordinate to current registry policy and official source checks.
