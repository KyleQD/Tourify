...
Provide a mandatory pre-change, migration, release and rollback checklist for every Phase 12 implementation task.
...
1. Confirm baseline.
2. Confirm additive design.
3. Test isolation and rollback.
4. Verify legacy regressions.
...
- No parallel music pipeline.
- No public raw-table exposure.
...
- Every pull request should reference execution-plan task IDs and attach commands, migrations, tests, screenshots or payload evidence.
