# Incident Transparency, Public Status and Remedy

## Purpose

Provide incident classification, notification, public status, participant remediation and independent review.
...
3. Notify affected parties and public where appropriate.
4. Restore and remediate.
5. Publish review and corrective actions.
...
- Security and privacy notices follow law and policy.
- Participants can appeal harm decisions.
...
- Public status must distinguish availability, integrity, freshness, issuer trust and operator health.
- Remedy can include correction, credential reissuance, fee refund, support, data deletion or independent review.
