# Public Registries, Projections, Minimization and Disclosures

## Purpose

Define exact public fields, privacy review, disclosure labels and removal or correction processes.
...
1. Select public purpose.
2. Build approved projection.
3. Review leakage and re-identification.
4. Publish with freshness label.
5. Correct, suppress or expire.
...
- No raw operational-table exposure.
- No private agreements or percentages.
- Purpose and source displayed.
- Dispute and revocation visible.
...
- Public data should be sufficient for discovery and verification but not for surveillance, targeting or reconstructing confidential rights positions.
- Search, bulk access and high-volume harvesting require separate controls.
