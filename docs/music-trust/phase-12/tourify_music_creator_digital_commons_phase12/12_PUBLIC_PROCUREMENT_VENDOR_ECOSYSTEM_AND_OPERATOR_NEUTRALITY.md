# Public Procurement, Vendor Ecosystem and Operator Neutrality

## Purpose

Create open procurement, operator accreditation and fair opportunities for multiple compatible providers.
...
2. Evaluate vendors against objective criteria.
3. Contract multiple providers.
4. Monitor performance and transition providers.
...
- No Tourify preference by default.
- Open standards and data export required.
- Conflicts and scoring published where lawful.
- Provider failure cannot terminate participant identity or records.
...
- Procurement criteria include security, accessibility, data portability, open standards, jurisdiction, resilience, financial stability and exit support.
- Conformance marks do not guarantee legal authority or security beyond their published scope.
