# Public-Interest Funding, Endowment and Donor Independence

## Purpose

Create diversified funding and reserves without allowing funders to control technical or rights decisions.
...
- `endowment_accounts`
- `donor_disclosures`
- `funding_concentration_reviews`

## Primary workflows

1. Approve budget and funding policy.
2. Accept, restrict or reject funding.
3. Allocate reserves.
4. Publish donor and concentration reports.
...
- Funding separated from votes and conformance results.
- No donor veto over public records or security findings.
- Minimum reserves and runway.
- Related-party funding reviewed independently.
...
- Funding sources may include grants, memberships, service fees, public procurement and endowment income, but essential access cannot depend solely on transaction fees.
- Concentration thresholds trigger mitigation, not automatic legal conclusions.
