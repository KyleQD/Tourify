...
Add optional commons readiness, participation, registry, protocol and governance surfaces without degrading music workflows.
...
1. Show readiness information.
2. Enroll or withdraw explicitly.
3. Inspect public source and freshness.
4. Submit governance or correction request.
...
- No confusing verified ownership language.
- Jukebox and music routes unchanged.
- Mobile parity planned through APIs.
...
- Suggested routes include `/creator-commons`, `/creator-commons/participation`, `/creator-commons/registry`, `/creator-commons/protocols` and dedicated admin routes.
- Public verification screens must show limitations, source and appeal routes.
