# Participation, Identifiers, Credentials and Portability

## Purpose

Provide explicit, optional and portable participation without compulsory identifiers or provider lock-in.
...
- `commons_participations`
- `participant_identifiers`
- `identifier_control_events`
...
1. Enroll explicitly.
2. Create or link optional identifier.
3. Issue scoped credential.
4. Export, rotate, deactivate, withdraw or migrate provider.
...
- Participation never inferred.
- Identifier documents contain no unnecessary PII.
- Credential status checked at use time.
- Provider migration cannot require Tourify approval.
...
- A creator may use an existing compatible identifier, a new identifier or no public identifier.
- Withdrawal stops future public participation but preserves required legal, audit and revocation records.
