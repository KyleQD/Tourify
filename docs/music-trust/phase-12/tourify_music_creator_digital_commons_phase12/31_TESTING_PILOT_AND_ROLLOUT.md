...
Define sandbox, bilateral multi-implementation pilot, independent review, limited production and stop conditions.
...
2. Deploy isolated sandbox.
3. Operate two independent implementations.
4. Run transition and failure drills.
...
- No production from mocks.
- No single-implementation conformance.
- All high-risk flags default off.
...
- Pilot participants use synthetic or purpose-approved minimal data.
- Production requires independent governance, legal, privacy, security, accessibility and operational approval.
