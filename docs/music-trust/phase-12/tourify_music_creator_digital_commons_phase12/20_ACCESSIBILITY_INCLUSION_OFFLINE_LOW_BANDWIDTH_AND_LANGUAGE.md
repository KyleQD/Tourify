# Accessibility, Inclusion, Offline, Low-Bandwidth and Language

## Purpose

Ensure the commons is usable by creators with disabilities, limited connectivity, limited devices and diverse languages.
...
- `language_packs`
- `assisted_service_cases`
- `offline_packages`
- `accessibility_findings`

## Primary workflows

1. Select accessibility and language needs.
2. Deliver compatible interface or assisted service.
3. Support offline verification and queued submissions.
4. Test and remediate barriers.
...
- No smartphone-only requirement.
- Human assistance does not weaken consent.
- Critical notices available in accessible formats.
...
- Offline artifacts require expiry, integrity verification and safe re-synchronization.
- Localization includes legal and cultural review, not only machine translation.
