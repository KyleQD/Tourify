...
Define safe experiences for creators, member organizations, stewards, operators, implementers, verifiers, auditors, civil society and public institutions.
...
- `commons_participant_roles`
- `participation_consents`
- `withdrawal_requests`

## Primary workflows

1. Creator reviews optional participation and public projections.
2. Organization applies to participate or operate infrastructure.
3. Implementer adopts protocols and runs conformance.
4. Auditor reviews governance, security and portability.
...
- Ordinary Tourify accounts are not commons participants.
- Every role is scoped and separately accepted.
- Withdrawal preserves legal and audit records.
- Accessibility and assisted channels are first-class.
...
- Journeys must show source authority, steward identity, operator identity, jurisdiction, policy version and appeal route.
- No dark patterns may couple music distribution, certification or marketplace access to commons participation.
