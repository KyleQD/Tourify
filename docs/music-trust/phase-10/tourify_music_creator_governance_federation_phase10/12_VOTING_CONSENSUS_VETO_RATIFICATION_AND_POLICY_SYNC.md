# Voting, Consensus, Veto, Ratification and Policy Synchronization

## Purpose

Implement versioned decision workflows for federation standards and services while respecting local vetoes and ratification requirements.

## Primary workflows

1. Create proposal with decision class
2. Resolve eligible voters and weighted or equal vote rule
3. Collect ballots and cryptographic or audit proof
4. Evaluate quorum, threshold, veto and ratification conditions
5. Publish effective policy version and local adoption map

## Required controls

- No hidden vote weighting.
- Abstention and nonparticipation are distinct.
- A federation vote cannot activate a service for an organization that has not locally ratified it.

## Primary records

- `creator_federation_proposals`
- `creator_federation_ballots`
- `creator_federation_policy_adoptions`
