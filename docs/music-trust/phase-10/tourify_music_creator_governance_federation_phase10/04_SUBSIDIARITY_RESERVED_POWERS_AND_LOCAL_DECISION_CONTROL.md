# Subsidiarity, Reserved Powers and Local Decision Control

## Purpose

Create a machine-enforceable policy showing which decisions remain local, which may be delegated, which require joint ratification and which are prohibited.

## Primary workflows

1. Define organization reserved powers
2. Define delegable administrative services
3. Define federation-wide standards decisions
4. Require local ratification where policy demands it
5. Resolve conflicts in favor of the stricter lawful local control

## Required controls

- Default rule is local control.
- Federation decisions cannot amend local bylaws, creator rights, contracts or mandates.
- Absence of a policy entry means the power is not delegated.

## Primary records

- `creator_federation_reserved_powers`
- `creator_federation_delegation_policies`
- `creator_federation_ratification_requirements`
