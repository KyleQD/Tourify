# Data Contribution, Portability and No Automatic Pooling

## Purpose

Allow member organizations to contribute approved extracts or portable data packages without placing raw local data into a universal federation pool.

## Primary workflows

1. Organization selects data package and purpose
2. Validate member and creator permissions
3. Create minimized, versioned export manifest
4. Transfer to approved destination or clean room
5. Process withdrawal, expiry and future-use restrictions

## Required controls

- Federation membership does not license data.
- Portability means controlled transfer, not federation ownership.
- Derived outputs retain lineage to every contributing organization and policy version.

## Primary records

- `creator_federation_data_packages`
- `creator_federation_contribution_permissions`
- `creator_federation_portability_events`
