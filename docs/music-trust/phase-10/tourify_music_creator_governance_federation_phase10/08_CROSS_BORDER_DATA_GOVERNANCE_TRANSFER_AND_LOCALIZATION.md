# Cross-Border Data Governance, Transfer and Localization

## Purpose

Define jurisdiction-aware transfer assessments, localization requirements, onward-transfer controls, processor/subprocessor records and emergency suspension.

## Primary workflows

1. Classify dataset and involved jurisdictions
2. Identify controllers, processors and purposes
3. Select approved transfer mechanism and safeguards
4. Generate immutable transfer manifest
5. Monitor legal changes and suspend invalid routes

## Required controls

- No cross-entity transfer from a prior contribution licence without new approved purpose and transfer authority.
- Data localization and residency rules are policy inputs, not UI preferences.
- Onward transfers require the same or stronger controls.

## Primary records

- `creator_federation_transfer_assessments`
- `creator_federation_data_transfer_manifests`
- `creator_federation_localization_rules`
