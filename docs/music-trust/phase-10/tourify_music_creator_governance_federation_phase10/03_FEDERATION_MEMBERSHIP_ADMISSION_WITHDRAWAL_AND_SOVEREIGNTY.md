# Federation Membership, Admission, Withdrawal and Sovereignty

## Purpose

Define organization-level membership separate from creator membership, including admission, probation, suspension, withdrawal, expulsion and post-exit credential/data treatment.

## Primary workflows

1. Submit organization membership application
2. Verify legal existence, governance and authorized signers
3. Complete member vote or board approval required by local rules
4. Activate limited federation services
5. Process suspension or withdrawal with orderly credential and data offboarding

## Required controls

- Only organizations—not individual Tourify accounts—become federation members under this workflow.
- Withdrawal cannot delete historical evidence or defeat legal holds.
- A federation cannot change local creator membership status.

## Primary records

- `creator_federation_memberships`
- `creator_federation_membership_versions`
- `creator_federation_withdrawals`
