# Security, Keys, Threat Model and Zero Trust

## Purpose

Define threats from compromised issuers, malicious federation members, insider abuse, key theft, credential correlation, routing attacks and governance capture.

## Primary workflows

1. Maintain federation threat model
2. Implement key-management and rotation policy
3. Enforce least privilege and step-up authentication
4. Detect anomalous credential or mandate activity
5. Contain incident and revoke affected trust paths

## Required controls

- Federation trust is explicit and continuously evaluated.
- Cryptographic verification does not replace authorization.
- No single administrator controls root keys, trust registry and audit deletion.

## Primary records

- `creator_federation_security_events`
- `creator_federation_key_registry`
- `creator_federation_risk_decisions`
