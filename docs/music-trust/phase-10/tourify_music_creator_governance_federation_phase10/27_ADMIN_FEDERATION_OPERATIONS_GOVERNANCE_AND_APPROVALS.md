# Admin Federation Operations, Governance and Approvals

## Purpose

Create operational queues for applications, issuers, mandates, transfers, governance, disputes, incidents and compliance reviews.

## Primary workflows

1. Triage application or case
2. Assign competent reviewer with conflict check
3. Collect required approvals
4. Execute controlled state transition
5. Monitor SLA, appeals and compensating actions

## Required controls

- Admin access is capability-based, not broad role-name access.
- High-risk actions require dual control.
- Tourify admins cannot cast member-organization votes.

## Primary records

- `creator_federation_admin_cases`
- `creator_federation_review_assignments`
- `creator_federation_approval_records`
