# Regulator, Standards and Public-Institution Engagement

## Purpose

Define controlled engagement with regulators, standards bodies, CMOs, public agencies and international institutions.

## Primary workflows

1. Identify authorized speaker and member mandate
2. Prepare sourced position or technical contribution
3. Complete competition, lobbying, privacy and IP review
4. Obtain required member or board approval
5. Submit, archive and track response without implying universal creator support

## Required controls

- Public comments identify participating entities and dissent where material.
- Standards participation follows the body’s IPR and contribution rules.
- Tourify cannot speak for nonparticipating organizations.

## Primary records

- `creator_federation_external_engagements`
- `creator_federation_standards_contributions`
- `creator_federation_public_positions`
