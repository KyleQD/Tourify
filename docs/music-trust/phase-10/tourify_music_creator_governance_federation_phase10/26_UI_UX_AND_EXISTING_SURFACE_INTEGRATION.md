...
Plan creator, organization, federation and verifier interfaces that clearly show entity, authority, jurisdiction, credential and decision state.

## Primary workflows

1. Add federation-readiness settings to approved organization surfaces
2. Add credential wallet and presentation views
3. Add mandate and reserved-power controls
4. Add governance proposal and ratification interfaces
5. Add public verification pages with minimal data

## Required controls

- Do not place federation controls on ordinary artist upload screens.
- Every badge links to scope, issuer, status and verification details.
- Unapproved features show education or waitlist states rather than fake functionality.

## Primary records

- `creator federation UI adapters`
- `federation verification pages`
