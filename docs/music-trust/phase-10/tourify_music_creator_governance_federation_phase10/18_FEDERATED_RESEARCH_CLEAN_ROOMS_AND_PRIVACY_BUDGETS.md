# Federated Research, Clean Rooms and Privacy Budgets

## Purpose

Enable approved research across sovereign data institutions through local computation, aggregate queries, clean rooms and privacy-budget controls.

## Primary workflows

1. Submit common research protocol
2. Each organization approves local data use
3. Run local or clean-room computation
4. Combine only policy-approved outputs
5. Review reproducibility, privacy and competition risk before release

## Required controls

- Raw member data stays local unless a separately approved transfer permits otherwise.
- Privacy budgets are tracked across related releases.
- Federated computation does not make an unsafe output anonymous.

## Primary records

- `creator_federation_research_protocols`
- `creator_federation_local_compute_jobs`
- `creator_federation_privacy_budget_ledger`
