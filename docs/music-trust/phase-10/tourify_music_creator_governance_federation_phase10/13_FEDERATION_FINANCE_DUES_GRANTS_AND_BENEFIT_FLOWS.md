# Federation Finance, Dues, Grants and Benefit Flows

## Purpose

Define budgets, dues, grants, shared-service charges, restricted funds and approved benefit flows without merging organization finances.

## Primary workflows

1. Approve annual federation budget
2. Assess and invoice dues under published formula
3. Track restricted grants and conditions
4. Allocate shared-service costs
5. Produce audited statements and organization-level reconciliation

## Required controls

- Federation funds are legally and operationally separate from Tourify and member-organization funds.
- No royalty or creator payment is redirected without a separate lawful instruction.
- Financial benefits cannot purchase governance control contrary to governing documents.

## Primary records

- `creator_federation_budgets`
- `creator_federation_dues`
- `creator_federation_grants_and_restrictions`
