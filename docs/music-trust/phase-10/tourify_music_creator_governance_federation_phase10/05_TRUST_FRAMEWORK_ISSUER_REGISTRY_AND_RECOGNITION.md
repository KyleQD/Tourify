# Federation Trust Framework, Issuer Registry and Recognition

## Purpose

Define how organizations, credential issuers, verifiers, service providers and governance authorities are recognized, reviewed, suspended and removed.

## Primary workflows

1. Publish trust-framework version
2. Accredit or recognize an issuer through approved review
3. Register verification keys and service endpoints
4. Monitor conformance and incidents
5. Suspend, revoke or retire recognition while preserving history

## Required controls

- Recognition is scoped by credential type, jurisdiction and purpose.
- A trust registry is not proof of ownership or legal authority beyond its stated scope.
- Key rotation and issuer compromise require immediate status handling.

## Primary records

- `creator_federation_trust_frameworks`
- `creator_federation_trusted_issuers`
- `creator_federation_trust_registry_versions`
