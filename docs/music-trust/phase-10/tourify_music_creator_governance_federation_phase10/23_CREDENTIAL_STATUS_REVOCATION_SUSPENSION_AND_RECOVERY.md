# Credential Status, Revocation, Suspension and Recovery

## Purpose

Define privacy-preserving credential status, reason handling, emergency suspension, replacement and recovery across federation participants.

## Primary workflows

1. Issue credential with status reference
2. Check status at required assurance level
3. Suspend on incident or dispute
4. Revoke or replace after decision
5. Propagate update to relying parties and audit failed deliveries

## Required controls

- Status endpoints must avoid unnecessary holder tracking.
- Suspension and revocation are distinct and reason disclosure is minimized.
- Recovery cannot resurrect expired or revoked authority.

## Primary records

- `creator_federation_credential_status_lists`
- `creator_federation_status_changes`
- `creator_federation_status_delivery_receipts`
