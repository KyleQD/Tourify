# AI Research, Dataset Licensing and Creator Control

## Purpose

Define separate opt-in pathways for AI research, model evaluation, training, fine-tuning, retrieval, synthetic voice and dataset redistribution.

## Primary workflows

1. Classify the AI purpose and model lifecycle.
2. Require source-specific contributor permission and Rights Passport compatibility.
3. Document model, provider, compute, retention, outputs and downstream users.
4. Enforce prohibited uses and audit access.
5. Provide member-facing reports and withdrawal treatment.

## Required controls

- No AI use from general cooperative membership or public-interest research consent.
- No synthetic voice, style emulation or commercial model deployment without explicit scope.
- No guarantee that model unlearning is technically complete unless independently verified.

## Primary records

- `phase9_ai_research_projects`
- `phase9_ai_data_licenses`
- `phase9_model_use_reports`
- `phase9_ai_withdrawal_events`
