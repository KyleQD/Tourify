# Member Complaints, Appeals, Inspection and Non-Retaliation

## Purpose

Provide enforceable member channels for access, correction, governance challenge, research objection, benefit dispute and retaliation claims.

## Primary workflows

1. Accept confidential and named complaints.
2. Triage jurisdiction, urgency, conflict and legal hold.
3. Assign an independent reviewer or committee.
4. Provide reasoned outcomes and appeal rights.
5. Monitor retaliation and systemic issues.

## Required controls

- Complaints do not reduce discovery, payouts, certifications, licensing access or platform support.
- Board inspection rights do not expose unrelated member confidential information.
- Whistleblower and legal-hold records use restricted storage.

## Primary records

- `phase9_complaints`
- `phase9_appeals`
- `phase9_inspection_requests`
- `phase9_non_retaliation_reviews`
