# Global Creator Policy Observatory

## Purpose

Create a versioned knowledge and evidence system for copyright, AI, labor, competition, privacy, platform, tax and cultural-policy developments affecting creators.

## Primary workflows

1. Ingest official primary sources and jurisdiction metadata.
2. Assign reviewers and freshness dates.
3. Link policy changes to affected Tourify capabilities and member education.
4. Publish neutral summaries with source citations and uncertainty.
5. Retire or correct stale interpretations.

## Required controls

- No partisan endorsements, lobbying instruction or legal conclusion by default.
- Policy alerts must distinguish enacted law, proposed rules, guidance, litigation and commentary.
- Machine summaries require human review before member-facing high-impact alerts.

## Primary records

- `phase9_policy_sources`
- `phase9_policy_versions`
- `phase9_policy_impacts`
- `phase9_policy_alerts`
