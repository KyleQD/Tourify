# Research Exchange, Applicants, Protocols and Eligibility

## Purpose

Define a licensed research exchange for universities, public-interest organizations, standards bodies and approved commercial researchers.

## Primary workflows

1. Verify the applicant institution, investigators, funding, conflicts and sanctions status.
2. Collect a protocol, data-minimization plan, analysis plan, publication plan and security controls.
3. Classify research as internal evaluation, public-interest, academic, commercial or product development.
4. Route to ethics, privacy, security, IP, competition and board review.
5. Issue a time-bound research licence and access grant.

## Required controls

- No anonymous or click-through researcher access.
- Commercial research cannot use public-interest consent or pricing.
- Funders and downstream beneficiaries must be disclosed.

## Primary records

- `phase9_research_applications`
- `phase9_research_protocols`
- `phase9_research_licenses`
- `phase9_research_access_grants`
