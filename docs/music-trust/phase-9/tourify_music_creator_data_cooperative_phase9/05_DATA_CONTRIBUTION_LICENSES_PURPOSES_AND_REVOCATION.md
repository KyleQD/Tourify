# Data Contribution Licences, Permitted Purposes and Revocation

## Purpose

Create a granular legal and technical model for members to license selected data for selected purposes without transferring ownership by implication.

## Primary workflows

1. Select specific data categories and source systems.
2. Select permitted purposes, researchers, geographies, duration, output types and benefit rules.
3. Execute a versioned contribution licence.
4. Propagate suspension, expiry or revocation to future datasets and jobs.
5. Preserve completed lawful outputs and audit records according to policy.

## Required controls

- No blanket licence to all present and future data or purposes.
- AI training, model development, commercial research and public policy uses require separate toggles.
- Revocation cannot be represented as erasing already published aggregate facts when erasure is technically or legally impossible.

## Primary records

- `phase9_data_contribution_licenses`
- `phase9_contribution_scopes`
- `phase9_revocation_events`
