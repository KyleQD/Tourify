# Analytics, Transparency, Public Interest and Impact

## Purpose

Measure membership health, consent quality, research access, privacy, benefit distribution, policy reach and public-interest outcomes without optimizing for data extraction.

## Primary workflows

1. Define balanced metrics and harms.
2. Generate member and public transparency reports.
3. Measure opt-out, complaint and correction rates.
4. Evaluate benefit distribution and researcher diversity.
5. Commission independent audits and impact assessments.

## Required controls

- No KPI rewards increasing data contribution regardless of member benefit or risk.
- No suppression of negative audit findings.
- Public reporting uses approved aggregate outputs only.

## Primary records

- `phase9_impact_metrics`
- `phase9_transparency_reports`
- `phase9_independent_audits`
