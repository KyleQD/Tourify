# Entity Options, Fiduciary Duties and Platform Boundaries

## Purpose

Provide a decision framework for a Nevada cooperative, nonprofit cooperative, public-benefit organization, data trust, contractual data-sharing consortium or other separately advised structure.

## Primary workflows

1. Compare entity purpose, ownership, voting, transferability, fiduciary duties, tax, securities, fundraising and dissolution.
2. Document Tourify service agreements with the separate entity.
3. Approve related-party transactions and data-processing roles.
4. Map which entity is controller, processor, licensor, fiduciary, research sponsor, publisher and payment obligor.

## Required controls

- No automatic selection of a Nevada or other entity form.
- Tourify executives do not control member votes by default.
- Entity assets, bank accounts, books, contracts and liabilities remain separate.

## Primary records

- `phase9_entity_options`
- `phase9_entity_role_assignments`
- `phase9_related_party_approvals`
