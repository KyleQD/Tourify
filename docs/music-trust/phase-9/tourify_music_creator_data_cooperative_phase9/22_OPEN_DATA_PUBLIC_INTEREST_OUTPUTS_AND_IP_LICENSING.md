# Open Data, Public-Interest Outputs and IP Licensing

## Purpose

Define when outputs may be private, member-only, licensed, openly published or released under standard public licences.

## Primary workflows

1. Classify ownership of source data, code, documentation, schemas, benchmarks and publications.
2. Choose an approved licence and attribution policy.
3. Check privacy, IP, contract, export and competition restrictions.
4. Publish reproducibility artifacts where safe.
5. Maintain version, correction and withdrawal records.

## Required controls

- Raw member data is never open data.
- Open-source code does not imply open access to production data or keys.
- No public licence may conflict with a standards-body or research-partner IPR obligation.

## Primary records

- `phase9_output_assets`
- `phase9_output_licenses`
- `phase9_open_releases`
- `phase9_attribution_records`
