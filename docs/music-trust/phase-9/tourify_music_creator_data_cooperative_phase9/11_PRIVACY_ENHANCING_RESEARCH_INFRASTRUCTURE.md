# Privacy-Enhancing Research Infrastructure

## Purpose

Plan differential privacy, secure multi-party computation, trusted execution environments, federated analysis, synthetic data and clean-room controls.

## Primary workflows

1. Select the least invasive PET that satisfies the approved protocol.
2. Document threat model, trust assumptions, utility tradeoffs and residual risk.
3. Allocate and enforce privacy budgets.
4. Validate implementation against known failure modes.
5. Review combined-query and composition risk over time.

## Required controls

- PET use never replaces lawful basis, consent, contracts or governance.
- Synthetic data is not assumed anonymous.
- Privacy claims must identify the mechanism and parameters rather than use vague “anonymized” language.

## Primary records

- `phase9_privacy_mechanisms`
- `phase9_privacy_budgets`
- `phase9_clean_room_sessions`
- `phase9_privacy_evaluations`
