# Research Ethics, IRB Review and Participant Protections

## Purpose

Create a review framework for human-subject, secondary-data and member-impact research, including independent ethics review where applicable.

## Primary workflows

1. Classify whether the activity is product analytics, quality improvement, non-human-subject research or human-subject research.
2. Require an IRB or independent ethics determination when appropriate.
3. Document consent, waiver, exemption or non-applicability decisions.
4. Assess vulnerable populations, deception, contact, recontact and participant risk.
5. Monitor deviations, adverse events and protocol amendments.

## Required controls

- Tourify does not self-declare regulatory exemption solely to avoid review.
- Research ethics approval does not replace privacy, competition, IP or contract approval.
- Members can decline research participation without losing unrelated platform services.

## Primary records

- `phase9_ethics_reviews`
- `phase9_irb_determinations`
- `phase9_protocol_deviations`
- `phase9_adverse_events`
