...
Add cooperative and research surfaces without changing existing artist upload and listener experiences.

## Primary workflows

1. Create a separate cooperative readiness hub.
2. Show membership and contribution as distinct opt-ins.
3. Provide member governance, data-use, research and benefit dashboards.
4. Provide researcher application and secure workspace surfaces.
5. Add optional educational cards to artist dashboards without coercive upsells.

## Required controls

- No cooperative badge implies certification, ownership or representation.
- No contribution toggle preselected.
- No public display of membership without member permission.

## Primary records

- `app/cooperative/**`
- `components/music/creator-cooperative/**`
- `app/api/creator-cooperative/**`
