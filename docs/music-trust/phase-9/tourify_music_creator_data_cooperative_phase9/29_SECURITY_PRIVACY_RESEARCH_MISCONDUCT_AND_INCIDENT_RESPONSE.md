# Security, Privacy, Research Misconduct and Incident Response

## Purpose

Plan threat modeling, access monitoring, insider risk, re-identification attempts, research misconduct, breach response and member notice.

## Primary workflows

1. Classify incidents and affected sources.
2. Freeze access and preserve evidence.
3. Notify entity leadership, counsel, partners, regulators and members as required.
4. Investigate re-identification, unauthorized publication, falsification or misuse.
5. Remediate, revoke and publish post-incident findings where appropriate.

## Required controls

- No automatic deletion during investigation or legal hold.
- Researchers must report suspected leakage and protocol deviations.
- Incident response covers both technical and governance failures.
