# API Routes, Events, Background Jobs and Partner Adapters

## Purpose

Define route namespaces, service boundaries, event outboxes, worker jobs, idempotency and partner synchronization.

## Primary workflows

1. Create membership, contribution, research, publication, governance and policy route families.
2. Use signed job payloads and idempotency keys.
3. Create outbox events for external partners.
4. Reconcile partner acknowledgements and failures.
5. Provide dead-letter, retry and compensating workflows.

## Required controls

- No long-running research computation in request handlers.
- No partner secret or service role in the client.
- Every write path records actor, authority, source version and reason.

## Primary records

- `phase9_outbox_events`
- `phase9_job_runs`
- `phase9_partner_deliveries`
- `phase9_dead_letters`
