...
Provide the mandatory pre-change, migration, API, UI, security, regression and rollback checklist.

## Primary workflows

1. Audit canonical paths and current deployed schema.
2. Create backups and explicit migration rollback plans.
3. Add feature flags before routes or jobs.
4. Run RLS and storage tests in isolated environments.
5. Complete full music ecosystem regression.

## Required controls

- No database reset, table replacement or destructive rename.
- No direct alteration of Phase 1–8 state machines.
- No production enablement without named operational owner.
