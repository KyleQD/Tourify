# Product Model and Member/Researcher Journeys

## Purpose

Define distinct journeys for creators, cooperative members, directors, researchers, public-interest partners, standards participants and Tourify operators.

## Primary workflows

1. Creator reviews educational materials without joining.
2. Creator applies for membership and separately chooses whether to contribute particular data.
3. Researcher submits a scoped protocol and receives approved aggregate or clean-room access only.
4. Member reviews benefits, votes, withdrawals and published outputs.
5. Board and committees approve high-risk uses and external actions.

## Required controls

- No dark patterns or bundling of membership with Artist+, certification or rights-administration services.
- Membership and contribution are reversible according to governing documents and data-retention law.
- External researcher access is never self-service.

## Primary records

- `phase9_members`
- `phase9_membership_applications`
- `phase9_researcher_profiles`
