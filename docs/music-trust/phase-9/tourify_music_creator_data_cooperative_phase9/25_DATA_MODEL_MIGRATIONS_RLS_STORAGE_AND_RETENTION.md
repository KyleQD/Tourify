...
Define additive database, storage, RLS, retention, deletion, legal-hold and audit requirements for Phase 9.

## Primary workflows

1. Create separate membership, governance, data contribution, research, publication and policy tables.
2. Use restricted cooperative and research-evidence buckets.
3. Implement owner/member/committee/researcher/worker policies with explicit capability checks.
4. Backfill only explicit approved references.
5. Run advisors and generated-type updates.

## Required controls

- No public table or view without RLS or security-invoker review.
- No SECURITY DEFINER shortcut for broad access.
- Deletions use tombstones or compensating records where audit or law requires retention.

## Primary records

- phase9 database objects defined in migration templates
