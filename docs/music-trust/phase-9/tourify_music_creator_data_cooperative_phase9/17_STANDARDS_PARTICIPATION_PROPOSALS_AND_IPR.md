# Standards Participation, Proposals and Intellectual-Property Rights

## Purpose

Build a workspace for member-informed participation in DDEX, W3C, ISO, C2PA, CISAC and other approved standards processes.

## Primary workflows

1. Classify the standards body, participation rules and IPR policy.
2. Collect member input without exposing confidential data.
3. Draft proposals, issues, implementation feedback and test vectors.
4. Approve representatives and statements.
5. Archive submissions, minutes, votes and resulting standards versions.

## Required controls

- No claim that a Tourify proposal is an adopted standard.
- Contributions must comply with the body’s patent, copyright and confidentiality policies.
- Competitor discussions are limited to the approved standards scope.

## Primary records

- `phase9_standards_bodies`
- `phase9_standards_projects`
- `phase9_standards_contributions`
- `phase9_ipr_disclosures`
