# Admin Cooperative, Research and Policy Operations

## Purpose

Define separate operational queues and permissions for membership, governance, data, research, publications, benefits, policy and incidents.

## Primary workflows

1. Review applications and conflicts.
2. Route matters to board or committees.
3. Monitor consent, licences, cohorts, privacy budgets and outputs.
4. Reconcile partner and payment activity.
5. Generate board, member and regulator reports.

## Required controls

- Tourify super-admin does not automatically receive cooperative confidential access.
- High-risk actions require dual control or committee approval.
- Operational SLAs do not override legal stop conditions.

## Primary records

- `phase9_ops_cases`
- `phase9_review_assignments`
- `phase9_sla_events`
- `phase9_board_packets`
