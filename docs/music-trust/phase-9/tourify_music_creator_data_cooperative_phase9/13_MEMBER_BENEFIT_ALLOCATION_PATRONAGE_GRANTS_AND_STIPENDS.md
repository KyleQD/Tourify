# Member Benefit Allocation, Patronage, Grants and Stipends

## Purpose

Define how research licence revenue or cooperative surplus may support members without promising investment returns or distorting consent.

## Primary workflows

1. Classify receipts, restricted grants, service revenue and donations.
2. Deduct approved reserves and operating expenses.
3. Apply a board/member-approved allocation formula tied to lawful cooperative activity.
4. Generate statements, holds, corrections and tax-provider exports.
5. Publish aggregate allocation policy and conflicts disclosures.

## Required controls

- Consent to data use is not conditioned on speculative payment.
- No benefit formula may encourage members to contribute unlawful, inaccurate or excessive personal data.
- No payout occurs until tax, sanctions, identity and payment readiness are complete.

## Primary records

- `phase9_benefit_pools`
- `phase9_benefit_allocations`
- `phase9_member_benefit_statements`
- `phase9_benefit_holds`
