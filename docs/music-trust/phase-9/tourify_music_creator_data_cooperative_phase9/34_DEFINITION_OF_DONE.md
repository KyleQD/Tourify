...
Define evidence required for Phase 9 readiness and distinguish documentation, pilot, production and separately approved collective capabilities.

## Primary workflows

1. Complete audited architecture and legal/entity decision records.
2. Pass data, consent, RLS, privacy, ethics, competition and security tests.
3. Prove member rights, withdrawal, complaints and non-retaliation.
4. Validate research output review and benefit accounting.
5. Maintain all existing Tourify music regressions.

## Required controls

- No area is complete merely because a schema or UI exists.
- No collective or external representation area can be complete under readiness-only approval.
