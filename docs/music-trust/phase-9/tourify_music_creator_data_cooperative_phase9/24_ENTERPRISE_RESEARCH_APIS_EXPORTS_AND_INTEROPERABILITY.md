# Enterprise Research APIs, Exports and Interoperability

## Purpose

Define scoped APIs, data products, secure exports, schemas, rate limits, contracts and revocation for approved institutions.

## Primary workflows

1. Provision a partner and approved use case.
2. Issue scoped credentials and mTLS or equivalent controls.
3. Generate privacy-reviewed datasets or query endpoints.
4. Meter access and reconcile usage.
5. Revoke credentials and preserve audit evidence.

## Required controls

- No API exposes member identities, raw contracts or artist masters.
- API schemas are versioned and do not silently widen fields.
- Partners cannot use exports for advertising, scoring or AI training unless explicitly licensed.

## Primary records

- `phase9_research_partners`
- `phase9_api_credentials`
- `phase9_data_products`
- `phase9_export_jobs`
