# Mature Public-Law Interoperability Service Catalog

## Purpose

Define the limited public-law services the institution could provide after separate authorization.

## Phase boundary

Services must be enumerated. The institution has no inherent general competence over creators or copyright.
...
- `public_law_service_definitions`
...
3. approve service charter.
4. test.
5. activate by jurisdiction.
6. monitor.
7. suspend or retire.
...
- Potential services include standards coordination, conformance, public trust status, technical assistance, capacity building, implementation reporting and non-adjudicative reference resolution.
- Each service has an enumerated legal basis, eligibility, jurisdiction list, SLA, complaint process, suspension path and sunset date.
- No service adjudicates copyright or sets market rates.
