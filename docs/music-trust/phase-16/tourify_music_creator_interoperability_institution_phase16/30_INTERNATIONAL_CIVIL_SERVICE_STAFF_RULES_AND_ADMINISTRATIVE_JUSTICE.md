# International Civil Service, Staff Rules and Administrative Justice

## Purpose

Define lawful employment status, staff rules, internal review and an independent employment remedy.

## Phase boundary

International-civil-service labels and administrative tribunal jurisdiction require an actual legal basis.
...
- Domestic employment status remains the default until a valid international civil-service framework exists.
- Recognition of an external administrative tribunal requires the tribunal’s actual eligibility and approval process.
- Judgments and settlements require implementation tracking.
