...
Prevent interoperability services from becoming coordinated pricing or collective market power.

## Phase boundary

No rate setting, bid coordination, boycott, blacklist, market allocation or compulsory licensing authority.
...
1. Screen proposal.
2. quarantine sensitive data.
3. obtain counsel review.
4. redesign.
5. approve limited neutral function or block.
