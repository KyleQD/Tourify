# Information Access, Public Archives, Records and Transparency

## Purpose

Provide public records, archival integrity and lawful confidentiality exceptions.

## Phase boundary

Transparency does not expose private identity, evidence, contracts, tax, payment or security material.
...
3. apply exception.
4. redact.
5. release or deny with reasons.
6. appeal.
7. archive.
8. declassify later.
