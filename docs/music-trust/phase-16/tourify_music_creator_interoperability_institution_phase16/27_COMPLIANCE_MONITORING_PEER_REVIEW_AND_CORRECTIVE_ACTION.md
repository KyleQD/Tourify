# Compliance Monitoring, Peer Review and Corrective Action

## Purpose

Monitor implementation with transparent criteria and proportionate remedies.

## Phase boundary

Monitoring does not authorize political retaliation or punishment of creators and nonparticipants.
...
3. peer review.
4. respond.
5. adopt corrective plan.
6. monitor.
7. close or escalate with due process.
