# Depositary, Registration, Publication and Authentic Texts

## Purpose

Prepare formal custody, notification, certified-copy, treaty-registration and authentic-text operations.

## Phase boundary

A private custodian remains a private custodian until a valid instrument appoints a depositary; UN Article 102 registration is external and cannot be self-certified by Tourify.
...
- `depositary_appointments`
- `authentic_texts`
- `certified_copies`
- `registration_submissions`
- `depositary_notifications`
...
2. validate form and authority.
3. preserve originals.
4. issue signed notifications.
5. register externally when eligible.
6. publish authoritative status.
...
- Model certified copies, full powers, signature, ratification, accession, reservations, objections, corrections and withdrawal as separate instrument events.
- Article 102 registration is an external status and the UN registration identifier is stored only after reconciliation.
- Authentic texts and courtesy translations are separately labeled.
