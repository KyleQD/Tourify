# Global Capacity-Building Fund and Grant Governance

## Purpose

Create a separately governed public-interest fund for implementation assistance.

## Phase boundary

Grant funding cannot purchase votes, recognition, conformance results, procurement outcomes or policy positions.
...
4. award.
5. milestone disbursement.
6. audit.
7. suspend.
8. recover improperly used funds.
