# Exact-Scope Mandates, Delegation and Public-Law Authorization

## Purpose

Prevent public-law or technical status from becoming an implied rights, payment or representation mandate.

## Phase boundary

Every action must fit an active mandate and the institution’s enumerated legal competence.
...
1. Load current mandate.
2. compare action scope.
3. evaluate reservations and local powers.
4. require approvals.
5. execute idempotently.
6. revoke or compensate.
