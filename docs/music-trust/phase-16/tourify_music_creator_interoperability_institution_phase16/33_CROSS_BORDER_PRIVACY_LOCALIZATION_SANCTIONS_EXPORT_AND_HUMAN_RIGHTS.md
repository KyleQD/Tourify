...
Gate cross-border data and service activity to current legal and human-rights review.

## Phase boundary

Institutional membership does not waive privacy, localization, sanctions, export or human-rights obligations.
...
4. screen parties.
5. approve.
6. monitor onward transfer.
7. suspend and delete or retain lawfully.
