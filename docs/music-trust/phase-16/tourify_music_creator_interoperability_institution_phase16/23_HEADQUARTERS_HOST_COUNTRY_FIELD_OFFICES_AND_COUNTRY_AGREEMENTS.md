# Headquarters, Host Country, Field Offices and Country Agreements

## Purpose

Model host and country agreements needed for institutional operation.

## Phase boundary

A mailing address, incorporation or cloud region is not a headquarters agreement.
...
1. Select candidate.
2. assess law and remedies.
3. negotiate.
4. approve.
5. enter into force.
6. monitor.
7. amend.
8. terminate and relocate.
