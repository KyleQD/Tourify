# Continuity, Emergency Powers, Succession, Dissolution and Asset Lock

## Purpose

Ensure services and public assets survive operator or institutional failure.

## Phase boundary

Emergency powers are narrow, time-limited, reviewable and cannot permanently change the constitutive instrument.
...
1. Declare narrowly.
2. activate alternate operator.
3. notify.
4. preserve records.
5. review.
6. expire.
7. succeed or dissolve.
8. transfer assets under approved schedule.
