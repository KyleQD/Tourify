# Model Public Treaty-System Instrument and Protocol Package

## Purpose

Provide a drafting and issue-spotting package for counsel and competent authorities.

## Phase boundary

Templates are not adopted instruments and must not be represented as effective.
...
4. consult.
5. revise.
6. approve externally.
7. deposit or register through the proper process.
...
- Constitutive-instrument issue list and article map.
- Optional protocol template with purpose, scope, parties, reservations, entry into force, amendments, withdrawal and depositary clauses.
- Authentic-language and certified-copy workflow.
- Competent-authority and full-powers evidence checklist.
- Article 102 registration submission checklist.
- Implementation schedule and jurisdiction module.
- Public communications language that distinguishes draft, signed, effective and registered status.

No model clause is production-ready until approved by competent authorities and counsel for the participating jurisdictions.
