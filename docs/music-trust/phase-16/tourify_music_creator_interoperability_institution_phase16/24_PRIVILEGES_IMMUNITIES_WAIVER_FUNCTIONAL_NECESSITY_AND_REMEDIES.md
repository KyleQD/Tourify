# Privileges, Immunities, Waiver, Functional Necessity and Remedies

## Purpose

Gate all privilege and immunity records to effective law and alternative remedies.

## Phase boundary

Privileges are never enabled through platform settings and cannot be used to create impunity.
...
1. Verify legal grant.
2. map function.
3. notify beneficiary.
4. assess waiver.
5. provide alternative remedy.
6. record abuse review.
7. suspend invalid claims.
...
- Privileges are mapped by jurisdiction and beneficiary class, not globally inferred.
- Waiver authority and procedure are versioned.
- Alternative dispute and claims mechanisms are tested before any immunity is relied upon.
