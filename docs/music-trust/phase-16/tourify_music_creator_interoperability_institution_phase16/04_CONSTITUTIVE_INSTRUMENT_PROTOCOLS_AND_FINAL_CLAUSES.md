# Constitutive Instrument, Protocols and Final Clauses

## Purpose

Model how a valid constitutive instrument and later protocols or annexes would be recorded without treating drafts as effective law.

## Phase boundary

Drafting assistance is not legal adoption. Entry into force, amendments and protocol participation require the exact procedures in the effective instrument.
...
- `constitutive_instruments`
- `protocol_instruments`
- `annex_versions`
- `final_clause_events`
- `entry_into_force_conditions`
...
1. Draft.
2. compare authentic texts.
3. collect authority evidence.
4. sign.
5. ratify or approve.
6. calculate entry into force.
7. publish current status.
8. supersede without rewriting history.
