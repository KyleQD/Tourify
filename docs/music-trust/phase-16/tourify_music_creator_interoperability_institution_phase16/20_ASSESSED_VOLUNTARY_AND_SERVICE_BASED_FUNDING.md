...
Define funding types and their legal prerequisites.

## Phase boundary

Assessed contributions require an effective constitutive basis and approved scale; software cannot invoice states as members by default.
...
1. Approve budget.
2. calculate assessment under valid rules.
3. issue notice.
4. receive payment.
5. manage arrears.
6. accept or reject voluntary contribution.
7. disclose concentration.
