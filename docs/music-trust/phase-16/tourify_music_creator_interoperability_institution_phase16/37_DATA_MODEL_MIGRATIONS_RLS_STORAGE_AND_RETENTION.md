...
Translate institutional requirements into additive, default-deny persistence.

## Phase boundary

Reference SQL is not production SQL until the repository and deployed schema are audited.
...
7. deploy.
8. monitor.
9. roll back by compensating action.
