# Testing, Multi-Year Pilot, Public Approval and Rollout

## Purpose

Require sustained evidence before limited production activation.

## Phase boundary

A successful demo or sandbox is insufficient for public-law activation.
...
1. Sandbox.
2. bilateral pilot.
3. multi-operator pilot.
4. independent audit.
5. public notice.
6. approval.
7. time-limited activation.
8. monitor.
9. sunset or expand.
...
- The pilot must include at least two independent operators, two implementations, multiple participant classes and a successful Tourify-unavailable drill.
- Privileges, treaty status and UN relationship remain disabled during the sandbox unless already effective under external law.
- Public status pages must distinguish simulated, proposed, approved and effective states.
