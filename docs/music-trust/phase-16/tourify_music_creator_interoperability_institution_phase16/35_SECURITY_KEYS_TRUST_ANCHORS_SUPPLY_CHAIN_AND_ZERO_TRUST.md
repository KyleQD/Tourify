# Security, Keys, Trust Anchors, Supply Chain and Zero Trust

## Purpose

Protect institutional signing, registry and public service operations.

## Phase boundary

Critical actions require hardware-backed keys, dual control, short-lived access and independent monitoring.
...
4. log.
5. rotate.
6. suspend compromised key.
7. recover.
8. attest build.
9. revoke supplier access.
