# Relationship Agreements with WIPO, ITU, UNESCO, ILO and Regional Organizations

## Purpose

Provide a controlled framework for liaison, cooperation and service agreements with established institutions.

## Phase boundary

A memorandum or technical liaison does not create membership, endorsement, regulatory authority or mutual representation.
...
2. verify authority.
3. conduct conflicts and mandate review.
4. approve scope.
5. execute.
6. monitor deliverables.
7. terminate and revoke access.
