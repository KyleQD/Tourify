...
Support minimal source-linked rights references while preserving official and private sources.

## Phase boundary

The institution does not adjudicate copyright ownership through a resolver response.
...
1. Request reference.
2. resolve approved projection.
3. show source and freshness.
4. flag disputes.
5. route correction to authoritative source.
6. revoke stale projection.
