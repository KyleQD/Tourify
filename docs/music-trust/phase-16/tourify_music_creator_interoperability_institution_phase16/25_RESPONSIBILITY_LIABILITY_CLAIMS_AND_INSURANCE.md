...
Model attribution, institutional responsibility, claims and risk transfer.

## Phase boundary

Responsibility is determined from conduct, authority, attribution and applicable law, not a registry label.
...
4. notify insurer and affected parties.
5. review remedy.
6. settle or contest.
7. publish permitted outcome.
