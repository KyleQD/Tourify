# Public-Law Dispute Settlement, Advisory Procedures and Review

## Purpose

Define consultation, mediation, arbitration, institutional review and advisory pathways without claiming court status.

## Phase boundary

An internal review panel cannot exercise state judicial power or bind non-consenting parties.
...
4. appoint neutral.
5. hear parties.
6. issue reasoned result.
7. implement.
8. appeal where authorized.
