# Public Trust Registries, Identifiers, Credentials and Status

## Purpose

Govern optional public trust and status services with participant control and multi-root safeguards.

## Phase boundary

No compulsory global identifier, wallet or credential. Public status is minimal and revocable.
