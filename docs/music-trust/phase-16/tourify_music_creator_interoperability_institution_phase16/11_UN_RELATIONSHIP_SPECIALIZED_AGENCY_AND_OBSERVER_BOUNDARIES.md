# UN Relationship, Specialized Agency and Observer Boundaries

## Purpose

Define the external approval path for any UN relationship while preventing implied affiliation.

## Phase boundary

Specialized-agency status requires intergovernmental establishment and a relationship agreement through the applicable UN Charter process.
...
- `un_relationship_assessments`
- `ecosoc_agreement_records`
- `ga_approval_records`
- `observer_status_records`
...
2. engage through approved diplomatic channels.
3. negotiate separately.
4. obtain institutional approvals.
5. update public claims only after effectiveness.
...
- Article 57/63 specialized-agency relationships require intergovernmental establishment and an agreement approved through the applicable UN process.
- Observer or liaison status is distinct from specialized-agency status.
- UN logos, names and relationship claims require separate authorization.
