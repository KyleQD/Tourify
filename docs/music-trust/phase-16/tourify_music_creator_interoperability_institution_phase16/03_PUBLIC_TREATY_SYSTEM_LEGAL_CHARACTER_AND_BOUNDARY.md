# Public Treaty-System Legal Character and Boundary

## Purpose

Prevent private platform or convention records from being presented as public international law instruments.

## Phase boundary

Legal character is determined by valid instruments, competent parties and applicable law—not naming, branding, UI labels or tokenization.
...
2. verify parties and governing law.
3. restrict labels.
4. review public communications.
5. suspend misleading claims.
...
- Use labels such as `private_compact`, `institutional_agreement`, `intergovernmental_instrument`, `effective_treaty` and `relationship_agreement` as distinct states.
- Public communications must display the exact legal character and effective date.
- No UI badge may imply UN affiliation, member-state status or immunity.
