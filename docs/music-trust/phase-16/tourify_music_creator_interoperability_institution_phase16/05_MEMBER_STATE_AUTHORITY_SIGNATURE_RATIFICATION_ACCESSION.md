# Member-State Authority, Signature, Ratification and Accession

## Purpose

Capture competent governmental authority and constitutional processes for state participation.

## Phase boundary

A ministry email, platform administrator approval or credential is not proof that a state is bound.
...
- `full_powers_evidence`
- `signature_events`
- `ratification_instruments`
- `accession_instruments`
...
1. Verify competent authority.
2. record full powers where applicable.
3. accept signed instruments.
4. validate form.
5. calculate status.
6. issue notifications.
7. preserve objections and corrections.
