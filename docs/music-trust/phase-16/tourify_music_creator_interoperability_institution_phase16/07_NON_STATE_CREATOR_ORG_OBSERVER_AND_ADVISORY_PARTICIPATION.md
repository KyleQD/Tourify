# Non-State, Creator Organization, Observer and Advisory Participation

## Purpose

Protect meaningful creator participation without falsely presenting non-state participants as treaty parties or public authorities.

## Phase boundary

Observer, advisor, implementer, beneficiary and member roles remain distinct.
...
- `observer_accreditations`
- `creator_advisory_seats`
- `civil_society_submissions`
...
1. Apply.
2. verify identity and mandate.
3. classify role.
4. disclose conflicts.
5. participate within scope.
6. appeal accreditation decisions.
7. withdraw.
