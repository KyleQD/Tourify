# Implementation Assistance, Country Programming and Capacity Building

## Purpose

Design technical assistance that is requested, transparent and non-coercive.

## Phase boundary

Assistance does not condition access on political alignment, proprietary software or rights transfer.
...
1. Receive request.
2. assess needs.
3. approve conflict-free workplan.
4. procure support.
5. deliver.
6. evaluate.
7. publish permitted results.
