...
Add readiness and institutional views without changing existing music behavior.

## Phase boundary

Legal character, authority, dispute, freshness and non-adjudication labels must be visible.
...
5. show blockers.
6. provide appeal.
7. expose minimal public projection.
