# Treaty Protocols, Annexes, Reservations and Declarations

## Purpose

Model protocol participation and instrument-specific reservations or declarations.

## Phase boundary

Reservations and declarations are legal instruments whose permissibility and effect require instrument-specific review.
...
1. Submit instrument.
2. classify type.
3. review permissibility.
4. notify participants.
5. record objections.
6. calculate effect.
7. withdraw or modify with full history.
