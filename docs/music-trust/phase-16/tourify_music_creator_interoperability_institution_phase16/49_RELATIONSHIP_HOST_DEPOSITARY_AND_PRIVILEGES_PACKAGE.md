# Relationship, Host, Depositary and Privileges Package

## Purpose

Consolidate the external instruments needed for mature institutional operation.

## Phase boundary

No relationship, headquarters, depositary or privilege status is activated from a checklist alone.
...
2. negotiate.
3. obtain competent approvals.
4. sign.
5. enter into force.
6. publish permitted status.
7. monitor and amend.
...
1. UN or international-organization relationship agreement issue list.
2. Headquarters and field-office agreement issue list.
3. Private custodian versus formal depositary classification.
4. Privilege and immunity schedule by jurisdiction and beneficiary.
5. Waiver, claims and alternative-remedy matrix.
6. Staff-justice and employment-jurisdiction analysis.
7. Public status and branding controls.
8. Termination, relocation and succession plan.
