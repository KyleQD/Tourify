...
Describe the readiness-only experiences for states, international organizations, creator bodies, observers, secretariat staff, implementers, auditors and the public.

## Phase boundary

The first product is an institutional readiness workspace, not a live treaty or regulatory service.
...
- `institution_participant_profiles`
- `participant_authority_evidence`
- `service_readiness_cases`
- `public_status_projections`
...
1. Apply.
2. submit authority evidence.
3. review.
4. simulate governing-body action.
5. test service delivery.
6. publish an accurate readiness status.
7. withdraw or correct participation.
