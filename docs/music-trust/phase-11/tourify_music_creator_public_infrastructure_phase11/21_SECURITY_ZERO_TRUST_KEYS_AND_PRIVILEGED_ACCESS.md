# Security, Zero Trust, Keys and Privileged Access

## Purpose

Protect infrastructure roots of trust, registries, signing keys and administrative functions with strong separation of duties.
...
1. Provision hardware-backed key.
2. Approve role and time-bound access.
3. Rotate or revoke.
4. Run compromise drill.
...
- No production root keys in application environment.
- Dual control.
- Just-in-time access.
- Independent audit.
