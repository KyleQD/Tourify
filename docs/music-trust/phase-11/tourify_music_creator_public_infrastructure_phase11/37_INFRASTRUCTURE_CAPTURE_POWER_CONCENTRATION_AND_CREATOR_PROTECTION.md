# Infrastructure Capture, Power Concentration and Creator Protection

## Purpose

Measure and limit structural power held by Tourify, governments, large platforms, dominant rightsholders, funders and technology vendors.
...
- `power_concentration_reviews`
- `capture_risk_indicators`
- `creator_protection_actions`

## Primary workflows

1. Measure voting, funding, technical and operational concentration.
2. Trigger independent review.
3. Apply mitigation.
4. Publish accountability report.
...
- Creator remedy and exit.
- No retaliation.
- No exclusive dependence.
- Emergency stewardship transition.
