# Rights Reference Resolution and Source-of-Truth Links

## Purpose

Provide minimal, versioned links to Rights Passports, licences, mandates and official records without exposing confidential rights data or declaring ownership.
...
- `rights_reference_sources`
- `resolver_responses`
- `resolver_dispute_flags`

## Primary workflows

1. Submit approved source reference.
2. Validate source and scope.
3. Resolve status and links.
4. Correct, suspend or mark disputed.
...
- Reference not ownership proof.
- No confidential shares or contracts in public response.
- Freshness and dispute status required.
