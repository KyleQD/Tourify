# Public-Interest Funding, Endowment, Procurement and Sustainability

## Purpose

Define transparent funding and procurement that supports long-term operation without turning creators into captive customers.
...
1. Approve funding source.
2. Conflict and restriction review.
3. Open procurement.
4. Publish budget and continuity plan.
...
- No undisclosed sponsor control.
- No sale of creator data to fund operations.
- Open exit and transition clauses.
- Affordable core access.
