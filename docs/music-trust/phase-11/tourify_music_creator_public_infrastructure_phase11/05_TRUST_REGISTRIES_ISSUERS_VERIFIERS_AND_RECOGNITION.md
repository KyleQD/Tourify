# Trust Registries, Issuers, Verifiers and Recognition

## Purpose

Govern which organizations may issue or verify approved credentials and how recognition, suspension and revocation are published.
...
- `issuer_recognitions`
- `verifier_recognitions`
- `trust_framework_versions`

## Primary workflows

1. Apply for recognition.
2. Complete diligence and conformance.
3. Publish trust metadata.
4. Suspend, revoke or appeal.
...
- Recognition is scoped and time-bound.
- Registry does not validate underlying rights automatically.
- Independent review for high-impact issuers.
- Public status with private evidence.
