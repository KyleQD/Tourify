# Service Discovery, Routing and Network Interoperability

## Purpose

Allow participants to discover approved services across organizations without transferring authority or confidential data.
...
1. Register service.
2. Verify organization and scope.
3. Resolve endpoint and policy.
4. Fail over or withdraw service.
...
- Directory listing is not endorsement.
- No hidden routing preference for Tourify.
- Health and jurisdiction metadata.
