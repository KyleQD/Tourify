...
Define shared terminology, bounded states and authoritative systems to prevent architecture drift.
...
- No ambiguous verified status.
- No silent overwrite.
- External authority distinguished from Tourify mirror.
- Expired and disputed states explicit.
