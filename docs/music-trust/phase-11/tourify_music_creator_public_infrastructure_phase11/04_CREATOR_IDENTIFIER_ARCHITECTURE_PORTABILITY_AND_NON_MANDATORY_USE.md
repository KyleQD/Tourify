# Creator Identifier Architecture, Portability and Non-Mandatory Use

## Purpose

Design optional identifiers that resolve to minimal metadata and can be controlled or replaced without creating ownership or authority.
...
- `creator_identifier_records`
- `identifier_aliases`
- `identifier_controllers`
- `identifier_rotation_events`

## Primary workflows

1. Create or link an identifier.
2. Prove control.
3. Publish minimal service metadata.
4. Rotate, deactivate or migrate provider.
...
- No single required identifier.
- No reuse of auth user IDs as public IDs.
- Pairwise or selective identifiers where appropriate.
- No PII in public identifier documents.
