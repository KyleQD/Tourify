# Public Procurement, Vendor Ecosystem and Interoperability

## Purpose

Support multiple interoperable providers through open procurement, transparent requirements and exit-ready contracts.
...
2. Evaluate transparent criteria.
3. Run interoperability tests.
4. Award, monitor and transition.
...
- No vendor-specific requirements without justification.
- Data and key portability.
- Termination assistance.
- Conflict and beneficial-owner disclosure.
