# Cross-Border Data, Jurisdiction, Localization and Onward Transfer

## Purpose

Gate every international data flow by authority, minimization, transfer mechanism, localization and onward-transfer requirements.
...
1. Identify source and destination roles.
2. Run transfer assessment.
3. Apply jurisdiction policy.
4. Monitor legal change and suspend if needed.
