...
Describe creator, member-organization, verifier, service-provider, regulator, researcher and public observer journeys without forcing participation.
...
- `public_infrastructure_participants`
- `participant_enrollments`
- `participant_exit_requests`

## Primary workflows

1. Creator opts into an identifier or credential.
2. Organization publishes an approved service endpoint.
3. Verifier resolves a minimal rights reference.
4. Participant exports records and exits.
...
- Separate Tourify account from infrastructure participation.
- Accessible consent and withdrawal.
- No penalty for using another provider.
- No public disclosure of private status.
