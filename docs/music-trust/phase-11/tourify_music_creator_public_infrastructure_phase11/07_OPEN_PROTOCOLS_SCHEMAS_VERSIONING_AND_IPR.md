# Open Protocols, Schemas, Versioning and IPR

## Purpose

Define stable open profiles for identifiers, credentials, rights references, service directories and event exchange with transparent change control.
...
4. Conformance implementation and version release.
...
- Published licensing and patent policy.
- Deprecation windows.
- Machine-readable version negotiation.
