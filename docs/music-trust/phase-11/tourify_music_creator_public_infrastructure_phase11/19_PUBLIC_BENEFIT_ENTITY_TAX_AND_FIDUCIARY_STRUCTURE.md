# Public-Benefit Entity, Tax and Fiduciary Structure

## Purpose

Evaluate nonprofit, public-benefit, foundation, consortium and hybrid structures for infrastructure ownership and stewardship.
...
1. Compare entity forms.
2. Review charitable or public-benefit purpose.
3. Approve asset lock and dissolution destination.
4. Document service-provider contracts.
...
- No entity selection by software.
- Separate legal and tax opinions.
- Assets cannot silently revert to Tourify.
- Public-purpose restrictions survive transition.
