...
Define evidence required before any Phase 11 capability is considered complete.
...
- No completion from mocked UI.
- No unresolved authority assumption.
- All regressions green or documented pre-existing.
- Rollback proven.
