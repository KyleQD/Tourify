# Production Operating Model, Staffing and Service Levels

## Purpose

Define the teams, qualifications, approvals, on-call coverage and service levels required for a durable public service.
...
2. Define RACI and escalation.
3. Train and certify operators.
4. Measure and publish service performance.
