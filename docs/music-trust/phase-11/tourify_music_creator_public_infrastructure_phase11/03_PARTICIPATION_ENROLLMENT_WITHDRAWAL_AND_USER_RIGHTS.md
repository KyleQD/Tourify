# Participation, Enrollment, Withdrawal and User Rights

## Purpose

Create explicit, reversible participation that does not affect catalog access, ownership, certification, licensing or platform eligibility.
...
1. Review participation notice.
2. Select identifier and disclosure preferences.
3. Confirm recovery method.
4. Withdraw and export.
...
- No bundled consent.
- No dark patterns.
- Withdrawal propagates prospectively.
- Legal records remain preserved when required.
