# Public-Interest Entity, Governance and Fiduciary Boundary

## Purpose

Separate Tourify from the infrastructure steward, operator, standards program, registry functions and public-interest fiduciary obligations.
...
- `public_infrastructure_entities`
- `entity_charters`
- `fiduciary_decisions`
...
1. Select entity options with counsel.
2. Approve charter and reserved powers.
3. Appoint independent directors and committees.
4. Document Tourify service agreement.
