# Accessibility, Inclusion, Offline and Low-Bandwidth Access

## Purpose

Ensure public infrastructure can be used by creators with disabilities, limited connectivity, limited documentation or limited technical literacy.
...
1. Choose accessible channel.
2. Use assisted enrollment with safeguards.
3. Issue portable proof.
4. Request correction or appeal offline.
...
- Multilingual and plain-language notices.
- No weaker privacy for assisted users.
