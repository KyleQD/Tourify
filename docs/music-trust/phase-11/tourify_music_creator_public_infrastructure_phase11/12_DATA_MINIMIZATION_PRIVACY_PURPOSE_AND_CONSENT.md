# Data Minimization, Privacy, Purpose and Consent

## Purpose

Limit infrastructure data to what is required for each public-interest function and prevent function creep.
...
1. Define purpose.
2. Map minimum fields.
3. Obtain authority or consent.
4. Review retention and downstream recipients.
...
- No public PII by default.
- No model training without separate consent.
- Opt-out and correction propagation.
