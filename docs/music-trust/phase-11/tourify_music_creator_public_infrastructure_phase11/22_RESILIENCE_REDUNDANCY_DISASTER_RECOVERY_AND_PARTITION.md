...
Keep verification and essential resolution functions available during operator, region, provider or federation failures.
...
1. Define service tier.
2. Deploy independent replicas.
3. Test recovery and read-only modes.
4. Reconcile after partition.
...
- No single-cloud dependency for critical public functions.
- Signed cached status with expiry.
