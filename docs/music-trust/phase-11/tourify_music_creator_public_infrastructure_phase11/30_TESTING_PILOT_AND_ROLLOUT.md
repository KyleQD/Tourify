...
Use a bilateral, sandbox-first rollout that proves portability, revocation, public access and independent operation before production.
...
2. Test two independent implementations.
3. Exercise withdrawal and provider migration.
4. Approve limited production or stop.
...
- No production universal ID.
- Independent security and accessibility testing.
- Rollback within documented objectives.
