# Regulator, Standards, Public Institution and Civil Society Engagement

## Purpose

Coordinate external engagement without claiming government endorsement or allowing policy advocacy to override member governance.
...
1. Approve engagement purpose.
2. Review authority and conflicts.
3. Submit transparent contribution.
4. Track response and implementation impact.
...
- Public positions versioned.
- Lobbying and procurement boundaries.
- Civil-society participation funded where possible.
