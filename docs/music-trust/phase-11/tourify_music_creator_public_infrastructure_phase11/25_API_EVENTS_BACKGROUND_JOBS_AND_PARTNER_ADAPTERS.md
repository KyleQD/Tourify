...
Define route-handler, event-outbox and worker patterns for identifiers, credentials, resolution, registry updates and conformance.
...
- `app/api/creator-public-infrastructure/**`
- `public_infrastructure_outbox`
- `idempotency_keys`
...
3. Write source and outbox transactionally.
4. Deliver, retry and reconcile.
