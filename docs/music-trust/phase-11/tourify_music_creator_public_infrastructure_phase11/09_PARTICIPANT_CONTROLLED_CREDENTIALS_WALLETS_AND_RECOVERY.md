# Participant-Controlled Credentials, Wallets and Recovery

## Purpose

Support portable credentials and recovery without forcing a custodial Tourify wallet or allowing recovery administrators to seize identity.
...
1. Issue credential.
2. Store with chosen wallet.
3. Present minimum claims.
4. Recover or rotate control.
...
- Wallet neutrality.
- No seed phrases stored by Tourify.
- High-assurance recovery with cooling-off.
- Status and source-record checks.
