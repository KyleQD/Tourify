# Anti-Capture, Vendor Neutrality, Portability and Exit

## Purpose

Prevent platform, government, funder, incumbent, vendor or large-rightsholder capture of infrastructure governance and technical dependencies.
...
1. Measure control concentration.
2. Review critical supplier dependency.
3. Run provider migration drill.
4. Trigger emergency stewardship transition.
...
- No single-party veto over ordinary operations.
- Open data export.
- Escrow or reproducible builds for critical code.
- Independent anti-capture committee.
