...
Add optional public-infrastructure controls and verification views without disrupting upload, playback or rights workflows.
...
1. Show plain-language participation choices.
2. Create or link identifier.
3. Verify credential or rights reference.
4. Export, suspend or leave.
...
- No coercive upsell.
- Clear distinction between platform and infrastructure.
- No public badge implying ownership.
- Mobile parity where approved.
