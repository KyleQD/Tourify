# Affordability, Equity, Public Access and Benefit Measurement

## Purpose

Ensure core infrastructure access remains affordable and measure whether it benefits creators rather than only institutions.
...
- `access_subsidies`
- `equity_metrics`
- `public_benefit_reports`

## Primary workflows

1. Set transparent fee policy.
2. Provide waivers or subsidies.
3. Measure access and exclusion.
4. Adjust through public governance.
...
- No loss of rights or identity for nonpayment.
- Free verification of essential public facts where feasible.
- No lower security for subsidized users.
- Publish distributional impact.
