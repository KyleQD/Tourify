# Abuse, Fraud, Identity Disputes and Misinformation

## Purpose

Detect impersonation, fraudulent credentials, malicious registrations, registry poisoning and misleading public claims while preserving due process.
...
1. Receive report.
2. Preserve evidence.
3. Apply proportionate interim control.
4. Review, appeal and resolve.
...
- No irreversible action from one automated signal.
- Protected reporting.
- False-report sanctions with due process.
- Public warnings narrowly scoped.
