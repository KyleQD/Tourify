# Privacy, Security, Human Rights and Algorithmic Impact Assessments

## Purpose

Require multidisciplinary assessment before high-impact identity, registry, resolver or automated-risk features ship.
...
1. Scope system and affected groups.
2. Test misuse and exclusion.
3. Mitigate and consult.
4. Approve or stop deployment.
...
- No self-approval by feature owner.
