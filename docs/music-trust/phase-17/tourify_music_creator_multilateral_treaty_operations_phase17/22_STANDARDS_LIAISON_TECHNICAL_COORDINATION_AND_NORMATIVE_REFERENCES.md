# Standards Liaison, Technical Coordination and Normative References

## Purpose

Coordinate with WIPO, ITU, UNESCO, ILO, ISO, IETF, W3C, DDEX, CISAC and other bodies through their actual procedures.
...
1. Approve liaison mandate.
2. Track current specifications.
3. Submit approved input.
4. Reconcile external outcomes.
5. Update profile through change control.

## Required design decisions

- No false claim of standards-body approval.
- Respect each body’s IPR and participation rules.
- Draft standards remain clearly labeled.
