...
Define additive records and default-deny data controls.
...
1. Audit deployed schema.
2. Design additive migration.
3. Implement RLS and grants.
4. Backfill explicitly.
5. Regenerate types and test rollback.

## Required design decisions

- Reference outlines are not production migrations.
- Sensitive evidence uses restricted storage.
- Security advisors and policy tests must pass.
