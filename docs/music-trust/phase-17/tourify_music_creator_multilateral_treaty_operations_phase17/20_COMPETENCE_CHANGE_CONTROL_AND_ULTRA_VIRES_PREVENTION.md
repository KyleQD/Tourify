# Competence Change Control and Ultra Vires Prevention

## Purpose

Create a formal gate for any proposed expansion, contraction or delegation of competence.
...
- `competence_change_proposals`
- `authority_opinions`
- `ratification_requirements`
- `competence_effective_versions`
...
1. Describe proposed competence.
2. Map legal basis.
3. Obtain independent opinion.
4. Complete participant approvals.
5. Activate only for approved scope.

## Required design decisions

- Default deny.
- No implied powers from technical necessity alone.
- Public communications must match effective scope.
