# Review Baseline, Evidence Manifests and Data Quality

## Purpose

Make every review reproducible from immutable evidence and disclosed methodology.
...
1. Freeze baseline date.
2. Create source manifest.
3. Assess completeness and bias.
4. Approve methodology.
5. Publish permitted evidence summary.

## Required design decisions

- Separate official statistics, administrative data, research and stakeholder testimony.
- Disclose uncertainty and missing data.
- Do not expose confidential creator records.
