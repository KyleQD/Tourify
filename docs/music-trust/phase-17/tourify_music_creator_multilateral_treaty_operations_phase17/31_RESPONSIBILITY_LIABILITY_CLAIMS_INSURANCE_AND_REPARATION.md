# Responsibility, Liability, Claims, Insurance and Reparation

## Purpose

Handle institutional and operator-caused harm with attribution, remedy and learning.
...
1. Receive claim.
2. Preserve evidence.
3. Determine forum and attribution.
4. Resolve or refer.
5. Implement remedy and prevention.

## Required design decisions

- No waiver of mandatory rights through platform terms.
- Separate legal responsibility from operational fault.
- Publish aggregate accountability data.
