# Institutional Reform, Organs, Mandates and Structural Change

## Purpose

Manage reform proposals through the correct legal and political process.
...
- `institutional_reform_proposals`
- `organ_change_plans`
- `mandate_reviews`
...
1. Diagnose problem.
2. Classify structural impact.
3. Consult participants and creators.
4. Obtain amendment or governing-body approval.
5. Implement and independently evaluate.

## Required design decisions

- Administrative reorganization cannot expand competence.
- Protect staff, records, remedies and continuity.
- Publish transition costs and conflicts.
