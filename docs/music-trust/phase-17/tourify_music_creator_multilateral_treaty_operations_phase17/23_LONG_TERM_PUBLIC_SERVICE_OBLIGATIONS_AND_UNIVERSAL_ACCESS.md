# Long-Term Public-Service Obligations and Universal Access

## Purpose

Define continuity, affordability and nondiscrimination obligations for mature services.
...
1. Enumerate essential service.
2. Define eligible users and minimum level.
3. Fund and monitor delivery.
4. Handle outage or exclusion.
5. Remediate and report.

## Required design decisions

- Nonpayment cannot erase rights history.
- Essential verification and correction remain accessible.
- Avoid compulsory identity or provider lock-in.
