# Admin Treaty Operations, Queues and Approvals

## Purpose

Provide operational queues with separation of duties and evidence requirements.
...
1. Create case.
2. Route by type and jurisdiction.
3. Review evidence.
...
- No super-admin bypass of legal authority.
- High-impact actions require dual control.
- Operational permissions are narrower than database service role.
