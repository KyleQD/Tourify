# Testing, Multi-Year Pilot, Periodic Review and Rollout

## Purpose

Prove the full legal, governance, operational and technical story before activation.
...
1. Run sandbox.
2. Operate multi-year limited pilot.
3. Conduct independent review conference.
4. Remediate findings.
5. Approve, narrow, extend, pause or terminate.

## Required design decisions

- No accelerated simulated years.
- At least two independent implementations and operators.
- Tourify-unavailable and succession drills must pass.
