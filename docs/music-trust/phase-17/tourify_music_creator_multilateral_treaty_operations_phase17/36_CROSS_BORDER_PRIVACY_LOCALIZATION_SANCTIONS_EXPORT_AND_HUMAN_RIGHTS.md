# Cross-Border Privacy, Localization, Sanctions, Export and Human Rights

## Purpose

Apply jurisdiction-specific safeguards to all treaty operations and assistance.
...
1. Define purpose and authority.
2. Minimize data.
3. Assess transfer and local law.
4. Approve or block.
5. Monitor onward transfer and remedy.

## Required design decisions

- No one-size-fits-all global transfer basis.
- Human-rights risk can stop a program.
- Public records remain minimized.
