...
Implement versioned, idempotent and reconcilable service interfaces.
...
1. Define schema.
2. Authorize request.
3. Persist proposal and outbox.
4. Execute and reconcile.
5. Publish safe projection.

## Required design decisions

- Signed webhooks where applicable.
- Replay protection and dead-letter queues.
- No direct public access to confidential tables.
