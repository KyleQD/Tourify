# Security, Keys, Trust Anchors and Supply Chain

## Purpose

Protect public-law systems with independent, replaceable security controls.
...
3. Operate hardware-backed keys and dual control.
4. Monitor and rotate.
5. Respond and recover.

## Required design decisions

- No single Tourify root.
- Critical changes require multi-party approval.
- Publish compromise and recovery status where safe.
