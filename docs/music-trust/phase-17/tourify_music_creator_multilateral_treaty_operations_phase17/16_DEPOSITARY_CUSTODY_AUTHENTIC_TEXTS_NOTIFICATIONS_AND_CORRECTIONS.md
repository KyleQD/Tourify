# Depositary Custody, Authentic Texts, Notifications and Corrections

## Purpose

Support authorized custody and notification functions with strict legal-character labels.
...
- `instruments_in_custody`
- `authentic_text_versions`
- `depositary_notifications`
- `correction_processes`
- `certified_copy_records`
...
2. Authenticate and checksum.
3. Validate authority.
4. Issue signed notification.
5. Correct through formal versioned process.

## Required design decisions

- Private custody is not a governmental or UN depositary function.
- No silent correction of authentic texts.
- Critical custody requires multi-party control and independent restore.
