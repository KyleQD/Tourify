# External Registration, Publication and Article 102 Reconciliation

## Purpose

Track external registration and publication without impersonating the external authority.
...
1. Prepare approved submission.
2. Send through authorized channel.
3. Record receipt.
4. Reconcile external status.
5. Publish accurate current projection.

## Required design decisions

- Tourify cannot issue a UN registration number.
- Entry into force and external registration remain separate.
- External authority controls its official record.
