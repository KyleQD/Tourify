# Compliance, Peer Review and Corrective Action

## Purpose

Use transparent criteria and proportionate due-process remedies.
...
1. Open review.
2. Receive response.
3. Conduct peer and independent review.
4. Adopt findings.
5. Monitor correction, close, suspend or reinstate.

## Required design decisions

- No retaliation against creators or nonparticipants.
- Separate technical nonconformance from legal noncompliance.
- Provide notice, response, appeal and reinstatement.
