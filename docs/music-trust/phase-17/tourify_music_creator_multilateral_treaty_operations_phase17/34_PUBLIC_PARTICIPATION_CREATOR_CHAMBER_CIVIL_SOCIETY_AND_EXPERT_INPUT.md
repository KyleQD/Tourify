# Public Participation, Creator Chamber and Civil-Society Input

## Purpose

Make periodic review meaningfully participatory without conflating consultation and membership.
...
- `consultations`
- `creator_chamber_submissions`
- `civil_society_inputs`
- `expert_hearings`
- `response_matrices`
...
1. Publish accessible call.
2. Receive and classify input.
3. Disclose conflicts.
4. Respond in a matrix.
5. Show how input affected outcome.

## Required design decisions

- Participation is voluntary and non-retaliatory.
- Resource less powerful participants.
- Do not disclose confidential commercial positions.
