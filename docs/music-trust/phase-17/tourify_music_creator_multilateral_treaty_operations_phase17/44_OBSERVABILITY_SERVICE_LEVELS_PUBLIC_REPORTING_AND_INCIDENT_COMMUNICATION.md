# Observability, Service Levels and Public Reporting

## Purpose

Measure reliability, integrity, timeliness and public-service outcomes.
...
1. Define SLO and owner.
2. Instrument systems.
3. Alert and respond.
4. Publish permitted status.
5. Review trends and improve.

## Required design decisions

- Accuracy and integrity outrank uptime.
- Stale or disputed public data is visibly labeled.
- Material incidents receive timely correction.
