# Legal Character, Competence and Non-Expansion Boundary

## Purpose

Prevent periodic operations from silently creating new institutional powers.
...
- `competence_schedules`
- `legal_character_versions`
- `ultra_vires_reviews`
- `competence_change_cases`
...
1. Resolve current constitutive competence.
2. Classify proposed action.
3. Check amendment or protocol authority.
4. Block ultra vires action.
5. Publish permitted legal-character projection.

## Required design decisions

- Implementation practice does not amend the constitutive instrument.
- Soft-law guidance cannot create binding powers.
- Ambiguity defaults to no authority.
