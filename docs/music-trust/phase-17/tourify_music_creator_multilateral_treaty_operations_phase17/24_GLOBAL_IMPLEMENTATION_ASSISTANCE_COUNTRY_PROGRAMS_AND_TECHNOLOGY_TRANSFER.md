# Global Implementation Assistance and Country Programs

## Purpose

Deliver demand-led assistance without imposing one vendor or governance model.
...
- `country_programs`
- `needs_assessments`
- `implementation_compacts`
- `technology_transfer_plans`
...
2. Assess local law and capacity.
3. Co-design program.
4. Procure neutrally.
5. Evaluate and transfer capability.

## Required design decisions

- Respect national and local priorities.
- No aid conditionality tied to Tourify adoption.
- Open standards and local ownership are preferred.
