# Competition, Market Neutrality and No Collective Authority

## Purpose

Prevent technical cooperation from becoming coordinated commercial conduct.
...
- `competition_reviews`
- `sensitive_topic_alerts`
- `market_neutrality_findings`
- `collective_action_blockers`
...
1. Classify activity.
2. Screen data and communications.
3. Obtain counsel review.
4. Limit or block.
5. Monitor and investigate.

## Required design decisions

- No coordinated rates, bids, refusals, blacklists or allocation.
- No enforcement retaliation against nonparticipants.
- Historical aggregate reporting remains governed.
