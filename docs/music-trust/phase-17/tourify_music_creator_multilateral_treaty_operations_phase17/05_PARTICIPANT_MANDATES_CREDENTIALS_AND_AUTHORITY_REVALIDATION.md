# Participant Mandates, Credentials and Authority Revalidation

## Purpose

Continuously revalidate the authority of participants and delegates.
...
1. Register authority source.
2. Issue scoped credential.
3. Verify before each action.
4. Revalidate periodically.
5. Suspend or revoke on change.

## Required design decisions

- Credentials evidence authority but do not create it.
- Delegation cannot exceed the principal authority.
- Observer and advisory roles never convert automatically to membership.
