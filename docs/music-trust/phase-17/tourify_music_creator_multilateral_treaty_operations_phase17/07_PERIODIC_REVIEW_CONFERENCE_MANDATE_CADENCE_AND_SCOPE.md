# Periodic Review Conference Mandate, Cadence and Scope

## Purpose

Create a lawful, time-bounded periodic-review cycle.
...
1. Trigger review under instrument.
2. Approve mandate and questions.
3. Publish scope and timetable.
4. Collect evidence and consultations.
5. Adopt outcome and follow-up schedule.

## Required design decisions

- Review does not itself reinterpret settled obligations unless the instrument allows.
- Review cadence and scope are versioned.
- Late or incomplete review triggers escalation, not silent extension.
