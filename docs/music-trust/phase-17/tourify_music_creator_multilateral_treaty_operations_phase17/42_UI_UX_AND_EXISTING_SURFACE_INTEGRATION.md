...
Add Phase 17 surfaces without degrading existing music or prior-phase experiences.
...
- `review_dashboard_views`
- `participant_status_views`
- `public_review_portal_views`
- `admin_queue_views`
...
2. Add navigation behind flags.
3. Build role-specific views.
4. Add disclosures and remedies.
5. Run accessibility and regression tests.

## Required design decisions

- Do not replace Jukebox or music surfaces.
- Show legal character and source freshness prominently.
- Default deny unavailable actions.
