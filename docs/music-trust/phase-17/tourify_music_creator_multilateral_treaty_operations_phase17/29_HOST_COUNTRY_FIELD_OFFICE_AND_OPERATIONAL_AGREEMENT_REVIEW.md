# Host-Country, Field-Office and Operational Agreement Review

## Purpose

Maintain current host and country arrangements as institutional operations evolve.
...
- `host_agreements`
- `field_office_agreements`
- `country_privilege_schedules`
- `agreement_reviews`
...
2. Check effective scope.
3. Assess operational change.
4. Renegotiate where required.
5. Publish permitted status.

## Required design decisions

- No global host status.
- Each jurisdiction is separately effective.
