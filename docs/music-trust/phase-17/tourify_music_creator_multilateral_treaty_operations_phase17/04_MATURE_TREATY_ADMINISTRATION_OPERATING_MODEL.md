# Mature Treaty Administration Operating Model

## Purpose

Define lawful day-to-day administration of effective instruments, protocols and annexes.
...
- `treaty_administration_cycles`
- `obligation_calendars`
- `instrument_status_versions`
...
1. Load effective instruments.
2. Generate obligation calendar.
3. Receive instruments and reports.
4. Reconcile status.
5. Publish approved notifications and dashboards.

## Required design decisions

- Separate depositary, secretariat and governing-body functions.
- Keep authoritative external status distinguishable from Tourify mirrors.
- Require dual control for critical status changes.
