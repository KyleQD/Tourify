# Information Access, Public Archives and Transparency

## Purpose

Preserve institutional memory and enable accountable public access.
...
1. Receive request.
2. Classify and search records.
3. Apply lawful exemptions.
4. Release or deny with reasons.
5. Appeal and preserve archive.

## Required design decisions

- Public interest favors disclosure but privacy and protected evidence remain restricted.
- No silent deletion.
- Authentic records and correction histories are preserved.
