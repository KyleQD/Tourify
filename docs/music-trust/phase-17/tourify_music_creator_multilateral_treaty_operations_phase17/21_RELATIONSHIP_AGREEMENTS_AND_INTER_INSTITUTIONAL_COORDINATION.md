# Relationship Agreements and Inter-Institutional Coordination

## Purpose

Operate additional agreements with existing international, regional and standards organizations.
...
1. Verify each party authority.
2. Negotiate exact scope.
3. Approve agreement.
4. Operate joint work plan.
5. Review, amend, suspend or terminate.

## Required design decisions

- No endorsement, agency, representation or data-sharing by implication.
- Conflicts and branding rights are explicit.
- Each agreement has exit and data disposition rules.
