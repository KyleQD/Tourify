# Independent Expert Review and Evaluation

## Purpose

Provide independent technical, legal, social and normative evaluation.
...
1. Appoint independent experts.
2. Disclose conflicts and funding.
3. Approve evaluation questions.
4. Conduct reproducible analysis.
5. Publish findings and management response.

## Required design decisions

- Experts advise; they do not replace participant decision-making.
- Evaluation independence includes publication protection.
- Minority or dissenting expert views are preserved.
