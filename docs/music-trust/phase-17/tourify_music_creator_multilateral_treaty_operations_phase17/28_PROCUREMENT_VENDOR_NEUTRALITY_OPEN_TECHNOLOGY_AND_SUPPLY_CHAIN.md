# Procurement, Vendor Neutrality and Open Technology

## Purpose

Prevent Tourify or another supplier from capturing essential public infrastructure.
...
- `technology_transfer_obligations`
- `exit_plans`
...
2. Conduct fair competition.
3. Evaluate security and interoperability.
4. Award and monitor.
5. Exercise exit and transfer.

## Required design decisions

- No proprietary lock-in for essential protocols.
- Require export and escrow where critical.
- Conflicts and beneficial ownership are reviewed.
