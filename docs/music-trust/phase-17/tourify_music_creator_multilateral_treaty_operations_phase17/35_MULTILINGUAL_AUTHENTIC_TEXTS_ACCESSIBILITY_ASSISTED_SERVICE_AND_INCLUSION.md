# Multilingual Authentic Texts, Accessibility and Inclusion

## Purpose

Ensure equal access to instruments, reviews and remedies.
...
1. Select authentic and working languages.
2. Translate and validate.
3. Publish accessible formats.
4. Provide assisted participation.
5. Correct errors and preserve versions.

## Required design decisions

- Machine translation is not automatically authentic.
- WCAG-aligned interfaces and low-bandwidth options.
- No disadvantage from language or disability.
