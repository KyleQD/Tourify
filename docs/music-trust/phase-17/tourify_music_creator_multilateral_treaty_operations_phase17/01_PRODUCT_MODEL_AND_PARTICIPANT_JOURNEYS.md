...
Define participant journeys without implying membership, representation or public authority.
...
- `treaty_operation_workspaces`
- `participant_service_requests`
- `review_participation_records`
...
1. Participant verifies role and authority.
2. Selects an exact service or review process.
3. Receives legal-character and scope disclosures.
4. Submits evidence.
5. Tracks decisions, remedies and exit.

## Required design decisions

- Separate state, IO, creator-body, observer, expert and public roles.
- Make status and authority visible on every screen.
- Provide accessible withdrawal, correction and appeal.
