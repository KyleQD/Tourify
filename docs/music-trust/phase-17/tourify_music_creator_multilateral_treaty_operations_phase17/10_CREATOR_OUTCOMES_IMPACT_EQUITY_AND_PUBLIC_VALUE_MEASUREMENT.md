# Creator Outcomes, Impact, Equity and Public-Value Measurement

## Purpose

Measure whether services improve creator outcomes rather than only institutional activity.
...
1. Define theory of change.
2. Approve indicators and disaggregation.
3. Collect consented evidence.
4. Evaluate outcomes and harms.
5. Adopt corrective actions.

## Required design decisions

- Measure portability, correction, remedy, accessibility and independence.
- Avoid vanity metrics and adoption-only success claims.
- Do not punish nonparticipants or low-volume creators.
