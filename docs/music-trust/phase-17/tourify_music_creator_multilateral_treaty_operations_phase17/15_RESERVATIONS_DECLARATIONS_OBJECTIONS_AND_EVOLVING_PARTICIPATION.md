# Reservations, Declarations, Objections and Evolving Participation

## Purpose

Maintain the effect and history of participant positions as instruments evolve.
...
- `declarations`
- `objections`
- `withdrawals_of_reservations`
- `effect_determinations`
...
1. Receive signed instrument.
2. Validate authority and form.
3. Notify participants.
4. Record objections and effect analysis.
5. Publish current status with history.

## Required design decisions

- Software does not decide international legal effect conclusively.
- Preserve authentic text and translations.
- A later withdrawal does not erase prior effect periods.
