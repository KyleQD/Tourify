# Protocol Amendment, Consolidation, Supersession and Migration

## Purpose

Manage orderly protocol evolution without rewriting history.
...
1. Classify change.
2. Run impact and compatibility review.
3. Obtain required adoption and consent.
4. Publish migration plan.
5. Operate coexistence and retire version.

## Required design decisions

- Technical changes cannot bypass legal amendment requirements.
- Historical records retain original semantics.
- Breaking changes require export and rollback.
