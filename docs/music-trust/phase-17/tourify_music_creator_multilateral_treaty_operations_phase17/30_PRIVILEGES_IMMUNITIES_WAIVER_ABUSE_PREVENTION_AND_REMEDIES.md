# Privileges, Immunities, Waiver and Remedies

## Purpose

Ensure any applicable protection is functionally necessary, scoped and paired with remedy.
...
1. Verify legal instrument.
2. Resolve beneficiary and function.
3. Assess waiver or remedy.
4. Issue reasoned decision.
5. Audit and report.

## Required design decisions

- No privilege by job title alone.
- Immunity is not impunity.
- Never claim protection outside effective jurisdiction and scope.
