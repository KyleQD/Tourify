# Capacity-Building Fund, Replenishment and Grants

## Purpose

Govern multi-year funding for equitable participation and implementation.
...
1. Approve replenishment case.
2. Receive commitments.
3. Run transparent grant cycle.
4. Disburse with controls.
5. Evaluate and publish results.

## Required design decisions

- Donors cannot purchase votes or standards outcomes.
- Conflicts and concentration are disclosed.
- Grants do not create representation mandates.
