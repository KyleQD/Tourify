...
Provide a release-by-release verification checklist.
...
1. Verify canonical music paths.
2. Verify source-of-truth references.
3. Verify additive schema and RLS.
4. Run prior-phase regressions.
...
- No authority inferred from old records.
...
- [ ] Canonical upload and playback paths unchanged.
- [ ] No Phase 16 flag activates Phase 17.
- [ ] No source rights, licence, royalty or administration record mutated.
- [ ] All migrations additive and reversible.
- [ ] RLS and API default deny.
- [ ] Public projections contain only approved fields.
- [ ] Review conference cannot expand competence.
- [ ] All external writes idempotent and reconciled.
- [ ] Full prior-phase regression suite green.
- [ ] Monitoring, owner and rollback recorded.
