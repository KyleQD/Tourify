# Budget, Audit, Evaluation, Reserves and Value for Money

## Purpose

Link resources to approved mandates and independently evaluated outcomes.
...
1. Prepare results-based budget.
2. Approve appropriation.
3. Execute with controls.
4. Audit and evaluate.
5. Adopt management response and follow-up.

## Required design decisions

- No off-budget mandate expansion.
- Publish material variances.
- Maintain reserves for continuity and orderly wind-down.
