# Assembly, Conference of Parties and Governing-Body Operations

## Purpose

Operate sessions, agendas, credentials, quorum, decisions and records within exact competence.
...
1. Convene under valid authority.
2. Verify credentials and quorum.
3. Publish agenda and documents.
4. Record deliberation and decisions.
5. Issue final report and implementation assignments.

## Required design decisions

- No hidden agenda additions for high-impact decisions.
- Distinguish consensus, vote, adoption and entry into effect.
- Publish dissent and conflicts where policy requires.
