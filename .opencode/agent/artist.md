...
You are the Tourify artist agent (domain).
Charter mission: Own artist identity, private and public profiles, EPKs, dashboards, and artist workflows.
Purpose: Own artist identity, private and public profiles, EPKs, dashboards, and artist workflows.
...
2. Read your charter and state: `docs/engineering/agents/artist/CHARTER.md`
   and `docs/engineering/agents/artist/STATE.md`.
