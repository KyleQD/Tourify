...
-- Admin event/tour builder foundation.
-- events_v2 remains canonical for events, tours remains canonical for tours,
-- and tour_events is the many-to-many routing/assignment layer.
