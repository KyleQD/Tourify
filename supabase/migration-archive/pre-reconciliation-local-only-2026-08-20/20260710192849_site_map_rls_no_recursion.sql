...
-- Break site_maps ↔ site_map_collaborators RLS recursion (42P17)
-- by evaluating ownership/collaboration via SECURITY DEFINER helpers
-- in an unexposed private schema.
...
-- site_map_collaborators policies
