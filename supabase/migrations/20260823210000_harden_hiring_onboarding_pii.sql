-- Re-issue of quarantined migration 20260718070001_harden_hiring_onboarding_templates_and_pii
-- (supabase/migration-archive/pre-reconciliation-local-only-2026-08-20/).
--
-- The original file was quarantined solely for a duplicate-version collision with
-- 20260718070000_creator_public_entities (see docs/audit-remediation/2026-07-27/
-- migration-reconciliation-decisions.json), not for content defects. This copy is
-- byte-identical apart from this header, under a fresh unique timestamp so the
-- hiring/hiring-PII hardening can enter the active chain through the normal gated
-- pipeline. AUDIT H11.
--
