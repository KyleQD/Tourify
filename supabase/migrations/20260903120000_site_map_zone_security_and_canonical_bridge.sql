...
begin
  select count(distinct constraint_row.confrelid), min(constraint_row.confrelid::text)::regclass
  ...
  if v_fk_count = 1 and v_fk_target = 'public.events'::regclass then
  ...
  elsif v_fk_count = 1 and v_fk_target = 'public.events_v2'::regclass then
    update public.site_maps
