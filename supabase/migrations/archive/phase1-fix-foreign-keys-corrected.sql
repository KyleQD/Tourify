-- =============================================================================
-- PHASE 1: FIX MISSING FOREIGN KEY CONSTRAINTS (CORRECTED)
-- =============================================================================
-- 
-- This script addresses the 88 missing foreign key constraints identified
-- in the Phase 1 audit. It first checks which tables exist before proceeding.
--
-- EXECUTION ORDER:
...
SELECT 
  ...
  rowsecurity,
  CASE 
    WHEN "hasprimarykey" = false THEN '🚨 Missing Primary Key'
    ELSE '✅ Has Primary Key'
  END as pk_status,
  CASE 
    WHEN rowsecurity = false THEN '🚨 Missing RLS'
    ELSE '✅ RLS Enabled'
  END as rls_status
FROM pg_tables 
...
-- =============================================================================
--
-- 1. THIS CORRECTED SCRIPT CHECKS WHICH TABLES EXIST BEFORE PROCEEDING
-- 2. IT AVOIDS ERRORS ON NON-EXISTENT TABLES
-- 3. IT PROVIDES CLEAR FEEDBACK ON WHAT WAS SKIPPED VS. WHAT WAS FIXED
