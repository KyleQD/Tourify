-- =============================================================================
-- AGGRESSIVE MESSAGING SCHEMA FIX
-- =============================================================================
-- This will force-fix the messaging schema issues
...
-- Force schema refresh by updating pg_stat_statements (if available)
-- This helps refresh the schema cache
SELECT 'Schema fix completed and cache refreshed!' as status;
