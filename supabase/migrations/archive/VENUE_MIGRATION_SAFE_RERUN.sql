-- =============================================================================
-- VENUE MANAGEMENT SYSTEM - SAFE MIGRATION (CAN BE RUN MULTIPLE TIMES)
...
-- =============================================================================
-- ROW LEVEL SECURITY (RLS) - SAFE POLICY CREATION
-- =============================================================================
...
BEGIN
  ...
  IF NOT EXISTS (SELECT 1 FROM pg_policies WHERE tablename = 'venue_booking_requests' AND policyname = 'Venue owners can manage all booking requests for their venues') THEN
  ...
  IF NOT EXISTS (SELECT 1 FROM pg_policies WHERE tablename = 'venue_booking_requests' AND policyname = 'Users can view and manage their own booking requests') THEN
  ...
  -- Documents Policies
  IF NOT EXISTS (SELECT 1 FROM pg_policies WHERE tablename = 'venue_documents' AND policyname = 'Venue owners can manage their venue documents') THEN
  ...
  IF NOT EXISTS (SELECT 1 FROM pg_policies WHERE tablename = 'venue_documents' AND policyname = 'Public documents are viewable by everyone') THEN
  ...
  IF NOT EXISTS (SELECT 1 FROM pg_policies WHERE tablename = 'venue_team_members' AND policyname = 'Venue owners can manage their team members') THEN
  ...
  IF NOT EXISTS (SELECT 1 FROM pg_policies WHERE tablename = 'venue_team_members' AND policyname = 'Team members can view their own profile') THEN
  ...
  -- Equipment Policies
  IF NOT EXISTS (SELECT 1 FROM pg_policies WHERE tablename = 'venue_equipment' AND policyname = 'Venue owners can manage their equipment') THEN
  ...
  IF NOT EXISTS (SELECT 1 FROM pg_policies WHERE tablename = 'venue_equipment' AND policyname = 'Anyone can view available rental equipment') THEN
  ...
  -- Reviews Policies
  IF NOT EXISTS (SELECT 1 FROM pg_policies WHERE tablename = 'venue_reviews' AND policyname = 'Anyone can view venue reviews') THEN
    CREATE POLICY "Anyone can view venue reviews"
      ON venue_reviews FOR SELECT
      USING (true);
  END IF;

  IF NOT EXISTS (SELECT 1 FROM pg_policies WHERE tablename = 'venue_reviews' AND policyname = 'Users can create reviews') THEN
    CREATE POLICY "Users can create reviews"
      ON venue_reviews FOR INSERT
      WITH CHECK (reviewer_id = auth.uid());
  END IF;

  IF NOT EXISTS (SELECT 1 FROM pg_policies WHERE tablename = 'venue_reviews' AND policyname = 'Reviewers can update their own reviews') THEN
    CREATE POLICY "Reviewers can update their own reviews"
      ON venue_reviews FOR UPDATE
      USING (reviewer_id = auth.uid());
  END IF;

  IF NOT EXISTS (SELECT 1 FROM pg_policies WHERE tablename = 'venue_reviews' AND policyname = 'Venue owners can respond to reviews') THEN
  ...
  -- Analytics Policies
  IF NOT EXISTS (SELECT 1 FROM pg_policies WHERE tablename = 'venue_analytics' AND policyname = 'Venue owners can view their analytics') THEN
  ...
  IF NOT EXISTS (SELECT 1 FROM pg_policies WHERE tablename = 'venue_availability' AND policyname = 'Venue owners can manage their availability') THEN
  ...
  IF NOT EXISTS (SELECT 1 FROM pg_policies WHERE tablename = 'venue_availability' AND policyname = 'Anyone can view venue availability') THEN
  ...
  -- Pricing Policies
  IF NOT EXISTS (SELECT 1 FROM pg_policies WHERE tablename = 'venue_pricing' AND policyname = 'Venue owners can manage their pricing') THEN
  ...
  IF NOT EXISTS (SELECT 1 FROM pg_policies WHERE tablename = 'venue_pricing' AND policyname = 'Anyone can view active pricing packages') THEN
  ...
  IF NOT EXISTS (SELECT 1 FROM pg_policies WHERE tablename = 'venue_social_integrations' AND policyname = 'Venue owners can manage their social integrations') THEN
  ...
  RAISE NOTICE 'All RLS policies created successfully (or already existed)';
END $$;

-- =============================================================================
-- FUNCTIONS FOR VENUE MANAGEMENT (SAFE TO RUN MULTIPLE TIMES)
-- =============================================================================
...
-- =============================================================================
-- SAMPLE DATA FOR TESTING (SAFE TO RUN MULTIPLE TIMES)
-- =============================================================================

-- Insert sample booking requests (only if venue_profiles exist and data doesn't exist)
DO $$
BEGIN
  IF EXISTS (SELECT 1 FROM venue_profiles LIMIT 1) AND NOT EXISTS (SELECT 1 FROM venue_booking_requests LIMIT 1) THEN
...
-- Insert sample documents (only if they don't exist)
DO $$
BEGIN
  IF EXISTS (SELECT 1 FROM venue_profiles LIMIT 1) AND NOT EXISTS (SELECT 1 FROM venue_documents LIMIT 1) THEN
...
-- Insert sample team members (only if they don't exist)
DO $$
BEGIN
  IF EXISTS (SELECT 1 FROM venue_profiles LIMIT 1) AND NOT EXISTS (SELECT 1 FROM venue_team_members LIMIT 1) THEN
...
BEGIN
  ...
  RAISE NOTICE '📊 Tables, indexes, and policies safely created or verified';
  ...
  RAISE NOTICE '💡 You can run this script multiple times safely.';
END $$; 