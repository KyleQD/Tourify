-- Complete fix for notifications system
-- This addresses schema mismatches and check constraints
...
DO $$ 
BEGIN
    -- Try to drop the constraint (it might not exist)
    BEGIN
...
-- Create comprehensive check constraint for notification types
...
-- Create comprehensive check constraint for priority
