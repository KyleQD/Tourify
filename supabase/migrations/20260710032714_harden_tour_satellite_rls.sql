...
-- Harden tour satellite tables that still use broad authenticated ALL policies.
-- Pattern mirrors tour_events: tour owner/team access OR org membership / event.manage.
...
create policy tour_artists_select
on public.tour_artists
for select
to authenticated
using (
...
create policy tour_artists_insert
on public.tour_artists
for insert
to authenticated
with check (
...
create policy tour_artists_update
on public.tour_artists
for update
to authenticated
using (
...
create policy tour_artists_delete
on public.tour_artists
for delete
to authenticated
using (
...
create policy tour_vendors_select
on public.tour_vendors
for select
to authenticated
using (
  public.can_access_tour(tour_id)
...
create policy tour_vendors_insert
on public.tour_vendors
for insert
to authenticated
with check (
...
create policy tour_vendors_update
on public.tour_vendors
for update
to authenticated
using (
...
create policy tour_vendors_delete
on public.tour_vendors
for delete
to authenticated
using (
...
create policy tour_teams_select
on public.tour_teams
for select
to authenticated
using (
  public.can_access_tour(tour_id)
...
create policy tour_teams_insert
on public.tour_teams
for insert
to authenticated
with check (
...
create policy tour_teams_update
on public.tour_teams
for update
to authenticated
using (
...
create policy tour_teams_delete
on public.tour_teams
for delete
to authenticated
using (
...
-- ---------------------------------------------------------------------------
-- tour_team_members: ensure org path exists alongside owner policies
-- ---------------------------------------------------------------------------
...
-- Keep existing owner policies from 20260710023852; add org-member overlays.
create policy tour_team_members_select_org
...
create policy tour_team_members_insert_org
on public.tour_team_members
for insert
to authenticated
with check (
...
create policy tour_team_members_update_org
on public.tour_team_members
for update
to authenticated
using (
...
create policy tour_team_members_delete_org
on public.tour_team_members
for delete
to authenticated
using (
