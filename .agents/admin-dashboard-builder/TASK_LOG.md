...
### 2026-09-10 — `ADMUX-0102`

- **Surface:** Admin dashboard sidebar, mobile drawer, collapsed navigation, and audit registry artifacts
- **Purpose:** Make Admin navigation accessible and predictable across mobile and collapsed desktop layouts
- **Change:** Kept one Radix dialog-backed mobile drawer, made its modal behavior explicit, restored focus to the invoking trigger on close, preserved keyboard-named collapsed controls/destinations, and retained Next client navigation; refreshed the affected baseline hash and derived audit views
- **Integration:** Internal Admin destinations continue to use Next client routing, while the acting-organization context bar remains compact and visible above workspace content
