...
export function activeMigrationFiles(root = MIGRATIONS_ROOT) {
...
export function scanActiveMigrationChain(files = activeMigrationFiles()) {
...
export function main() {
  ...
  console.log(`✓ active migration chain has no duplicate policy creations (${activeMigrationFiles().length} files scanned)`)
}
