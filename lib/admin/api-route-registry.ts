...
export const ADMIN_API_ROUTE_REGISTRY: AdminRouteContract[] = [
  ...
  {
    route: "/api/admin/staffing/shift-plans",
    methods: ["POST"],
    authClass: "capability_gated",
  ...
  {
    route: "/api/admin/staffing/shift-plans/[id]/publish",
    methods: ["POST"],
    authClass: "capability_gated",
    capability: "workforce.publish",
    idempotency: false,
    audit: true,
    owner: "workforce",
  },
  ...
  {
    route: "/api/admin/workforce/assignees",
    methods: ["GET"],
    authClass: "capability_gated",
    capability: "workforce.view",
    idempotency: false,
  ...
  {
    route: "/api/admin/workforce/tour-memberships",
    methods: ["POST"],
    authClass: "capability_gated",
    capability: "workforce.manage",
    idempotency: false,
