  ...
  public: {
    Tables: {
      ...
      account_follows: {
        ...
        Relationships: [
          {
            foreignKeyName: "account_follows_account_id_fkey"
            columns: ["account_id"]
            isOneToOne: false
      ...
      event_ticketing_config: {
        Row: {
          ...
          metadata: Json
          payout_destination_account_id: string | null
          platform_fee_amount: number
          platform_fee_type: string
          processing_fee_passthrough: boolean
          ...
          ticketing_owner_id: string | null
          ticketing_owner_type: string
        ...
        Relationships: [
          {
            foreignKeyName: "event_ticketing_config_event_id_fkey"
            columns: ["event_id"]
            isOneToOne: true
            referencedRelation: "events_v2"
            referencedColumns: ["id"]
      ...
      event_ticketing_grants: {
        ...
        Relationships: [
          {
            foreignKeyName: "event_ticketing_grants_event_id_fkey"
            columns: ["event_id"]
            isOneToOne: false
            referencedRelation: "events_v2"
            referencedColumns: ["id"]
      ...
      financial_transactions: {
        ...
        Relationships: [
          ...
          {
            foreignKeyName: "financial_transactions_ticket_id_fkey"
            columns: ["ticket_id"]
            isOneToOne: false
          ...
          {
            foreignKeyName: "financial_transactions_ticket_order_id_fkey"
      ...
      staff_onboarding_sensitive_vault: {
        Row: {
          ...
          field_summaries: Json
          id: string
          sensitive_envelope: Json
          updated_at: string
        }
        Insert: {
          candidate_id: string
        ...
        Relationships: [
          {
            foreignKeyName: "staff_onboarding_sensitive_vault_candidate_id_fkey"
            columns: ["candidate_id"]
            isOneToOne: true
            referencedRelation: "staff_onboarding_candidates"
            referencedColumns: ["id"]
      ...
      team_communications: {
        ...
        Relationships: [
          ...
          {
            foreignKeyName: "team_communications_site_map_id_fkey"
            columns: ["site_map_id"]
            isOneToOne: false
            referencedRelation: "site_maps"
            referencedColumns: ["id"]
          ...
          {
            foreignKeyName: "team_communications_tour_id_fkey"
            columns: ["tour_id"]
            isOneToOne: false
            referencedRelation: "tours"
            referencedColumns: ["id"]
      ...
      ticket_allocations: {
        ...
        Relationships: [
          {
            foreignKeyName: "ticket_allocations_event_id_fkey"
            columns: ["event_id"]
            isOneToOne: false
            referencedRelation: "events_v2"
            referencedColumns: ["id"]
      ...
      ticket_analytics_events: {
        ...
        Relationships: [
          {
            foreignKeyName: "ticket_analytics_events_event_id_fkey"
            columns: ["event_id"]
            isOneToOne: false
            referencedRelation: "events_v2"
            referencedColumns: ["id"]
      ...
      ticket_checkins: {
        ...
        Relationships: [
          {
            foreignKeyName: "ticket_checkins_credential_id_fkey"
            columns: ["credential_id"]
            isOneToOne: false
            referencedRelation: "ticket_credentials"
            referencedColumns: ["id"]
          },
          {
      ...
      ticket_credentials: {
        ...
        Relationships: [
          {
            foreignKeyName: "ticket_credentials_superseded_by_fkey"
            columns: ["superseded_by"]
            isOneToOne: false
            referencedRelation: "ticket_credentials"
            referencedColumns: ["id"]
      ...
      ticket_inventory_reservations: {
        ...
        Relationships: [
          {
            foreignKeyName: "ticket_inventory_reservations_event_id_fkey"
            columns: ["event_id"]
            isOneToOne: false
            referencedRelation: "events_v2"
            referencedColumns: ["id"]
          ...
          {
            foreignKeyName: "ticket_inventory_reservations_ticket_type_id_fkey"
            columns: ["ticket_type_id"]
            isOneToOne: false
            referencedRelation: "ticket_types"
            referencedColumns: ["id"]
      ...
      ticket_ownership_events: {
        ...
        Relationships: [
          {
            foreignKeyName: "ticket_ownership_events_ticket_id_fkey"
            columns: ["ticket_id"]
            isOneToOne: false
            referencedRelation: "tickets"
            referencedColumns: ["id"]
      ...
      ticket_revenue_allocations: {
        ...
        Relationships: [
          {
            foreignKeyName: "ticket_revenue_allocations_event_id_fkey"
            columns: ["event_id"]
            isOneToOne: false
            referencedRelation: "events_v2"
            referencedColumns: ["id"]
      ...
      ticket_sales: {
        ...
        Relationships: [
          ...
          {
            foreignKeyName: "ticket_sales_reservation_id_fkey"
            columns: ["reservation_id"]
            isOneToOne: false
            referencedRelation: "ticket_inventory_reservations"
            referencedColumns: ["id"]
      ...
      ticket_stripe_webhook_events: {
        ...
        Relationships: [
          {
            foreignKeyName: "ticket_stripe_webhook_events_order_id_fkey"
            columns: ["order_id"]
            isOneToOne: false
            referencedRelation: "ticket_sales"
            referencedColumns: ["id"]
      ...
      tickets: {
        ...
        Relationships: [
          {
            foreignKeyName: "tickets_allocation_id_fkey"
            columns: ["allocation_id"]
            isOneToOne: false
            referencedRelation: "ticket_allocations"
            referencedColumns: ["id"]
      ...
      venue_manual_transactions: {
        ...
        Relationships: [
          {
            foreignKeyName: "venue_manual_transactions_venue_id_fkey"
            columns: ["venue_id"]
            isOneToOne: false
            referencedRelation: "entities_venues"
            referencedColumns: ["entity_id"]
      ...
      venue_profiles: {
        ...
        Relationships: [
          {
            foreignKeyName: "venue_profiles_main_profile_id_fkey"
    ...
    Functions: {
      ...
      refresh_forum_mviews: { Args: never; Returns: undefined }
      ...
      send_dm_request: {
        Args: {
          p_content: string
          p_recipient: string
          p_recipient_account_type?: string
          p_recipient_profile_id?: string
          p_sender: string
          p_sender_account_type?: string
